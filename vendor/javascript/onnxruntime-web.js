// onnxruntime-web@1.18.0 downloaded from https://unpkg.com/onnxruntime-web@1.18.0/dist/esm/ort.min.js
...
var me = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports),
  Sr = (a, t) => {
    for (var o in t) Pn(a, o, { get: t[o], enumerable: !0 });
  },
  Va = (a, t, o, e) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let r of Od(t))
        !Sd.call(a, r) &&
          ...
          Pn(a, r, {
            get: () => t[r],
            enumerable: !(e = _d(t, r)) || e.enumerable,
          });
    return a;
  };
var Ar = (a, t, o) => (
    ...
    Va(
      t || !a || !a.__esModule
        ? Pn(o, "default", { value: a, enumerable: !0 })
        : o,
      a
    )
  ),
  ar = (a) => Va(Pn({}, "__esModule", { value: !0 }), a);
var En,
  sr,
  Pr,
  Ad,
    ...
    (En = new Map()),
        ...
        if (
          ...
          if (e === void 0) En.set(a, { backend: t, priority: o });
            ...
            if (e.priority === o && e.backend !== t)
              throw new Error(
                `cannot register backend "${a}" using priority ${o}`
              );
          }
          if (o >= 0) {
            let r = sr.indexOf(a);
      ...
      (Ad = async (a) => {
        ...
        if (t.aborted) return t.error;
        {
          ...
          try {
            return (
              o || (t.initPromise = t.backend.init(a)),
              await t.initPromise,
              (t.initialized = !0),
              t.backend
            );
          } catch (e) {
            return o || ((t.error = `${e}`), (t.aborted = !0)), t.error;
          } finally {
      ...
      (Dn = async (a) => {
        let t = a.executionProviders || [],
          o = t.map((u) => (typeof u == "string" ? u : u.name)),
          e = o.length === 0 ? sr : o,
          r,
          n = [],
          s = new Set();
        ...
        return [
          r,
          new Proxy(a, {
            get: (u, l) => (l === "executionProviders" ? i : Reflect.get(u, l)),
          }),
        ];
      });
  });
      ...
      (ut = {
        ...
        set logLevel(a) {
          if (a !== void 0) {
            if (
              typeof a != "string" ||
              ["verbose", "info", "warning", "error", "fatal"].indexOf(a) === -1
            )
    ...
    (Xa = (a, t) => {
      ...
      if (e != null) {
        ...
        t?.tensorLayout !== void 0 && t.tensorLayout === "NHWC"
          ? ((r = a.dims[2]), (n = a.dims[3]))
          : ((r = a.dims[3]), (n = a.dims[2]));
        let s = t?.format !== void 0 ? t.format : "RGB",
          i = t?.norm,
          u,
          l;
        i === void 0 || i.mean === void 0
          ? (u = [255, 255, 255, 255])
          : typeof i.mean == "number"
          ? (u = [i.mean, i.mean, i.mean, i.mean])
          : ((u = [i.mean[0], i.mean[1], i.mean[2], 0]),
            i.mean[3] !== void 0 && (u[3] = i.mean[3])),
          i === void 0 || i.bias === void 0
            ? (l = [0, 0, 0, 0])
            : typeof i.bias == "number"
            ? (l = [i.bias, i.bias, i.bias, i.bias])
            : ((l = [i.bias[0], i.bias[1], i.bias[2], 0]),
              i.bias[3] !== void 0 && (l[3] = i.bias[3]));
        let c = n * r,
          p = 0,
          d = c,
          T = c * 2,
        ...
        for (let v = 0; v < n; v++)
          for (let S = 0; S < r; S++) {
            let A = (a.data[p++] - l[0]) * u[0],
              C = (a.data[d++] - l[1]) * u[1],
              F = (a.data[T++] - l[2]) * u[2],
              J = w === -1 ? 255 : (a.data[w++] - l[3]) * u[3];
            (e.fillStyle = "rgba(" + A + "," + C + "," + F + "," + J + ")"),
              e.fillRect(S, v, 1, 1);
          }
      ...
      (Ka = (a, t) => {
        ...
        if (o != null) {
          let r, n, s;
          t?.tensorLayout !== void 0 && t.tensorLayout === "NHWC"
            ? ((r = a.dims[2]), (n = a.dims[1]), (s = a.dims[3]))
            : ((r = a.dims[3]), (n = a.dims[2]), (s = a.dims[1]));
          let i = t !== void 0 && t.format !== void 0 ? t.format : "RGB",
            u = t?.norm,
            l,
            c;
          u === void 0 || u.mean === void 0
            ...
            u === void 0 || u.bias === void 0
              ...
              ? (c = [u.bias, u.bias, u.bias, u.bias])
              : ((c = [u.bias[0], u.bias[1], u.bias[2], 0]),
          ...
          i === "RGBA"
            ...
            ? ((A = 0), (C = p), (F = p * 2))
            : i === "RBG" && ((A = 0), (F = p), (C = p * 2)),
            (e = o.createImageData(r, n));
          for (let j = 0; j < n * r; T += d, w += d, v += d, S += d, j++)
            (e.data[T] = (a.data[A++] - c[0]) * l[0]),
              (e.data[w] = (a.data[C++] - c[1]) * l[1]),
              (e.data[v] = (a.data[F++] - c[2]) * l[2]),
              (e.data[S] = J === -1 ? 255 : (a.data[J++] - c[3]) * l[3]);
        } else throw new Error("Can not access image data");
        return e;
      });
  });
var Wo,
  ...
  rs = L(() => {
    ...
    (Wo = (a, t) => {
      ...
      let { height: o, width: e } = t,
        r = t.norm ?? { mean: 255, bias: 0 },
        n,
        s;
      ...
      let i = t.format !== void 0 ? t.format : "RGBA",
        u =
          t.tensorFormat !== void 0 && t.tensorFormat !== void 0
            ? t.tensorFormat
            : "RGB",
        l = o * e,
        c = u === "RGBA" ? new Float32Array(l * 4) : new Float32Array(l * 3),
        p = 4,
        d = 0,
        T = 1,
        w = 2,
      ...
      for (let j = 0; j < l; j++, d += p, w += p, T += p, v += p)
        (c[S++] = (a[d] + s[0]) / n[0]),
          (c[A++] = (a[T] + s[1]) / n[1]),
          (c[C++] = (a[w] + s[2]) / n[2]),
          F !== -1 && v !== -1 && (c[F++] = (a[v] + s[3]) / n[3]);
      return u === "RGBA"
        ? new Je("float32", c, [1, 4, o, e])
        : new Je("float32", c, [1, 3, o, e]);
    }),
      (Za = async (a, t) => {
        let o = typeof HTMLImageElement < "u" && a instanceof HTMLImageElement,
          e = typeof ImageData < "u" && a instanceof ImageData,
          r = typeof ImageBitmap < "u" && a instanceof ImageBitmap,
          n = typeof a == "string",
          s,
          i = t ?? {},
          u = () => {
          ...
          l = (c) =>
            c instanceof HTMLCanvasElement || c instanceof OffscreenCanvas
              ? c.getContext("2d")
              : null;
        if (o) {
          let c = u();
          ...
          if (p != null) {
            ...
            if (
              (t !== void 0 &&
                ...
                ((d = t.resizedHeight), (T = t.resizedWidth)),
              t !== void 0)
            ) {
              if (((i = t), t.tensorFormat !== void 0))
                throw new Error(
          ...
          if (
            ...
            t.resizedWidth !== void 0 &&
            t.resizedHeight !== void 0
              ? ((c = t.resizedHeight), (p = t.resizedWidth))
          ...
          if (p != null) {
            let d = a.height,
              T = a.width;
            return (
              p.drawImage(a, 0, 0, T, d),
              (s = p.getImageData(0, 0, T, d).data),
              (i.height = d),
              (i.width = T),
              Wo(s, i)
            );
            ...
            return new Promise((c, p) => {
              ...
              (w.crossOrigin = "Anonymous"),
                ...
                (w.onload = () => {
                  (d.width = w.width),
                    (d.height = w.height),
                    T.drawImage(w, 0, 0, d.width, d.height);
      ...
      (Qa = (a, t) => {
        let { width: o, height: e, download: r, dispose: n } = t,
          s = [1, e, o, 4];
        return new Je({
          location: "texture",
          type: "float32",
  ...
  is = L(() => {
    ...
    (ur = new Map([
      ...
      (os = () => {
        if (!ns) {
          ns = !0;
          let a = typeof BigInt64Array < "u" && BigInt64Array.from,
            t = typeof BigUint64Array < "u" && BigUint64Array.from,
            o = typeof Float16Array < "u" && Float16Array.from;
          a && (ur.set("int64", BigInt64Array), Qr.set(BigInt64Array, "int64")),
            t &&
              (ur.set("uint64", BigUint64Array),
              Qr.set(BigUint64Array, "uint64")),
            o
              ? (ur.set("float16", Float16Array),
                Qr.set(Float16Array, "float16"))
              : ur.set("float16", Uint16Array);
        }
      });
  });
var as,
    ...
    (as = (a) => {
      ...
      for (let o = 0; o < a.length; o++) {
        ...
        if (e < 0)
          throw new RangeError(
            `dims[${o}] must be a non-negative integer, got: ${e}`
          );
        t *= e;
      }
      return t;
      ...
      (ss = (a, t) => {
        switch (a.location) {
          ...
          default:
            throw new Error(
              `tensorReshape: tensor location ${a.location} is not supported`
            );
        }
      });
  });
...
var ls,
  ...
  Ho = L(() => {
    ...
    Vo();
    (ls = (a, t) => {
      (typeof ut.trace > "u" ? !ut.wasm.trace : !ut.trace) ||
        console.timeStamp(`${a}::ORT::${t}`);
    }),
      (fs = (a, t) => {
  ...
  cs = L(() => {
    ...
    $n = class a {
      ...
      async run(t, o, e) {
        ...
        let i = await this.handler.run(t, r, n),
          u = {};
        for (let l in i)
          if (Object.hasOwnProperty.call(i, l)) {
            ...
            c instanceof Me
              ? (u[l] = c)
              : (u[l] = new Me(c.type, c.data, c.dims));
          }
        return fr(), u;
      }
      async release() {
      ...
      static async create(t, o, e, r) {
        ...
        if (typeof t == "string") {
          ...
          if (typeof o == "object" && o !== null) s = o;
            ...
            if (p < 0 || p >= c.byteLength)
              throw new RangeError(
                `'byteOffset' is out of range [0, ${c.byteLength}).`
              );
            if (((d = t.byteLength - p), typeof e == "number")) {
              ...
              if (d <= 0 || p + d > c.byteLength)
                throw new RangeError(
                  `'byteLength' is out of range (0, ${c.byteLength - p}].`
                );
        ...
        let [i, u] = await Dn(s),
          l = await i.createInferenceSessionHandler(n, u);
        return fr(), new a(l);
      }
      startProfiling() {
      ...
      (kn = class a {
        ...
        convertHandlerReturnTypeToMapOfTensors(t) {
          ...
          for (let e in t)
            if (Object.hasOwnProperty.call(t, e)) {
              ...
              r instanceof Me
                ? (o[e] = r)
                : (o[e] = new Me(r.type, r.data, r.dims));
            }
          return o;
        }
        async lazyResetGrad() {
        ...
        async runTrainStep(t, o, e) {
          let [r, n] = this.typeNarrowingForRunStep(
            ...
            s = await this.handler.runTrainStep(t, r, n);
        ...
        async runEvalStep(t, o, e) {
          if (this.hasEvalModel) {
            let [r, n] = this.typeNarrowingForRunStep(
              ...
              s = await this.handler.runEvalStep(t, r, n);
            return this.convertHandlerReturnTypeToMapOfTensors(s);
          } else
        ...
        async loadParametersBuffer(t, o = !0) {
...
function Cd(a) {
  return {
    verbose: Xt.verbose.bind(null, a),
    info: Xt.info.bind(null, a),
    warning: Xt.warning.bind(null, a),
    error: Xt.error.bind(null, a),
    fatal: Xt.fatal.bind(null, a),
  };
}
function Bn(a, t, o, e) {
  let r = en[e || ""] || en[""];
  xs[a] < xs[r.minimalSeverity] ||
    (r.logDateTime && (t = `${new Date().toISOString()}|${t}`),
    r.logSourceLocation,
    Ld[r.provider].log(a, t, e));
}
var jo,
  Yo,
  xs,
  ...
  lt = L(() => {
    ...
    (jo = class {
      ...
      (Yo = class {
        log(t, o, e) {
          console.log(
            `${this.color(t)} ${e ? "\x1B[35m" + e + "\x1B[0m " : ""}${o}`
          );
        }
        color(t) {
          switch (t) {
      ...
      (xs = { verbose: 1e3, info: 2e3, warning: 4e3, error: 5e3, fatal: 6e3 }),
      (Ld = { none: new jo(), console: new Yo() }),
      (ws = {
        provider: "console",
      ...
      function s(l, c) {
        if (l === "*") n(c);
          ...
          en[l] = {
            ...
            minimalSeverity: c.minimalSeverity || p.minimalSeverity,
            logDateTime:
              c.logDateTime === void 0 ? p.logDateTime : c.logDateTime,
            logSourceLocation:
              c.logSourceLocation === void 0
                ? p.logSourceLocation
                : c.logSourceLocation,
          };
        }
    ...
    (ce = Xt),
      ...
      (Gn = class {
        constructor(t, o, e) {
          ...
          (this._started = !1),
            (this._maxNumberEvents = t === void 0 ? 1e4 : t),
            (this._flushBatchSize = o === void 0 ? 10 : o),
            (this._flushIntervalInMilliseconds = e === void 0 ? 5e3 : e);
        }
        static create(t) {
          return t === void 0
            ? new this()
        ...
        event(t, o, e, r) {
          let n = this._started ? this.begin(t, o, r) : void 0,
            s = !1,
            i = e();
        ...
        async end(t) {
          ...
          this._timingEvents.length < this._maxNumberEvents &&
            (this._timingEvents.push(
              new Mn(t.category, t.name, t.startTime, o)
            ),
            this.flush(o));
        }
        endSync(t) {
        ...
        logOneEvent(t) {
          ce.verbose(
            `Profiler.${t.category}`,
            `${(t.endTime - t.startTime).toFixed(2)}ms on event '${
              t.name
            }' at ${t.endTime.toFixed(2)}`
          );
        }
        flush(t) {
          if (
            ...
            t - this._flushTime >= this._flushIntervalInMilliseconds
          ) {
            for (
...
function vs(a, t, o) {
  ...
  throw new TypeError(
    `cannot resolve operator '${a.opType}' with opsets: ${t
      .map((e) => `${e.domain || "ai.onnx"} v${e.version}`)
      .join(", ")}`
  );
}
function Fd(a, t) {
...
var Os = me((Xo) => {
  ...
  var $d = (function () {
    ...
    return (
      ...
      (a.create = function () {
        return new a(
          [a.gen(2), a.gen(1), a.gen(1), a.gen(1), a.gen(3)].join("-")
        );
      }),
...
function cr(a, t) {
  ...
  return t
    ? ((a >>>= 0),
      (r = 0 <= a && a < 256) && ((e = As[a]), e)
        ? e
        : ((o = le(a, 0, !0)), r && (As[a] = o), o))
    : ((a |= 0),
      (r = -128 <= a && a < 128) && ((e = Ss[a]), e)
        ? e
        : ((o = le(a, a < 0 ? -1 : 0, !1)), r && (Ss[a] = o), o));
}
function ct(a, t) {
...
function Jo(a, t, o) {
  ...
  for (var r = ct(Un(o, 8)), n = It, s = 0; s < a.length; s += 8) {
    var i = Math.min(8, a.length - s),
      u = parseInt(a.substring(s, s + i), o);
    if (i < 8) {
      var l = ct(Un(o, i));
      n = n.mul(l).add(ct(u));
    } else (n = n.mul(r)), (n = n.add(ct(u)));
  }
...
function St(a, t) {
  return typeof a == "number"
    ...
    : typeof a == "string"
    ? Jo(a, t)
    : le(a.low, a.high, typeof t == "boolean" ? t : a.unsigned);
}
var ft,
  Ss,
  As,
  ...
  Zo = L(() => {
    ...
    Object.defineProperty(be.prototype, "__isLong__", { value: !0 });
    be.isLong = Xe;
    (Ss = {}), (As = {});
    be.fromInt = cr;
    be.fromNumber = ct;
    ...
    Ko = cr(-1);
    be.NEG_ONE = Ko;
    Fs = le(-1, 2147483647, !1);
    be.MAX_VALUE = Fs;
    $s = le(-1, -1, !0);
    be.MAX_UNSIGNED_VALUE = $s;
    nt = le(0, -2147483648, !1);
    be.MIN_VALUE = nt;
    B = be.prototype;
    B.toInt = function () {
    ...
    B.toNumber = function () {
      return this.unsigned
        ? (this.high >>> 0) * Dr + (this.low >>> 0)
        : this.high * Dr + (this.low >>> 0);
    };
    ...
    B.getNumBitsAbs = function () {
      ...
      for (
        var t = this.high != 0 ? this.high : this.low, o = 31;
        o > 0 && !(t & (1 << o));
        o--
      );
    ...
    B.add = function (t) {
      ...
      return (
        ...
        (c += o + s),
        (c &= 65535),
        le((d << 16) | T, (c << 16) | p, this.unsigned)
      );
    };
    ...
    B.multiply = function (t) {
      ...
      return (
        ...
        (p += e * c + r * l + n * u + s * i),
        (p &= 65535),
        le((T << 16) | w, (p << 16) | d, this.unsigned)
      );
    };
    B.mul = B.multiply;
    B.divide = function (t) {
      ...
      if (ft) {
        if (
          ...
          return this;
        var o = (this.unsigned ? ft.div_u : ft.div_s)(
          this.low,
          this.high,
          t.low,
          t.high
          ...
          return (
            ...
            e.eq(It)
              ? t.isNegative()
                ? Er
                : Ko
              : ((r = this.sub(t.mul(e))), (n = e.add(r.div(t))), n)
          );
    ...
    B.modulo = function (t) {
      if ((Xe(t) || (t = St(t)), ft)) {
        var o = (this.unsigned ? ft.rem_u : ft.rem_s)(
          this.low,
          this.high,
          t.low,
          t.high
    ...
    B.and = function (t) {
      return (
        Xe(t) || (t = St(t)),
        le(this.low & t.low, this.high & t.high, this.unsigned)
      );
    };
    B.or = function (t) {
      return (
    ...
    B.shiftLeft = function (t) {
      return (
        ...
        (t &= 63) === 0
          ...
          : le(0, this.low << (t - 32), this.unsigned)
      );
    };
    B.shl = B.shiftLeft;
    B.shiftRight = function (t) {
      return (
        ...
        (t &= 63) === 0
          ...
          : le(this.high >> (t - 32), this.high >= 0 ? 0 : -1, this.unsigned)
      );
    };
    B.shr = B.shiftRight;
    B.shiftRightUnsigned = function (t) {
      return (
        ...
        (t &= 63) === 0
          ...
          : t === 32
          ? le(this.high, 0, this.unsigned)
          : le(this.high >>> (t - 32), 0, this.unsigned)
      );
    };
    ...
    B.rotateLeft = function (t) {
      ...
      return (
        ...
        (t &= 63) === 0
          ? this
          : t === 32
          ? le(this.high, this.low, this.unsigned)
          : t < 32
          ? ((o = 32 - t),
            le(
              (this.low << t) | (this.high >>> o),
...
var _,
  zn = L(() => {
    ...
    _.Builder = function (a) {
      ...
      (this.bb = _.ByteBuffer.allocate(t)),
        (this.space = t),
        (this.minalign = 1),
        (this.vtable = null),
    ...
    _.Builder.prototype.prep = function (a, t) {
      ...
      for (
        var o = (~(this.bb.capacity() - this.space + t) + 1) & (a - 1);
        this.space < o + a + t;

      ) {
        var e = this.bb.capacity();
        (this.bb = _.Builder.growByteBuffer(this.bb)),
    ...
    _.Builder.growByteBuffer = function (a) {
      ...
      var o = t << 1,
        e = _.ByteBuffer.allocate(o);
      return e.setPosition(o - t), e.bytes().set(a.bytes(), o - t), e;
    };
    _.Builder.prototype.addOffset = function (a) {
      this.prep(_.SIZEOF_INT, 0),
        this.writeInt32(this.offset() - a + _.SIZEOF_INT);
    };
    ...
    _.Builder.prototype.endObject = function () {
      ...
      this.addInt32(0);
      for (
        var a = this.offset(), t = this.vtable_in_use - 1;
        t >= 0 && this.vtable[t] == 0;
        t--
      );
      for (var o = t + 1; t >= 0; t--)
      ...
      return (
        n
          ? ((this.space = this.bb.capacity() - a),
            this.bb.writeInt32(this.space, n - a))
          : (this.vtables.push(this.offset()),
            this.bb.writeInt32(this.bb.capacity() - a, this.offset() - a)),
        (this.isNested = !1),
        a
      );
    };
    _.Builder.prototype.finish = function (a, t, o) {
      ...
      if (t) {
        ...
        if (
          (this.prep(
            this.minalign,
            _.SIZEOF_INT + _.FILE_IDENTIFIER_LENGTH + e
          ),
          r.length != _.FILE_IDENTIFIER_LENGTH)
        )
          throw new Error(
            "FlatBuffers: file identifier must be length " +
              _.FILE_IDENTIFIER_LENGTH
          );
        for (var n = _.FILE_IDENTIFIER_LENGTH - 1; n >= 0; n--)
          this.writeInt8(r.charCodeAt(n));
      }
      this.prep(this.minalign, _.SIZEOF_INT + e),
        this.addOffset(a),
        e && this.addInt32(this.bb.capacity() - this.space),
    ...
    _.Builder.prototype.requiredField = function (a, t) {
      var o = this.bb.capacity() - a,
        e = o - this.bb.readInt32(o),
        r = this.bb.readInt16(e + t) != 0;
    ...
    _.ByteBuffer.prototype.readFloat64 = function (a) {
      return (
        (_.int32[_.isLittleEndian ? 0 : 1] = this.readInt32(a)),
        (_.int32[_.isLittleEndian ? 1 : 0] = this.readInt32(a + 4)),
        _.float64[0]
      );
    };
    ...
    _.ByteBuffer.prototype.writeInt32 = function (a, t) {
      (this.bytes_[a] = t),
        (this.bytes_[a + 1] = t >> 8),
        (this.bytes_[a + 2] = t >> 16),
        (this.bytes_[a + 3] = t >> 24);
    };
    ...
    _.ByteBuffer.prototype.writeFloat64 = function (a, t) {
      (_.float64[0] = t),
        this.writeInt32(a, _.int32[_.isLittleEndian ? 0 : 1]),
        this.writeInt32(a + 4, _.int32[_.isLittleEndian ? 1 : 0]);
    };
    _.ByteBuffer.prototype.getBufferIdentifier = function () {
      if (
        this.bytes_.length <
        this.position_ + _.SIZEOF_INT + _.FILE_IDENTIFIER_LENGTH
      )
        throw new Error(
      ...
      for (var a = "", t = 0; t < _.FILE_IDENTIFIER_LENGTH; t++)
        a += String.fromCharCode(
          this.readInt8(this.position_ + _.SIZEOF_INT + t)
        );
      return a;
    };
      ...
      for (; r < o; ) {
        ...
        if (s < 192) n = s;
          ...
          if (s < 224) n = ((s & 31) << 6) | (i & 63);
            ...
            if (s < 240) n = ((s & 15) << 12) | ((i & 63) << 6) | (u & 63);
            else {
              var l = this.readUint8(a + r++);
              n =
                ((s & 7) << 18) | ((i & 63) << 12) | ((u & 63) << 6) | (l & 63);
            }
          }
        }
        n < 65536
      ...
      ((e) => {
        ...
        ((n) => {
          ...
          ((F) => (
            ...
            (F[(F.FLOATS = 6)] = "FLOATS"),
            (F[(F.INTS = 7)] = "INTS"),
            (F[(F.STRINGS = 8)] = "STRINGS"),
            (F[(F.TENSORS = 9)] = "TENSORS"),
            (F[(F.GRAPHS = 10)] = "GRAPHS"),
            (F[(F.SPARSE_TENSOR = 11)] = "SPARSE_TENSOR"),
            (F[(F.SPARSE_TENSORS = 12)] = "SPARSE_TENSORS")
          ))((r = n.AttributeType ||= {}));
        })((o = e.fbs ||= {}));
      })((a = t.experimental ||= {}));
    })((V ||= {}));
      ...
      ((e) => {
        ...
        ((n) => {
          ...
          ((Y) => (
            ...
            (Y[(Y.STRING = 8)] = "STRING"),
            (Y[(Y.BOOL = 9)] = "BOOL"),
            (Y[(Y.FLOAT16 = 10)] = "FLOAT16"),
            (Y[(Y.DOUBLE = 11)] = "DOUBLE"),
            (Y[(Y.UINT32 = 12)] = "UINT32"),
            (Y[(Y.UINT64 = 13)] = "UINT64"),
            (Y[(Y.COMPLEX64 = 14)] = "COMPLEX64"),
            (Y[(Y.COMPLEX128 = 15)] = "COMPLEX128"),
            (Y[(Y.BFLOAT16 = 16)] = "BFLOAT16"),
            (Y[(Y.FLOAT8E4M3FN = 17)] = "FLOAT8E4M3FN"),
            (Y[(Y.FLOAT8E4M3FNUZ = 18)] = "FLOAT8E4M3FNUZ"),
            (Y[(Y.FLOAT8E5M2 = 19)] = "FLOAT8E5M2"),
            (Y[(Y.FLOAT8E5M2FNUZ = 20)] = "FLOAT8E5M2FNUZ")
          ))((r = n.TensorDataType ||= {}));
        })((o = e.fbs ||= {}));
      })((a = t.experimental ||= {}));
    })((V ||= {}));
    ...
    ((t) => {
      ...
      ((e) => {
        ...
        ((n) => {
          ...
          ((c) => (
            (c[(c.NONE = 0)] = "NONE"),
            (c[(c.tensor_type = 1)] = "tensor_type"),
            (c[(c.sequence_type = 2)] = "sequence_type"),
            (c[(c.map_type = 3)] = "map_type")
          ))((r = n.TypeInfoValue ||= {}));
        })((o = e.fbs ||= {}));
      })((a = t.experimental ||= {}));
    })((V ||= {}));
        ...
        ((n) => {
          class r {
            ...
            static getSizePrefixedRootAsShape(i, u) {
              return (
                i.setPosition(i.position() + _.SIZE_PREFIX_LENGTH),
                (u || new r()).__init(
                  i.readInt32(i.position()) + i.position(),
                  i
                )
            ...
            dim(i, u) {
              ...
              return l
                ? (u || new t.experimental.fbs.Dimension()).__init(
                    this.bb.__indirect(
                      this.bb.__vector(this.bb_pos + l) + i * 4
                    ),
                    this.bb
                  )
                : null;
            ...
            static createDimVector(i, u) {
              ...
              for (let l = u.length - 1; l >= 0; l--) i.addOffset(u[l]);
              return i.endVector();
            }
        ...
        ((n) => {
          class r {
            ...
            value(i) {
              ...
              return u
                ? (i || new t.experimental.fbs.DimensionValue()).__init(
        ...
        ((n) => {
          class r {
            ...
            static createDimensionValue(i, u, l, c) {
              return (
                r.startDimensionValue(i),
                r.addDimType(i, u),
                r.addDimValue(i, l),
                r.addDimParam(i, c),
                r.endDimensionValue(i)
              );
            }
          }
          n.DimensionValue = r;
        ...
        ((n) => {
          class r {
            ...
            shape(i) {
              let u = this.bb.__offset(this.bb_pos, 6);
              return u
                ? (i || new t.experimental.fbs.Shape()).__init(
                    this.bb.__indirect(this.bb_pos + u),
                    this.bb
                  )
                : null;
            ...
            static createTensorTypeAndShape(i, u, l) {
              return (
                r.startTensorTypeAndShape(i),
                r.addElemType(i, u),
                r.addShape(i, l),
                r.endTensorTypeAndShape(i)
              );
            }
          }
        ...
        ((n) => {
          class r {
            ...
            valueType(i) {
              let u = this.bb.__offset(this.bb_pos, 6);
              return u
                ? (i || new t.experimental.fbs.TypeInfo()).__init(
                    this.bb.__indirect(this.bb_pos + u),
                    this.bb
                  )
                : null;
        ...
        ((n) => {
          class r {
            ...
            inputEdges(i, u) {
              ...
              return l
                ? (u || new t.experimental.fbs.EdgeEnd()).__init(
                    this.bb.__vector(this.bb_pos + l) + i * 12,
                    this.bb
                  )
                : null;
            }
        ...
        ((n) => {
          class r {
            ...
            inputs(i, u) {
              ...
              return l
                ? this.bb.__string(this.bb.__vector(this.bb_pos + l) + i * 4, u)
                : null;
            }
            inputsLength() {
            ...
            attributes(i, u) {
              ...
              return l
                ? (u || new t.experimental.fbs.Attribute()).__init(
                    this.bb.__indirect(
                      this.bb.__vector(this.bb_pos + l) + i * 4
                    ),
                    this.bb
            ...
            inputArgCounts(i) {
              ...
              return u
                ? this.bb.readInt32(this.bb.__vector(this.bb_pos + u) + i * 4)
                : 0;
            }
            ...
            static createInputArgCountsVector(i, u) {
              i.startVector(4, u.length, 4);
              for (let l = u.length - 1; l >= 0; l--) i.addInt32(u[l]);
              return i.endVector();
            }
            ...
            static createNode(i, u, l, c, p, d, T, w, v, S, A, C, F, J) {
              return (
                ...
                r.addDocString(i, l),
                r.addDomain(i, c),
                r.addSinceVersion(i, p),
                r.addIndex(i, d),
                r.addOpType(i, T),
                r.addType(i, w),
                r.addExecutionProviderType(i, v),
                r.addInputs(i, S),
                r.addOutputs(i, A),
                r.addAttributes(i, C),
                r.addInputArgCounts(i, F),
                r.addImplicitInputs(i, J),
                r.endNode(i)
              );
            }
          }
        ...
        ((n) => {
          class r {
            ...
            static createOperatorSetId(i, u, l) {
              return (
                r.startOperatorSetId(i),
                r.addDomain(i, u),
                r.addVersion(i, l),
                r.endOperatorSetId(i)
              );
            }
          }
          n.OperatorSetId = r;
        ...
        ((n) => {
          class r {
            ...
            dims(i) {
              let u = this.bb.__offset(this.bb_pos, 8);
              return u
                ? this.bb.readInt64(this.bb.__vector(this.bb_pos + u) + i * 8)
                : this.bb.createLong(0, 0);
            }
            dimsLength() {
              let i = this.bb.__offset(this.bb_pos, 8);
            ...
            rawData(i) {
              ...
              return u
                ? this.bb.readUint8(this.bb.__vector(this.bb_pos + u) + i)
                : 0;
            }
            rawDataLength() {
              let i = this.bb.__offset(this.bb_pos, 12);
            ...
            static createDimsVector(i, u) {
              ...
              for (let l = u.length - 1; l >= 0; l--) i.addInt64(u[l]);
              return i.endVector();
            }
            ...
            static createRawDataVector(i, u) {
              ...
              for (let l = u.length - 1; l >= 0; l--) i.addInt8(u[l]);
              return i.endVector();
            }
        ...
        ((n) => {
          class r {
            ...
            values(i) {
              let u = this.bb.__offset(this.bb_pos, 4);
              return u
                ? (i || new t.experimental.fbs.Tensor()).__init(
                    this.bb.__indirect(this.bb_pos + u),
                    this.bb
                  )
                : null;
        ...
        ((n) => {
          class r {
            ...
            g(i) {
              let u = this.bb.__offset(this.bb_pos, 18);
              return u
                ? (i || new t.experimental.fbs.Graph()).__init(
                    this.bb.__indirect(this.bb_pos + u),
                    this.bb
                  )
                : null;
            ...
            floats(i) {
              ...
              return u
                ? this.bb.readFloat32(this.bb.__vector(this.bb_pos + u) + i * 4)
                : 0;
            }
            floatsLength() {
              let i = this.bb.__offset(this.bb_pos, 20);
            ...
            tensors(i, u) {
              ...
              return l
                ? (u || new t.experimental.fbs.Tensor()).__init(
                    this.bb.__indirect(
                      this.bb.__vector(this.bb_pos + l) + i * 4
                    ),
                    this.bb
            ...
            graphs(i, u) {
              let l = this.bb.__offset(this.bb_pos, 28);
              return l
                ? (u || new t.experimental.fbs.Graph()).__init(
                    this.bb.__indirect(
                      this.bb.__vector(this.bb_pos + l) + i * 4
                    ),
                    this.bb
            ...
            static createFloatsVector(i, u) {
              i.startVector(4, u.length, 4);
              for (let l = u.length - 1; l >= 0; l--) i.addFloat32(u[l]);
              return i.endVector();
            }
        ...
        ((n) => {
          class r {
            ...
            nodeArgs(i, u) {
              let l = this.bb.__offset(this.bb_pos, 6);
              return l
                ? (u || new t.experimental.fbs.ValueInfo()).__init(
                    this.bb.__indirect(
                      this.bb.__vector(this.bb_pos + l) + i * 4
                    ),
                    this.bb
            ...
            nodes(i, u) {
              let l = this.bb.__offset(this.bb_pos, 8);
              return l
                ? (u || new t.experimental.fbs.Node()).__init(
                    this.bb.__indirect(
                      this.bb.__vector(this.bb_pos + l) + i * 4
                    ),
                    this.bb
            ...
            nodeEdges(i, u) {
              ...
              return l
                ? (u || new t.experimental.fbs.NodeEdge()).__init(
                    this.bb.__indirect(
                      this.bb.__vector(this.bb_pos + l) + i * 4
                    ),
                    this.bb
            ...
            sparseInitializers(i, u) {
              ...
              return l
                ? (u || new t.experimental.fbs.SparseTensor()).__init(
                    this.bb.__indirect(
                      this.bb.__vector(this.bb_pos + l) + i * 4
                    ),
                    this.bb
            ...
            static createGraph(i, u, l, c, p, d, T, w, v) {
              return (
                r.startGraph(i),
                r.addInitializers(i, u),
                r.addNodeArgs(i, l),
                r.addNodes(i, c),
                r.addMaxNodeIndex(i, p),
                r.addNodeEdges(i, d),
                r.addInputs(i, T),
                r.addOutputs(i, w),
                r.addSparseInitializers(i, v),
                r.endGraph(i)
              );
            }
          }
        ...
        ((n) => {
          class r {
            ...
            opsetImport(i, u) {
              let l = this.bb.__offset(this.bb_pos, 6);
              return l
                ? (u || new t.experimental.fbs.OperatorSetId()).__init(
                    this.bb.__indirect(
                      this.bb.__vector(this.bb_pos + l) + i * 4
                    ),
                    this.bb
            ...
            static createModel(i, u, l, c, p, d, T, w, v, S) {
              return (
                r.startModel(i),
                r.addIrVersion(i, u),
                r.addOpsetImport(i, l),
                r.addProducerName(i, c),
                r.addProducerVersion(i, p),
                r.addDomain(i, d),
                r.addModelVersion(i, T),
                r.addDocString(i, w),
                r.addGraph(i, v),
                r.addGraphDocString(i, S),
                r.endModel(i)
              );
            }
          }
        ...
        ((n) => {
          class r {
            ...
            nodeIndices(i) {
              let u = this.bb.__offset(this.bb_pos, 4);
              return u
                ? this.bb.readUint32(this.bb.__vector(this.bb_pos + u) + i * 4)
                : 0;
            }
            nodeIndicesLength() {
              let i = this.bb.__offset(this.bb_pos, 4);
            ...
            kernelDefHashes(i) {
              let u = this.bb.__offset(this.bb_pos, 6);
              return u
                ? this.bb.readUint64(this.bb.__vector(this.bb_pos + u) + i * 8)
                : this.bb.createLong(0, 0);
            }
            ...
            static createKernelCreateInfos(i, u, l) {
              return (
                r.startKernelCreateInfos(i),
                r.addNodeIndices(i, u),
                r.addKernelDefHashes(i, l),
                r.endKernelCreateInfos(i)
              );
            }
          }
        ...
        ((n) => {
          class r {
            ...
            sessionState(i) {
              let u = this.bb.__offset(this.bb_pos, 6);
              return u
                ? (i || new t.experimental.fbs.SessionState()).__init(
                    this.bb.__indirect(this.bb_pos + u),
                    this.bb
                  )
                : null;
            ...
            static createSubGraphSessionState(i, u, l) {
              return (
                r.startSubGraphSessionState(i),
                r.addGraphId(i, u),
                r.addSessionState(i, l),
                r.endSubGraphSessionState(i)
              );
            }
          }
        ...
        ((n) => {
          class r {
            ...
            kernels(i) {
              let u = this.bb.__offset(this.bb_pos, 4);
              return u
                ? (i || new t.experimental.fbs.KernelCreateInfos()).__init(
                    this.bb.__indirect(this.bb_pos + u),
                    this.bb
                  )
                : null;
            ...
            subGraphSessionStates(i, u) {
              let l = this.bb.__offset(this.bb_pos, 6);
              return l
                ? (u || new t.experimental.fbs.SubGraphSessionState()).__init(
                    this.bb.__indirect(
                      this.bb.__vector(this.bb_pos + l) + i * 4
                    ),
                    this.bb
            ...
            static createSessionState(i, u, l) {
              return (
                r.startSessionState(i),
                r.addKernels(i, u),
                r.addSubGraphSessionStates(i, l),
                r.endSessionState(i)
              );
            }
          }
        ...
        ((n) => {
          class r {
            ...
            model(i) {
              let u = this.bb.__offset(this.bb_pos, 6);
              return u
                ? (i || new t.experimental.fbs.Model()).__init(
                    this.bb.__indirect(this.bb_pos + u),
                    this.bb
                  )
                : null;
            ...
            static createInferenceSession(i, u, l, c) {
              return (
                r.startInferenceSession(i),
                r.addOrtVersion(i, u),
                r.addModel(i, l),
                r.addSessionState(i, c),
                r.endInferenceSession(i)
              );
            }
          }
...
var Bs = me((vy, ks) => {
  ...
  function Bd(a, t) {
    for (
      var o = new Array(arguments.length - 1), e = 0, r = 2, n = !0;
      r < arguments.length;
...
var Gs = me((Ms) => {
  ...
  Vn.decode = function (t, o, e) {
    for (var r = e, n = 0, s, i = 0; i < t.length; ) {
      ...
      if (u === 61 && n > 1) break;
      if ((u = Rs[u]) === void 0) throw Error(Ns);
      switch (n) {
        case 0:
          (s = u), (n = 1);
          break;
    ...
    return (
      typeof Float32Array < "u"
        ...
        : (function () {
            ...
            (a.writeFloatLE = t.bind(null, Ws)),
              (a.writeFloatBE = t.bind(null, Hs));
            function o(e, r, n) {
              var s = e(r, n),
                i = (s >> 31) * 2 + 1,
                u = (s >>> 23) & 255,
              ...
              return u === 255
                ? l
                  ...
                  : i * (1 / 0)
                : u === 0
                ? i * 1401298464324817e-60 * l
                : i * Math.pow(2, u - 150) * (l + 8388608);
            }
            (a.readFloatLE = o.bind(null, qs)),
              (a.readFloatBE = o.bind(null, js));
          })(),
      typeof Float64Array < "u"
        ...
        : (function () {
            function t(e, r, n, s, i, u) {
              ...
              if ((l && (s = -s), s === 0))
              ...
              else if (isNaN(s)) e(0, i, u + r), e(2146959360, i, u + n);
                ...
                if (s < 22250738585072014e-324)
                  (c = s / 5e-324),
                    e(c >>> 0, i, u + r),
                    e(((l << 31) | (c / 4294967296)) >>> 0, i, u + n);
                else {
                  var p = Math.floor(Math.log(s) / Math.LN2);
                  p === 1024 && (p = 1023),
                    (c = s * Math.pow(2, -p)),
                    e((c * 4503599627370496) >>> 0, i, u + r),
                    e(
                      ((l << 31) |
                        ((p + 1023) << 20) |
                        ((c * 1048576) & 1048575)) >>>
            ...
            (a.writeDoubleLE = t.bind(null, Ws, 0, 4)),
              (a.writeDoubleBE = t.bind(null, Hs, 4, 0));
            function o(e, r, n, s, i) {
              ...
              return p === 2047
                ...
                : p === 0
                ? c * 5e-324 * d
                : c * Math.pow(2, p - 1075) * (d + 4503599627370496);
            }
            (a.readDoubleLE = o.bind(null, qs, 0, 4)),
              (a.readDoubleBE = o.bind(null, js, 4, 0));
          })(),
      a
    );
  }
    ...
    for (var o = 0, e = 0, r = 0; r < t.length; ++r)
      (e = t.charCodeAt(r)),
        e < 128
          ...
          : e < 2048
          ? (o += 2)
          : (e & 64512) === 55296 && (t.charCodeAt(r + 1) & 64512) === 56320
          ? (++r, (o += 4))
          : (o += 3);
    return o;
  };
      ...
      (u = t[o++]),
        u < 128
          ...
          ? ((u =
            ...
            (s[i++] = 55296 + (u >> 10)),
            (s[i++] = 56320 + (u & 1023)))
          : (s[i++] = ((u & 15) << 12) | ((t[o++] & 63) << 6) | (t[o++] & 63)),
        i > 8191 &&
          ((n || (n = [])).push(String.fromCharCode.apply(String, s)), (i = 0));
    return n
      ? (i && n.push(String.fromCharCode.apply(String, s.slice(0, i))),
        n.join(""))
      : String.fromCharCode.apply(String, s.slice(0, i));
  };
    ...
    for (var r = e, n, s, i = 0; i < t.length; ++i)
      (n = t.charCodeAt(i)),
        n < 128
          ? (o[e++] = n)
          : n < 2048
          ? ((o[e++] = (n >> 6) | 192), (o[e++] = (n & 63) | 128))
          : (n & 64512) === 55296 &&
            ((s = t.charCodeAt(i + 1)) & 64512) === 56320
...
var ru = me((Py, tu) => {
  ...
  Ge.fromNumber = function (t) {
    ...
    return (
      o &&
        ((r = ~r >>> 0),
        (e = ~e >>> 0),
        ++e > 4294967295 && ((e = 0), ++r > 4294967295 && (r = 0))),
      new Ge(e, r)
    );
  };
  Ge.from = function (t) {
    ...
    if (rn.isString(t))
      if (rn.Long) t = rn.Long.fromString(t);
  ...
  Ge.prototype.toLong = function (t) {
    return rn.Long
      ? new rn.Long(this.lo | 0, this.hi | 0, !!t)
      : { low: this.lo | 0, high: this.hi | 0, unsigned: !!t };
  };
...
var Jt = me((ei) => {
  ...
  W.isset = W.isSet = function (t, o) {
    var e = t[o];
    return e != null && t.hasOwnProperty(o)
      ? typeof e != "object" ||
          (Array.isArray(e) ? e.length : Object.keys(e).length) > 0
      : !1;
  };
  W.Buffer = (function () {
    try {
  ...
  W.Long =
    (W.global.dcodeIO && W.global.dcodeIO.Long) ||
    W.global.Long ||
    W.inquire("long");
  ...
  W.toJSONOptions = { longs: String, enums: String, bytes: String, json: !0 };
...
var si = me((Dy, uu) => {
  ...
  pt.Array !== Array &&
    (se.alloc = pt.pool(se.alloc, pt.Array.prototype.subarray));
  se.prototype._push = function (t, o, e) {
    return (
      (this.tail = this.tail.next = new nn(t, o, e)), (this.len += o), this
    );
  };
  function oi(a, t, o) {
    t[o] = a & 255;
  ...
  se.prototype.fork = function () {
    return (
      (this.states = new Md(this)),
      (this.head = this.tail = new nn(ni, 0, 0)),
      (this.len = 0),
      this
    );
  };
  se.prototype.reset = function () {
    return (
      this.states
        ...
        : ((this.head = this.tail = new nn(ni, 0, 0)), (this.len = 0)),
      this
    );
  };
  se.prototype.ldelim = function () {
    ...
    return (
      this.reset().uint32(e),
      e && ((this.tail.next = t.next), (this.tail = o), (this.len += e)),
      this
    );
  };
  se.prototype.finish = function () {
    for (
      var t = this.head.next, o = this.constructor.alloc(this.len), e = 0;
      t;
...
var cu = me((Ly, fu) => {
  ...
  kt._configure = function () {
    (kt.alloc = Zt._Buffer_allocUnsafe),
      (kt.writeBytesBuffer =
        Zt.Buffer &&
        Zt.Buffer.prototype instanceof Uint8Array &&
        Zt.Buffer.prototype.set.name === "set"
          ? function (t, o, e) {
              o.set(t, e);
            }
          : function (t, o, e) {
...
var fi = me((Cy, bu) => {
  ...
  function Et(a, t) {
    return RangeError(
      "index out of range: " + a.pos + " + " + (t || 1) + " > " + a.len
    );
  }
  function Ae(a) {
  ...
  function ui() {
    ...
    if (this.len - this.pos > 4) {
      for (; t < 4; ++t)
        if (
          ((a.lo = (a.lo | ((this.buf[this.pos] & 127) << (t * 7))) >>> 0),
          this.buf[this.pos++] < 128)
        )
          return a;
      if (
      ...
      return (
        (a.lo = (a.lo | ((this.buf[this.pos++] & 127) << (t * 7))) >>> 0), a
      );
    }
    if (this.len - this.pos > 4) {
      for (; t < 5; ++t)
        if (
          ((a.hi = (a.hi | ((this.buf[this.pos] & 127) << (t * 7 + 3))) >>> 0),
          this.buf[this.pos++] < 128)
        )
          return a;
    } else
  ...
  function qn(a, t) {
    return (
      (a[t - 4] | (a[t - 3] << 8) | (a[t - 2] << 16) | (a[t - 1] << 24)) >>> 0
    );
  }
  ...
  Ae.prototype.skip = function (t) {
    if (typeof t == "number") {
      ...
      do if (this.pos >= this.len) throw Et(this);
  ...
  Ae._configure = function (a) {
    ...
    Pt.merge(Ae.prototype, {
      int64: function () {
        return ui.call(this)[t](!1);
      },
      uint64: function () {
        return ui.call(this)[t](!0);
      },
      sint64: function () {
        return ui.call(this).zzDecode()[t](!1);
      },
      fixed64: function () {
        return du.call(this)[t](!0);
      },
      sfixed64: function () {
        return du.call(this)[t](!1);
      },
    });
  };
});
  ...
  on.prototype.rpcCall = function a(t, o, e, r, n) {
    ...
    try {
      return s.rpcImpl(
        ...
        function (u, l) {
          if (u) return s.emit("error", u, t), n(u);
          if (l === null) {
            s.end(!0);
            return;
          }
...
var Eu = me((Pu) => {
  ...
  function Au() {
    ot.util._configure(),
      ot.Writer._configure(ot.BufferWriter),
      ot.Reader._configure(ot.BufferReader);
  }
  Au();
});
var Lu = me((Ry, Du) => {
...
var Cr = me((My, Cu) => {
  ...
  var ge = Lu(),
    ...
    Pe = ge.Writer,
    g = ge.util,
    h = ge.roots.default || (ge.roots.default = {});
  h.onnx = (function () {
    var a = {};
    return (
      (a.Version = (function () {
        var t = {},
          o = Object.create(t);
        return (
          (o[(t[0] = "_START_VERSION")] = 0),
          (o[(t[1] = "IR_VERSION_2017_10_10")] = 1),
          (o[(t[2] = "IR_VERSION_2017_10_30")] = 2),
          (o[(t[3] = "IR_VERSION_2017_11_3")] = 3),
          (o[(t[4] = "IR_VERSION_2019_1_22")] = 4),
          (o[(t[5] = "IR_VERSION_2019_3_18")] = 5),
          (o[(t[6] = "IR_VERSION_2019_9_19")] = 6),
          (o[(t[7] = "IR_VERSION_2020_5_8")] = 7),
          (o[(t[8] = "IR_VERSION_2021_7_30")] = 8),
          (o[(t[9] = "IR_VERSION")] = 9),
          o
        );
      })()),
      (a.AttributeProto = (function () {
        ...
        return (
          (t.prototype.name = ""),
          (t.prototype.refAttrName = ""),
          (t.prototype.docString = ""),
          (t.prototype.type = 0),
          (t.prototype.f = 0),
          (t.prototype.i = g.Long ? g.Long.fromBits(0, 0, !1) : 0),
          (t.prototype.s = g.newBuffer([])),
          (t.prototype.t = null),
          (t.prototype.g = null),
          (t.prototype.sparseTensor = null),
          (t.prototype.tp = null),
          (t.prototype.floats = g.emptyArray),
          (t.prototype.ints = g.emptyArray),
          (t.prototype.strings = g.emptyArray),
          (t.prototype.tensors = g.emptyArray),
          (t.prototype.graphs = g.emptyArray),
          (t.prototype.sparseTensors = g.emptyArray),
          (t.prototype.typeProtos = g.emptyArray),
          (t.create = function (e) {
            return new t(e);
          }),
          (t.encode = function (e, r) {
            if (
              ...
              e.name != null &&
                ...
                r.uint32(10).string(e.name),
              e.f != null &&
                Object.hasOwnProperty.call(e, "f") &&
                r.uint32(21).float(e.f),
              e.i != null &&
                Object.hasOwnProperty.call(e, "i") &&
                r.uint32(24).int64(e.i),
              e.s != null &&
                Object.hasOwnProperty.call(e, "s") &&
                r.uint32(34).bytes(e.s),
              e.t != null &&
                Object.hasOwnProperty.call(e, "t") &&
                h.onnx.TensorProto.encode(e.t, r.uint32(42).fork()).ldelim(),
              e.g != null &&
                Object.hasOwnProperty.call(e, "g") &&
                h.onnx.GraphProto.encode(e.g, r.uint32(50).fork()).ldelim(),
              e.floats != null && e.floats.length)
            ) {
              r.uint32(58).fork();
            ...
            if (
              (e.docString != null &&
                Object.hasOwnProperty.call(e, "docString") &&
                r.uint32(106).string(e.docString),
              e.tp != null &&
                Object.hasOwnProperty.call(e, "tp") &&
                h.onnx.TypeProto.encode(e.tp, r.uint32(114).fork()).ldelim(),
              e.typeProtos != null && e.typeProtos.length)
            )
            ...
            if (
              (e.type != null &&
                ...
                r.uint32(160).int32(e.type),
              e.refAttrName != null &&
                Object.hasOwnProperty.call(e, "refAttrName") &&
                r.uint32(170).string(e.refAttrName),
              e.sparseTensor != null &&
                Object.hasOwnProperty.call(e, "sparseTensor") &&
                h.onnx.SparseTensorProto.encode(
                  e.sparseTensor,
                  r.uint32(178).fork()
                ).ldelim(),
              e.sparseTensors != null && e.sparseTensors.length)
            )
          ...
          (t.decode = function (e, r) {
            ...
            for (
              ...
              switch (i >>> 3) {
                ...
                case 8: {
                  if (
                    ((s.ints && s.ints.length) || (s.ints = []), (i & 7) === 2)
                  )
                    for (var u = e.uint32() + e.pos; e.pos < u; )
                      s.ints.push(e.int64());
                ...
                case 9: {
                  (s.strings && s.strings.length) || (s.strings = []),
                    s.strings.push(e.bytes());
                  break;
                }
                case 10: {
                  (s.tensors && s.tensors.length) || (s.tensors = []),
                    s.tensors.push(h.onnx.TensorProto.decode(e, e.uint32()));
                  break;
                }
                case 11: {
                  (s.graphs && s.graphs.length) || (s.graphs = []),
                    s.graphs.push(h.onnx.GraphProto.decode(e, e.uint32()));
                  break;
                }
                case 23: {
                  (s.sparseTensors && s.sparseTensors.length) ||
                    ...
                    s.sparseTensors.push(
                      h.onnx.SparseTensorProto.decode(e, e.uint32())
                    );
                  break;
                }
                case 15: {
                  (s.typeProtos && s.typeProtos.length) || (s.typeProtos = []),
                    s.typeProtos.push(h.onnx.TypeProto.decode(e, e.uint32()));
                  break;
                }
                default:
                  e.skipType(i & 7);
          ...
          (t.verify = function (e) {
            ...
            if (
              ...
              !g.isString(e.refAttrName)
            )
              return "refAttrName: string expected";
            if (
              e.docString != null &&
              e.hasOwnProperty("docString") &&
              !g.isString(e.docString)
            )
            ...
            if (
              ...
              e.hasOwnProperty("i") &&
              !g.isInteger(e.i) &&
              !(e.i && g.isInteger(e.i.low) && g.isInteger(e.i.high))
            )
              return "i: integer|Long expected";
            if (
              e.s != null &&
              e.hasOwnProperty("s") &&
              !((e.s && typeof e.s.length == "number") || g.isString(e.s))
            )
            ...
            if (e.ints != null && e.hasOwnProperty("ints")) {
              ...
              for (var n = 0; n < e.ints.length; ++n)
                if (
                  !g.isInteger(e.ints[n]) &&
                  !(
                    e.ints[n] &&
                    g.isInteger(e.ints[n].low) &&
                    g.isInteger(e.ints[n].high)
                  )
                )
            ...
            if (e.strings != null && e.hasOwnProperty("strings")) {
              ...
              for (var n = 0; n < e.strings.length; ++n)
                if (
                  !(
                    (e.strings[n] && typeof e.strings[n].length == "number") ||
                    g.isString(e.strings[n])
                  )
                )
          ...
          (t.fromObject = function (e) {
            if (e instanceof h.onnx.AttributeProto) return e;
            var r = new h.onnx.AttributeProto();
            switch (
              (e.name != null && (r.name = String(e.name)),
              e.refAttrName != null && (r.refAttrName = String(e.refAttrName)),
              e.docString != null && (r.docString = String(e.docString)),
              e.type)
            ) {
              default:
            ...
            if (
              (e.f != null && (r.f = Number(e.f)),
              e.i != null &&
                (g.Long
                  ? ((r.i = g.Long.fromValue(e.i)).unsigned = !1)
                  : typeof e.i == "string"
                  ? (r.i = parseInt(e.i, 10))
                  : typeof e.i == "number"
                  ? (r.i = e.i)
              ...
              e.s != null &&
                (typeof e.s == "string"
                  ? g.base64.decode(
                      e.s,
                      (r.s = g.newBuffer(g.base64.length(e.s))),
                      0
                    )
                  : e.s.length >= 0 && (r.s = e.s)),
              e.t != null)
            ) {
            ...
            if (e.ints) {
              ...
              for (var n = 0; n < e.ints.length; ++n)
                g.Long
                  ? ((r.ints[n] = g.Long.fromValue(e.ints[n])).unsigned = !1)
                  : typeof e.ints[n] == "string"
                  ? (r.ints[n] = parseInt(e.ints[n], 10))
                  : typeof e.ints[n] == "number"
                  ? (r.ints[n] = e.ints[n])
                  : typeof e.ints[n] == "object" &&
                    (r.ints[n] = new g.LongBits(
                      e.ints[n].low >>> 0,
                      e.ints[n].high >>> 0
                    ).toNumber());
            }
            if (e.strings) {
              ...
              r.strings = [];
              for (var n = 0; n < e.strings.length; ++n)
                typeof e.strings[n] == "string"
                  ? g.base64.decode(
                      e.strings[n],
                      (r.strings[n] = g.newBuffer(
                        g.base64.length(e.strings[n])
                      )),
                      0
                    )
                  : e.strings[n].length >= 0 && (r.strings[n] = e.strings[n]);
            }
            if (e.tensors) {
          ...
          (t.toObject = function (e, r) {
            ...
            if (
              ...
              r.bytes === String
                ? (n.s = "")
                : ((n.s = []), r.bytes !== Array && (n.s = g.newBuffer(n.s))),
                (n.t = null),
                (n.g = null),
                (n.docString = ""),
                (n.tp = null),
            ...
            if (
              (e.name != null && e.hasOwnProperty("name") && (n.name = e.name),
              e.f != null &&
                e.hasOwnProperty("f") &&
                (n.f = r.json && !isFinite(e.f) ? String(e.f) : e.f),
              e.i != null &&
                e.hasOwnProperty("i") &&
                (typeof e.i == "number"
                  ? (n.i = r.longs === String ? String(e.i) : e.i)
                  : (n.i =
                      r.longs === String
                        ? g.Long.prototype.toString.call(e.i)
                        : r.longs === Number
                        ? new g.LongBits(
                            e.i.low >>> 0,
                            e.i.high >>> 0
              ...
              e.s != null &&
                ...
                (n.s =
                  r.bytes === String
                    ? g.base64.encode(e.s, 0, e.s.length)
                    : r.bytes === Array
                    ? Array.prototype.slice.call(e.s)
                    : e.s),
              e.t != null &&
                e.hasOwnProperty("t") &&
                (n.t = h.onnx.TensorProto.toObject(e.t, r)),
              e.g != null &&
                e.hasOwnProperty("g") &&
                (n.g = h.onnx.GraphProto.toObject(e.g, r)),
              e.floats && e.floats.length)
            ) {
              n.floats = [];
              for (var i = 0; i < e.floats.length; ++i)
                n.floats[i] =
                  r.json && !isFinite(e.floats[i])
                    ? String(e.floats[i])
                    : e.floats[i];
            }
            if (e.ints && e.ints.length) {
              ...
              for (var i = 0; i < e.ints.length; ++i)
                typeof e.ints[i] == "number"
                  ? (n.ints[i] =
                      r.longs === String ? String(e.ints[i]) : e.ints[i])
                  : (n.ints[i] =
                      r.longs === String
                        ? g.Long.prototype.toString.call(e.ints[i])
                        : r.longs === Number
                        ? new g.LongBits(
                            e.ints[i].low >>> 0,
                            e.ints[i].high >>> 0
            ...
            if (e.strings && e.strings.length) {
              ...
              for (var i = 0; i < e.strings.length; ++i)
                n.strings[i] =
                  r.bytes === String
                    ? g.base64.encode(e.strings[i], 0, e.strings[i].length)
                    : r.bytes === Array
                    ? Array.prototype.slice.call(e.strings[i])
                    : e.strings[i];
            }
            ...
            if (
              ...
              e.tp != null &&
                e.hasOwnProperty("tp") &&
                (n.tp = h.onnx.TypeProto.toObject(e.tp, r)),
              e.typeProtos && e.typeProtos.length)
            ) {
              n.typeProtos = [];
            ...
            if (
              (e.type != null &&
                ...
                (n.type =
                  r.enums === String
                    ? h.onnx.AttributeProto.AttributeType[e.type] === void 0
                      ? e.type
                      : h.onnx.AttributeProto.AttributeType[e.type]
                    : e.type),
              e.refAttrName != null &&
                e.hasOwnProperty("refAttrName") &&
                (n.refAttrName = e.refAttrName),
              e.sparseTensor != null &&
                e.hasOwnProperty("sparseTensor") &&
                (n.sparseTensor = h.onnx.SparseTensorProto.toObject(
                  e.sparseTensor,
                  r
                )),
              e.sparseTensors && e.sparseTensors.length)
            ) {
              n.sparseTensors = [];
              for (var i = 0; i < e.sparseTensors.length; ++i)
                n.sparseTensors[i] = h.onnx.SparseTensorProto.toObject(
                  e.sparseTensors[i],
                  r
                );
            }
          ...
          (t.AttributeType = (function () {
            ...
            return (
              ...
              (e[(o[4] = "TENSOR")] = 4),
              (e[(o[5] = "GRAPH")] = 5),
              (e[(o[11] = "SPARSE_TENSOR")] = 11),
              (e[(o[13] = "TYPE_PROTO")] = 13),
              (e[(o[6] = "FLOATS")] = 6),
              (e[(o[7] = "INTS")] = 7),
              (e[(o[8] = "STRINGS")] = 8),
              (e[(o[9] = "TENSORS")] = 9),
              (e[(o[10] = "GRAPHS")] = 10),
              (e[(o[12] = "SPARSE_TENSORS")] = 12),
              (e[(o[14] = "TYPE_PROTOS")] = 14),
              e
            );
          })()),
          t
        ...
        return (
          ...
          (t.encode = function (e, r) {
            return (
              ...
              e.type != null &&
                Object.hasOwnProperty.call(e, "type") &&
                h.onnx.TypeProto.encode(e.type, r.uint32(18).fork()).ldelim(),
              e.docString != null &&
                Object.hasOwnProperty.call(e, "docString") &&
                r.uint32(26).string(e.docString),
              r
            );
          }),
          (t.encodeDelimited = function (e, r) {
          ...
          (t.fromObject = function (e) {
            if (e instanceof h.onnx.ValueInfoProto) return e;
            ...
            return (
              e.docString != null && (r.docString = String(e.docString)), r
            );
          }),
          (t.toObject = function (e, r) {
            r || (r = {});
            ...
            return (
              ...
              e.type != null &&
                e.hasOwnProperty("type") &&
                (n.type = h.onnx.TypeProto.toObject(e.type, r)),
              e.docString != null &&
                e.hasOwnProperty("docString") &&
                (n.docString = e.docString),
              n
      ...
      (a.NodeProto = (function () {
        ...
        return (
          (t.prototype.input = g.emptyArray),
          (t.prototype.output = g.emptyArray),
          (t.prototype.name = ""),
          (t.prototype.opType = ""),
          (t.prototype.domain = ""),
          (t.prototype.attribute = g.emptyArray),
          (t.prototype.docString = ""),
          (t.create = function (e) {
            return new t(e);
          }),
          (t.encode = function (e, r) {
            ...
            if (
              (e.name != null &&
                Object.hasOwnProperty.call(e, "name") &&
                r.uint32(26).string(e.name),
              e.opType != null &&
                Object.hasOwnProperty.call(e, "opType") &&
                r.uint32(34).string(e.opType),
              e.attribute != null && e.attribute.length)
            )
            ...
            return (
              e.docString != null &&
                Object.hasOwnProperty.call(e, "docString") &&
                r.uint32(50).string(e.docString),
              e.domain != null &&
                Object.hasOwnProperty.call(e, "domain") &&
                r.uint32(58).string(e.domain),
              r
            );
          }),
          (t.encodeDelimited = function (e, r) {
              ...
              switch (i >>> 3) {
                case 1: {
                  (s.input && s.input.length) || (s.input = []),
                    s.input.push(e.string());
                  break;
                }
                case 2: {
                  (s.output && s.output.length) || (s.output = []),
                    s.output.push(e.string());
                  break;
                }
                case 3: {
                  s.name = e.string();
                ...
                case 5: {
                  (s.attribute && s.attribute.length) || (s.attribute = []),
                    s.attribute.push(
                      h.onnx.AttributeProto.decode(e, e.uint32())
                    );
                  break;
                }
                case 6: {
          ...
          (t.verify = function (e) {
            ...
            if (e.input != null && e.hasOwnProperty("input")) {
              ...
              for (var r = 0; r < e.input.length; ++r)
                if (!g.isString(e.input[r])) return "input: string[] expected";
            }
          ...
          (t.fromObject = function (e) {
            if (e instanceof h.onnx.NodeProto) return e;
            ...
            if (
              (e.name != null && (r.name = String(e.name)),
              e.opType != null && (r.opType = String(e.opType)),
              e.domain != null && (r.domain = String(e.domain)),
              e.attribute)
            ) {
              if (!Array.isArray(e.attribute))
          ...
          (t.getTypeUrl = function (e) {
            return (
              e === void 0 && (e = "type.googleapis.com"), e + "/onnx.NodeProto"
            );
          }),
          t
        );
      ...
      (a.TrainingInfoProto = (function () {
        ...
        return (
          (t.prototype.initialization = null),
          (t.prototype.algorithm = null),
          (t.prototype.initializationBinding = g.emptyArray),
          (t.prototype.updateBinding = g.emptyArray),
          (t.create = function (e) {
            return new t(e);
          }),
          (t.encode = function (e, r) {
            if (
              (r || (r = Pe.create()),
              e.initialization != null &&
                Object.hasOwnProperty.call(e, "initialization") &&
                h.onnx.GraphProto.encode(
                  e.initialization,
                  r.uint32(10).fork()
                ).ldelim(),
              e.algorithm != null &&
                Object.hasOwnProperty.call(e, "algorithm") &&
                h.onnx.GraphProto.encode(
                  e.algorithm,
                  r.uint32(18).fork()
                ).ldelim(),
              e.initializationBinding != null && e.initializationBinding.length)
            )
              for (var n = 0; n < e.initializationBinding.length; ++n)
                h.onnx.StringStringEntryProto.encode(
                  e.initializationBinding[n],
                  r.uint32(26).fork()
                ).ldelim();
                ...
                case 3: {
                  (s.initializationBinding && s.initializationBinding.length) ||
                    ...
                    s.initializationBinding.push(
                      h.onnx.StringStringEntryProto.decode(e, e.uint32())
                    );
                  break;
                }
                case 4: {
          ...
          (t.verify = function (e) {
            ...
            if (
              e.initialization != null &&
              e.hasOwnProperty("initialization")
            ) {
            ...
            if (
              e.initializationBinding != null &&
              e.hasOwnProperty("initializationBinding")
            ) {
          ...
          (t.fromObject = function (e) {
            if (e instanceof h.onnx.TrainingInfoProto) return e;
          ...
          (t.toObject = function (e, r) {
            ...
            if (
              ...
              e.algorithm != null &&
                e.hasOwnProperty("algorithm") &&
                (n.algorithm = h.onnx.GraphProto.toObject(e.algorithm, r)),
              e.initializationBinding && e.initializationBinding.length)
            ) {
      ...
      (a.ModelProto = (function () {
        ...
        return (
          (t.prototype.irVersion = g.Long ? g.Long.fromBits(0, 0, !1) : 0),
          (t.prototype.opsetImport = g.emptyArray),
          (t.prototype.producerName = ""),
          (t.prototype.producerVersion = ""),
          (t.prototype.domain = ""),
          (t.prototype.modelVersion = g.Long ? g.Long.fromBits(0, 0, !1) : 0),
          (t.prototype.docString = ""),
          (t.prototype.graph = null),
          (t.prototype.metadataProps = g.emptyArray),
          (t.prototype.trainingInfo = g.emptyArray),
          (t.prototype.functions = g.emptyArray),
          (t.create = function (e) {
            return new t(e);
          }),
          (t.encode = function (e, r) {
            if (
              (r || (r = Pe.create()),
              e.irVersion != null &&
                Object.hasOwnProperty.call(e, "irVersion") &&
                r.uint32(8).int64(e.irVersion),
              e.producerName != null &&
                Object.hasOwnProperty.call(e, "producerName") &&
                r.uint32(18).string(e.producerName),
              e.producerVersion != null &&
                Object.hasOwnProperty.call(e, "producerVersion") &&
                r.uint32(26).string(e.producerVersion),
              e.domain != null &&
                Object.hasOwnProperty.call(e, "domain") &&
                r.uint32(34).string(e.domain),
              e.modelVersion != null &&
              ...
              e.docString != null &&
                ...
                r.uint32(50).string(e.docString),
              e.graph != null &&
                Object.hasOwnProperty.call(e, "graph") &&
                h.onnx.GraphProto.encode(e.graph, r.uint32(58).fork()).ldelim(),
              e.opsetImport != null && e.opsetImport.length)
            )
              ...
              switch (i >>> 3) {
                ...
                case 8: {
                  (s.opsetImport && s.opsetImport.length) ||
                    (s.opsetImport = []),
                    s.opsetImport.push(
                      h.onnx.OperatorSetIdProto.decode(e, e.uint32())
                    );
                  break;
                }
                case 2: {
                ...
                case 20: {
                  (s.trainingInfo && s.trainingInfo.length) ||
                    (s.trainingInfo = []),
                    s.trainingInfo.push(
                      h.onnx.TrainingInfoProto.decode(e, e.uint32())
                    );
                  break;
                }
                case 25: {
                  (s.functions && s.functions.length) || (s.functions = []),
                    s.functions.push(
                      h.onnx.FunctionProto.decode(e, e.uint32())
                    );
                  break;
                }
                default:
          ...
          (t.verify = function (e) {
            ...
            if (
              ...
              !g.isInteger(e.irVersion) &&
              !(
                e.irVersion &&
                g.isInteger(e.irVersion.low) &&
                g.isInteger(e.irVersion.high)
              )
            )
            ...
            if (
              ...
              !g.isString(e.producerName)
            )
              return "producerName: string expected";
            if (
              e.producerVersion != null &&
              e.hasOwnProperty("producerVersion") &&
              !g.isString(e.producerVersion)
            )
            ...
            if (
              ...
              !(
                e.modelVersion &&
                g.isInteger(e.modelVersion.low) &&
                g.isInteger(e.modelVersion.high)
              )
            )
          ...
          (t.fromObject = function (e) {
            if (e instanceof h.onnx.ModelProto) return e;
            var r = new h.onnx.ModelProto();
            if (
              (e.irVersion != null &&
                (g.Long
                  ? ((r.irVersion = g.Long.fromValue(e.irVersion)).unsigned =
                      !1)
                  : typeof e.irVersion == "string"
                  ? (r.irVersion = parseInt(e.irVersion, 10))
                  : typeof e.irVersion == "number"
                  ? (r.irVersion = e.irVersion)
                  : typeof e.irVersion == "object" &&
                    (r.irVersion = new g.LongBits(
                      e.irVersion.low >>> 0,
                      e.irVersion.high >>> 0
                    ).toNumber())),
              e.opsetImport)
            ...
            if (
              (e.producerName != null &&
                (r.producerName = String(e.producerName)),
              e.producerVersion != null &&
                (r.producerVersion = String(e.producerVersion)),
              e.domain != null && (r.domain = String(e.domain)),
              e.modelVersion != null &&
                (g.Long
                  ? ((r.modelVersion = g.Long.fromValue(
                      e.modelVersion
                    )).unsigned = !1)
                  : typeof e.modelVersion == "string"
                  ? (r.modelVersion = parseInt(e.modelVersion, 10))
                  : typeof e.modelVersion == "number"
                  ? (r.modelVersion = e.modelVersion)
                  : typeof e.modelVersion == "object" &&
                    (r.modelVersion = new g.LongBits(
          ...
          (t.toObject = function (e, r) {
            ...
            if (
              (e.irVersion != null &&
                ...
                (typeof e.irVersion == "number"
                  ? (n.irVersion =
                      r.longs === String ? String(e.irVersion) : e.irVersion)
                  : (n.irVersion =
                      r.longs === String
                        ? g.Long.prototype.toString.call(e.irVersion)
                        : r.longs === Number
                        ? new g.LongBits(
                            e.irVersion.low >>> 0,
                            e.irVersion.high >>> 0
              ...
              e.modelVersion != null &&
                ...
                (typeof e.modelVersion == "number"
                  ...
                  : (n.modelVersion =
                      r.longs === String
                        ? g.Long.prototype.toString.call(e.modelVersion)
                        : r.longs === Number
                        ? new g.LongBits(
                            e.modelVersion.low >>> 0,
                            e.modelVersion.high >>> 0
              ...
              e.graph != null &&
                ...
                (n.graph = h.onnx.GraphProto.toObject(e.graph, r)),
              e.opsetImport && e.opsetImport.length)
            ) {
              n.opsetImport = [];
              for (var i = 0; i < e.opsetImport.length; ++i)
                n.opsetImport[i] = h.onnx.OperatorSetIdProto.toObject(
                  e.opsetImport[i],
                  r
                );
            }
            if (e.metadataProps && e.metadataProps.length) {
              ...
              for (var i = 0; i < e.metadataProps.length; ++i)
                n.metadataProps[i] = h.onnx.StringStringEntryProto.toObject(
                  e.metadataProps[i],
                  r
                );
            }
            if (e.trainingInfo && e.trainingInfo.length) {
              ...
              for (var i = 0; i < e.trainingInfo.length; ++i)
                n.trainingInfo[i] = h.onnx.TrainingInfoProto.toObject(
                  e.trainingInfo[i],
                  r
                );
            }
            if (e.functions && e.functions.length) {
              ...
              for (var i = 0; i < e.functions.length; ++i)
                n.functions[i] = h.onnx.FunctionProto.toObject(
                  e.functions[i],
                  r
                );
            }
        ...
        return (
          ...
          (t.encode = function (e, r) {
            return (
              ...
              e.key != null &&
                ...
                r.uint32(10).string(e.key),
              e.value != null &&
                Object.hasOwnProperty.call(e, "value") &&
                r.uint32(18).string(e.value),
              r
            );
          }),
          (t.encodeDelimited = function (e, r) {
          ...
          (t.verify = function (e) {
            return typeof e != "object" || e === null
              ? "object expected"
              : e.key != null && e.hasOwnProperty("key") && !g.isString(e.key)
              ? "key: string expected"
              : e.value != null &&
          ...
          (t.fromObject = function (e) {
            if (e instanceof h.onnx.StringStringEntryProto) return e;
            var r = new h.onnx.StringStringEntryProto();
            return (
              e.key != null && (r.key = String(e.key)),
              e.value != null && (r.value = String(e.value)),
              r
            );
          }),
          (t.toObject = function (e, r) {
            ...
            return (
              ...
              e.key != null && e.hasOwnProperty("key") && (n.key = e.key),
              e.value != null &&
                e.hasOwnProperty("value") &&
                (n.value = e.value),
              n
      ...
      (a.TensorAnnotation = (function () {
        ...
        return (
          (t.prototype.tensorName = ""),
          (t.prototype.quantParameterTensorNames = g.emptyArray),
          (t.create = function (e) {
            return new t(e);
          }),
          (t.encode = function (e, r) {
            if (
              (r || (r = Pe.create()),
              e.tensorName != null &&
                Object.hasOwnProperty.call(e, "tensorName") &&
                r.uint32(10).string(e.tensorName),
              e.quantParameterTensorNames != null &&
                e.quantParameterTensorNames.length)
            )
          ...
          (t.fromObject = function (e) {
            if (e instanceof h.onnx.TensorAnnotation) return e;
            var r = new h.onnx.TensorAnnotation();
            if (
              (e.tensorName != null && (r.tensorName = String(e.tensorName)),
      ...
      (a.GraphProto = (function () {
        ...
        return (
          (t.prototype.node = g.emptyArray),
          (t.prototype.name = ""),
          (t.prototype.initializer = g.emptyArray),
          (t.prototype.sparseInitializer = g.emptyArray),
          (t.prototype.docString = ""),
          (t.prototype.input = g.emptyArray),
          (t.prototype.output = g.emptyArray),
          (t.prototype.valueInfo = g.emptyArray),
          (t.prototype.quantizationAnnotation = g.emptyArray),
          (t.create = function (e) {
            return new t(e);
          }),
          (t.encode = function (e, r) {
            ...
            if (
              (e.name != null &&
                Object.hasOwnProperty.call(e, "name") &&
                r.uint32(18).string(e.name),
              e.initializer != null && e.initializer.length)
            )
            ...
            if (
              (e.docString != null &&
                Object.hasOwnProperty.call(e, "docString") &&
                r.uint32(82).string(e.docString),
              e.input != null && e.input.length)
            )
              for (var n = 0; n < e.input.length; ++n)
            ...
            if (
              e.quantizationAnnotation != null &&
              e.quantizationAnnotation.length
            )
              ...
              switch (i >>> 3) {
                case 1: {
                  (s.node && s.node.length) || (s.node = []),
                    s.node.push(h.onnx.NodeProto.decode(e, e.uint32()));
                  break;
                }
                case 2: {
                  s.name = e.string();
                ...
                case 5: {
                  (s.initializer && s.initializer.length) ||
                    (s.initializer = []),
                    s.initializer.push(
                      h.onnx.TensorProto.decode(e, e.uint32())
                    );
                  break;
                }
                case 15: {
                ...
                case 11: {
                  (s.input && s.input.length) || (s.input = []),
                    s.input.push(h.onnx.ValueInfoProto.decode(e, e.uint32()));
                  break;
                }
                case 12: {
                  (s.output && s.output.length) || (s.output = []),
                    s.output.push(h.onnx.ValueInfoProto.decode(e, e.uint32()));
                  break;
                }
                case 13: {
                  (s.valueInfo && s.valueInfo.length) || (s.valueInfo = []),
                    s.valueInfo.push(
                      h.onnx.ValueInfoProto.decode(e, e.uint32())
                    );
                  break;
                }
                case 14: {
                  (s.quantizationAnnotation &&
                    ...
                    s.quantizationAnnotation.push(
                      h.onnx.TensorAnnotation.decode(e, e.uint32())
                    );
                  break;
                }
                default:
          ...
          (t.verify = function (e) {
            ...
            if (
              e.sparseInitializer != null &&
              e.hasOwnProperty("sparseInitializer")
            ) {
          ...
          (t.fromObject = function (e) {
            if (e instanceof h.onnx.GraphProto) return e;
      ...
      (a.TensorProto = (function () {
        ...
        return (
          (t.prototype.dims = g.emptyArray),
          (t.prototype.dataType = 0),
          (t.prototype.segment = null),
          (t.prototype.floatData = g.emptyArray),
          (t.prototype.int32Data = g.emptyArray),
          (t.prototype.stringData = g.emptyArray),
          (t.prototype.int64Data = g.emptyArray),
          (t.prototype.name = ""),
          (t.prototype.docString = ""),
          (t.prototype.rawData = g.newBuffer([])),
          (t.prototype.externalData = g.emptyArray),
          (t.prototype.dataLocation = 0),
          (t.prototype.doubleData = g.emptyArray),
          (t.prototype.uint64Data = g.emptyArray),
          (t.create = function (e) {
            return new t(e);
          }),
          (t.encode = function (e, r) {
            ...
            if (
              (e.dataType != null &&
                Object.hasOwnProperty.call(e, "dataType") &&
                r.uint32(16).int32(e.dataType),
              e.segment != null &&
              ...
              e.floatData != null && e.floatData.length)
            ) {
              r.uint32(34).fork();
            ...
            if (
              (e.name != null &&
                Object.hasOwnProperty.call(e, "name") &&
                r.uint32(66).string(e.name),
              e.rawData != null &&
                Object.hasOwnProperty.call(e, "rawData") &&
                r.uint32(74).bytes(e.rawData),
              e.doubleData != null && e.doubleData.length)
            ) {
              r.uint32(82).fork();
            ...
            if (
              (e.docString != null &&
                Object.hasOwnProperty.call(e, "docString") &&
                r.uint32(98).string(e.docString),
              e.externalData != null && e.externalData.length)
            )
          ...
          (t.decode = function (e, r) {
            ...
            for (
              ...
              switch (i >>> 3) {
                case 1: {
                  if (
                    ((s.dims && s.dims.length) || (s.dims = []), (i & 7) === 2)
                  )
                    for (var u = e.uint32() + e.pos; e.pos < u; )
                      s.dims.push(e.int64());
          ...
          (t.verify = function (e) {
            ...
            if (e.dims != null && e.hasOwnProperty("dims")) {
              ...
              for (var r = 0; r < e.dims.length; ++r)
                if (
                  !g.isInteger(e.dims[r]) &&
                  !(
                    e.dims[r] &&
                    g.isInteger(e.dims[r].low) &&
                    g.isInteger(e.dims[r].high)
                  )
                )
            ...
            if (e.stringData != null && e.hasOwnProperty("stringData")) {
              ...
              for (var r = 0; r < e.stringData.length; ++r)
                if (
                  !(
                    (e.stringData[r] &&
                      typeof e.stringData[r].length == "number") ||
                    g.isString(e.stringData[r])
                  )
                )
            ...
            if (e.int64Data != null && e.hasOwnProperty("int64Data")) {
              ...
              for (var r = 0; r < e.int64Data.length; ++r)
                if (
                  !g.isInteger(e.int64Data[r]) &&
                  !(
                    e.int64Data[r] &&
                    g.isInteger(e.int64Data[r].low) &&
                    g.isInteger(e.int64Data[r].high)
                  )
                )
            ...
            if (
              ...
              !(
                (e.rawData && typeof e.rawData.length == "number") ||
                g.isString(e.rawData)
              )
            )
            ...
            if (e.uint64Data != null && e.hasOwnProperty("uint64Data")) {
              ...
              for (var r = 0; r < e.uint64Data.length; ++r)
                if (
                  !g.isInteger(e.uint64Data[r]) &&
                  !(
                    e.uint64Data[r] &&
                    g.isInteger(e.uint64Data[r].low) &&
                    g.isInteger(e.uint64Data[r].high)
                  )
                )
          ...
          (t.fromObject = function (e) {
            if (e instanceof h.onnx.TensorProto) return e;
            ...
            if (e.dims) {
              ...
              for (var n = 0; n < e.dims.length; ++n)
                g.Long
                  ? ((r.dims[n] = g.Long.fromValue(e.dims[n])).unsigned = !1)
                  : typeof e.dims[n] == "string"
                  ? (r.dims[n] = parseInt(e.dims[n], 10))
                  : typeof e.dims[n] == "number"
                  ? (r.dims[n] = e.dims[n])
                  : typeof e.dims[n] == "object" &&
                    (r.dims[n] = new g.LongBits(
                      e.dims[n].low >>> 0,
                      e.dims[n].high >>> 0
                    ).toNumber());
            }
            if (
              (e.dataType != null && (r.dataType = e.dataType | 0),
              e.segment != null)
            ) {
            ...
            if (e.stringData) {
              ...
              r.stringData = [];
              for (var n = 0; n < e.stringData.length; ++n)
                typeof e.stringData[n] == "string"
                  ? g.base64.decode(
                      e.stringData[n],
                      (r.stringData[n] = g.newBuffer(
                        g.base64.length(e.stringData[n])
                      )),
                      0
                    )
                  : e.stringData[n].length >= 0 &&
                    (r.stringData[n] = e.stringData[n]);
            }
            if (e.int64Data) {
              if (!Array.isArray(e.int64Data))
              ...
              for (var n = 0; n < e.int64Data.length; ++n)
                g.Long
                  ? ((r.int64Data[n] = g.Long.fromValue(
                      e.int64Data[n]
                    )).unsigned = !1)
                  : typeof e.int64Data[n] == "string"
                  ? (r.int64Data[n] = parseInt(e.int64Data[n], 10))
                  : typeof e.int64Data[n] == "number"
                  ? (r.int64Data[n] = e.int64Data[n])
                  : typeof e.int64Data[n] == "object" &&
                    (r.int64Data[n] = new g.LongBits(
                      e.int64Data[n].low >>> 0,
            ...
            if (
              ...
              e.docString != null && (r.docString = String(e.docString)),
              e.rawData != null &&
                (typeof e.rawData == "string"
                  ? g.base64.decode(
                      e.rawData,
                      (r.rawData = g.newBuffer(g.base64.length(e.rawData))),
                      0
                    )
                  : e.rawData.length >= 0 && (r.rawData = e.rawData)),
              e.externalData)
            ) {
              if (!Array.isArray(e.externalData))
                throw TypeError(
            ...
            if (e.uint64Data) {
              ...
              for (var n = 0; n < e.uint64Data.length; ++n)
                g.Long
                  ? ((r.uint64Data[n] = g.Long.fromValue(
                      e.uint64Data[n]
                    )).unsigned = !0)
                  : typeof e.uint64Data[n] == "string"
                  ? (r.uint64Data[n] = parseInt(e.uint64Data[n], 10))
                  : typeof e.uint64Data[n] == "number"
                  ? (r.uint64Data[n] = e.uint64Data[n])
                  : typeof e.uint64Data[n] == "object" &&
                    (r.uint64Data[n] = new g.LongBits(
          ...
          (t.toObject = function (e, r) {
            ...
            if (
              ...
              r.defaults &&
                ...
                r.bytes === String
                  ? (n.rawData = "")
                  : ((n.rawData = []),
                    r.bytes !== Array && (n.rawData = g.newBuffer(n.rawData))),
                (n.docString = ""),
              ...
              for (var s = 0; s < e.dims.length; ++s)
                typeof e.dims[s] == "number"
                  ? (n.dims[s] =
                      r.longs === String ? String(e.dims[s]) : e.dims[s])
                  : (n.dims[s] =
                      r.longs === String
                        ? g.Long.prototype.toString.call(e.dims[s])
                        : r.longs === Number
                        ? new g.LongBits(
                            e.dims[s].low >>> 0,
                            e.dims[s].high >>> 0
            ...
            if (
              ...
              e.segment != null &&
                ...
                (n.segment = h.onnx.TensorProto.Segment.toObject(e.segment, r)),
              e.floatData && e.floatData.length)
            ) {
              n.floatData = [];
              for (var s = 0; s < e.floatData.length; ++s)
                n.floatData[s] =
                  r.json && !isFinite(e.floatData[s])
                    ? String(e.floatData[s])
                    : e.floatData[s];
            }
                ...
                n.stringData[s] =
                  r.bytes === String
                    ? g.base64.encode(
                        e.stringData[s],
                        0,
                        e.stringData[s].length
                      )
                    : r.bytes === Array
                    ? Array.prototype.slice.call(e.stringData[s])
                    : e.stringData[s];
            }
            if (e.int64Data && e.int64Data.length) {
              n.int64Data = [];
              for (var s = 0; s < e.int64Data.length; ++s)
                typeof e.int64Data[s] == "number"
                  ? (n.int64Data[s] =
                      r.longs === String
                        ? String(e.int64Data[s])
                        : e.int64Data[s])
                  : (n.int64Data[s] =
                      r.longs === String
                        ? g.Long.prototype.toString.call(e.int64Data[s])
                        : r.longs === Number
                        ? new g.LongBits(
                            e.int64Data[s].low >>> 0,
                            e.int64Data[s].high >>> 0
                          ).toNumber()
                        : e.int64Data[s]);
            }
            if (
              ...
              e.rawData != null &&
                ...
                (n.rawData =
                  r.bytes === String
                    ? g.base64.encode(e.rawData, 0, e.rawData.length)
                    : r.bytes === Array
              ...
              for (var s = 0; s < e.doubleData.length; ++s)
                n.doubleData[s] =
                  r.json && !isFinite(e.doubleData[s])
                    ? String(e.doubleData[s])
                    : e.doubleData[s];
            }
            if (e.uint64Data && e.uint64Data.length) {
              n.uint64Data = [];
              for (var s = 0; s < e.uint64Data.length; ++s)
                typeof e.uint64Data[s] == "number"
                  ? (n.uint64Data[s] =
                      r.longs === String
                        ? String(e.uint64Data[s])
                        : e.uint64Data[s])
                  : (n.uint64Data[s] =
                      r.longs === String
                        ? g.Long.prototype.toString.call(e.uint64Data[s])
                        : r.longs === Number
                        ? new g.LongBits(
                            e.uint64Data[s].low >>> 0,
                            e.uint64Data[s].high >>> 0
                          ).toNumber(!0)
                        : e.uint64Data[s]);
            }
            if (
            ...
            return (
              e.dataLocation != null &&
                ...
                (n.dataLocation =
                  r.enums === String
                    ? h.onnx.TensorProto.DataLocation[e.dataLocation] === void 0
                      ? e.dataLocation
          ...
          (t.DataType = (function () {
            ...
            return (
              ...
              (e[(o[13] = "UINT64")] = 13),
              (e[(o[14] = "COMPLEX64")] = 14),
              (e[(o[15] = "COMPLEX128")] = 15),
              (e[(o[16] = "BFLOAT16")] = 16),
              (e[(o[17] = "FLOAT8E4M3FN")] = 17),
              (e[(o[18] = "FLOAT8E4M3FNUZ")] = 18),
              (e[(o[19] = "FLOAT8E5M2")] = 19),
              (e[(o[20] = "FLOAT8E5M2FNUZ")] = 20),
              e
            );
          })()),
          (t.Segment = (function () {
            ...
            return (
              (o.prototype.begin = g.Long ? g.Long.fromBits(0, 0, !1) : 0),
              (o.prototype.end = g.Long ? g.Long.fromBits(0, 0, !1) : 0),
              (o.create = function (r) {
                return new o(r);
              }),
              ...
              (o.decode = function (r, n) {
                ...
                for (
                  var s = n === void 0 ? r.len : r.pos + n,
                    i = new h.onnx.TensorProto.Segment();
                  r.pos < s;
              ...
              (o.decodeDelimited = function (r) {
                return (
                  r instanceof N || (r = new N(r)), this.decode(r, r.uint32())
                );
              }),
              (o.verify = function (r) {
                return typeof r != "object" || r === null
                  ...
                  : r.begin != null &&
                    ...
                    !(
                      r.begin &&
                      g.isInteger(r.begin.low) &&
                      g.isInteger(r.begin.high)
                    )
                  ...
                  : r.end != null &&
                    ...
                    !(
                      r.end &&
                      g.isInteger(r.end.low) &&
                      g.isInteger(r.end.high)
                    )
              ...
              (o.fromObject = function (r) {
                ...
                return (
                  r.begin != null &&
                    (g.Long
                      ? ((n.begin = g.Long.fromValue(r.begin)).unsigned = !1)
                      : typeof r.begin == "string"
                      ? (n.begin = parseInt(r.begin, 10))
                      : typeof r.begin == "number"
                      ? (n.begin = r.begin)
                      : typeof r.begin == "object" &&
                        (n.begin = new g.LongBits(
                          r.begin.low >>> 0,
                          r.begin.high >>> 0
                        ).toNumber())),
                  r.end != null &&
                    (g.Long
                      ? ((n.end = g.Long.fromValue(r.end)).unsigned = !1)
                      : typeof r.end == "string"
                      ? (n.end = parseInt(r.end, 10))
                      : typeof r.end == "number"
                      ? (n.end = r.end)
                      : typeof r.end == "object" &&
                        (n.end = new g.LongBits(
                          r.end.low >>> 0,
                          r.end.high >>> 0
                        ).toNumber())),
                  n
                ...
                return (
                  r.begin != null &&
                    ...
                    (typeof r.begin == "number"
                      ...
                      : (s.begin =
                          n.longs === String
                            ? g.Long.prototype.toString.call(r.begin)
                            : n.longs === Number
                            ? new g.LongBits(
                                r.begin.low >>> 0,
                                r.begin.high >>> 0
                  ...
                  r.end != null &&
                    ...
                    (typeof r.end == "number"
                      ...
                      : (s.end =
                          n.longs === String
                            ? g.Long.prototype.toString.call(r.end)
                            : n.longs === Number
                            ? new g.LongBits(
                                r.end.low >>> 0,
                                r.end.high >>> 0
      ...
      (a.SparseTensorProto = (function () {
        ...
        return (
          (t.prototype.values = null),
          (t.prototype.indices = null),
          (t.prototype.dims = g.emptyArray),
          (t.create = function (e) {
            return new t(e);
          }),
          (t.encode = function (e, r) {
            if (
              (r || (r = Pe.create()),
              e.values != null &&
                Object.hasOwnProperty.call(e, "values") &&
                h.onnx.TensorProto.encode(
                  e.values,
                  r.uint32(10).fork()
                ).ldelim(),
              e.indices != null &&
                Object.hasOwnProperty.call(e, "indices") &&
                h.onnx.TensorProto.encode(
                  e.indices,
                  r.uint32(18).fork()
                ).ldelim(),
              e.dims != null && e.dims.length)
            ) {
              r.uint32(26).fork();
              for (var n = 0; n < e.dims.length; ++n) r.int64(e.dims[n]);
              r.ldelim();
          ...
          (t.verify = function (e) {
            ...
            if (e.dims != null && e.hasOwnProperty("dims")) {
              ...
              for (var n = 0; n < e.dims.length; ++n)
                if (
                  !g.isInteger(e.dims[n]) &&
                  !(
                    e.dims[n] &&
                    g.isInteger(e.dims[n].low) &&
                    g.isInteger(e.dims[n].high)
                  )
                )
                  return "dims: integer|Long[] expected";
            }
          ...
          (t.fromObject = function (e) {
            if (e instanceof h.onnx.SparseTensorProto) return e;
          ...
          (t.toObject = function (e, r) {
            ...
            if (
              ...
              e.values != null &&
                e.hasOwnProperty("values") &&
                (n.values = h.onnx.TensorProto.toObject(e.values, r)),
              e.indices != null &&
                e.hasOwnProperty("indices") &&
                (n.indices = h.onnx.TensorProto.toObject(e.indices, r)),
              e.dims && e.dims.length)
            ) {
              n.dims = [];
              for (var s = 0; s < e.dims.length; ++s)
      ...
      (a.TensorShapeProto = (function () {
        ...
        return (
              ...
              switch (i >>> 3) {
                case 1: {
                  (s.dim && s.dim.length) || (s.dim = []),
                    s.dim.push(
                      h.onnx.TensorShapeProto.Dimension.decode(e, e.uint32())
                    );
                  break;
                }
                default:
          ...
          (t.fromObject = function (e) {
            if (e instanceof h.onnx.TensorShapeProto) return e;
          ...
          (t.toObject = function (e, r) {
            ...
            var n = {};
            if (
              ((r.arrays || r.defaults) && (n.dim = []), e.dim && e.dim.length)
            ) {
              n.dim = [];
          ...
          (t.Dimension = (function () {
            ...
            return (
              Object.defineProperty(o.prototype, "value", {
                get: g.oneOfGetter((e = ["dimValue", "dimParam"])),
                set: g.oneOfSetter(e),
              }),
              (o.create = function (n) {
                return new o(n);
              ...
              (o.decodeDelimited = function (n) {
                return (
                  n instanceof N || (n = new N(n)), this.decode(n, n.uint32())
                );
              }),
              (o.verify = function (n) {
                ...
                if (
                  ...
                  ((s.value = 1),
                  !g.isInteger(n.dimValue) &&
                    !(
                      n.dimValue &&
                      g.isInteger(n.dimValue.low) &&
                      g.isInteger(n.dimValue.high)
                    ))
                )
              ...
              (o.fromObject = function (n) {
                ...
                return (
                  n.dimValue != null &&
                    (g.Long
                      ? ((s.dimValue = g.Long.fromValue(n.dimValue)).unsigned =
                          !1)
                ...
                return (
                  ...
                  n.dimValue != null &&
                    ...
                    (typeof n.dimValue == "number"
                      ...
                      : (i.dimValue =
                          s.longs === String
                            ? g.Long.prototype.toString.call(n.dimValue)
                            : s.longs === Number
                            ? new g.LongBits(
                                n.dimValue.low >>> 0,
                                n.dimValue.high >>> 0
                            ...
                            : n.dimValue),
                    s.oneofs && (i.value = "dimValue")),
                  n.dimParam != null &&
                    n.hasOwnProperty("dimParam") &&
                    ((i.dimParam = n.dimParam),
                    s.oneofs && (i.value = "dimParam")),
                  n.denotation != null &&
                    n.hasOwnProperty("denotation") &&
                    (i.denotation = n.denotation),
                  i
                );
              }),
              (o.prototype.toJSON = function () {
      ...
      (a.TypeProto = (function () {
        ...
        (t.prototype.tensorType = null),
          (t.prototype.sequenceType = null),
          (t.prototype.mapType = null),
          (t.prototype.optionalType = null),
          (t.prototype.sparseTensorType = null),
          (t.prototype.denotation = "");
        var o;
        return (
          ...
          (t.decode = function (r, n) {
            ...
            for (
              ...
              switch (u >>> 3) {
                ...
                case 4: {
                  i.sequenceType = h.onnx.TypeProto.Sequence.decode(
                    r,
                    r.uint32()
                  );
                  break;
                ...
                case 9: {
                  i.optionalType = h.onnx.TypeProto.Optional.decode(
                    r,
                    r.uint32()
                  );
                  break;
                ...
                case 8: {
                  i.sparseTensorType = h.onnx.TypeProto.SparseTensor.decode(
                    r,
                    r.uint32()
                  );
                  break;
          ...
          (t.Tensor = (function () {
            ...
            return (
              ...
              (e.toObject = function (n, s) {
                ...
                var i = {};
                return (
                  s.defaults && ((i.elemType = 0), (i.shape = null)),
                  n.elemType != null &&
                    n.hasOwnProperty("elemType") &&
                    (i.elemType = n.elemType),
                  n.shape != null &&
                    n.hasOwnProperty("shape") &&
                    (i.shape = h.onnx.TensorShapeProto.toObject(n.shape, s)),
                  i
                );
              }),
          ...
          (t.Sequence = (function () {
            ...
            return (
              ...
              (e.toObject = function (n, s) {
                ...
                var i = {};
                return (
                  s.defaults && (i.elemType = null),
                  n.elemType != null &&
                    n.hasOwnProperty("elemType") &&
                    (i.elemType = h.onnx.TypeProto.toObject(n.elemType, s)),
                  i
                );
              }),
              (e.prototype.toJSON = function () {
          ...
          (t.Map = (function () {
            ...
            return (
              ...
              (e.toObject = function (n, s) {
                ...
                var i = {};
                return (
                  s.defaults && ((i.keyType = 0), (i.valueType = null)),
                  n.keyType != null &&
                    n.hasOwnProperty("keyType") &&
                    (i.keyType = n.keyType),
                  n.valueType != null &&
                    n.hasOwnProperty("valueType") &&
                    (i.valueType = h.onnx.TypeProto.toObject(n.valueType, s)),
                  i
                );
              }),
              (e.prototype.toJSON = function () {
      ...
      (a.OperatorSetIdProto = (function () {
        ...
        return (
          (t.prototype.domain = ""),
          (t.prototype.version = g.Long ? g.Long.fromBits(0, 0, !1) : 0),
          (t.create = function (e) {
            return new t(e);
          }),
          (t.encode = function (e, r) {
            return (
              ...
              e.domain != null &&
                Object.hasOwnProperty.call(e, "domain") &&
                r.uint32(10).string(e.domain),
              e.version != null &&
                Object.hasOwnProperty.call(e, "version") &&
                r.uint32(16).int64(e.version),
              r
            );
          }),
          (t.encodeDelimited = function (e, r) {
          ...
          (t.verify = function (e) {
            return typeof e != "object" || e === null
              ...
              : e.version != null &&
                ...
                !g.isInteger(e.version) &&
                !(
                  e.version &&
                  g.isInteger(e.version.low) &&
                  g.isInteger(e.version.high)
                )
              ? "version: integer|Long expected"
              : null;
          }),
          (t.fromObject = function (e) {
            if (e instanceof h.onnx.OperatorSetIdProto) return e;
            var r = new h.onnx.OperatorSetIdProto();
            return (
              e.domain != null && (r.domain = String(e.domain)),
              e.version != null &&
                (g.Long
                  ? ((r.version = g.Long.fromValue(e.version)).unsigned = !1)
                  : typeof e.version == "string"
                  ? (r.version = parseInt(e.version, 10))
                  : typeof e.version == "number"
                  ? (r.version = e.version)
                  : typeof e.version == "object" &&
                    (r.version = new g.LongBits(
                      e.version.low >>> 0,
                      e.version.high >>> 0
                    ).toNumber())),
              r
          ...
          (t.toObject = function (e, r) {
            ...
            return (
              ...
              e.version != null &&
                ...
                (typeof e.version == "number"
                  ? (n.version =
                      r.longs === String ? String(e.version) : e.version)
                  : (n.version =
                      r.longs === String
                        ? g.Long.prototype.toString.call(e.version)
                        : r.longs === Number
                        ? new g.LongBits(
                            e.version.low >>> 0,
                            e.version.high >>> 0
      ...
      (a.FunctionProto = (function () {
        ...
        return (
          ...
          (t.prototype.output = g.emptyArray),
          (t.prototype.attribute = g.emptyArray),
          (t.prototype.attributeProto = g.emptyArray),
          (t.prototype.node = g.emptyArray),
          (t.prototype.docString = ""),
          (t.prototype.opsetImport = g.emptyArray),
          (t.prototype.domain = ""),
          ...
          (t.encode = function (e, r) {
            ...
            if (
              (e.docString != null &&
                Object.hasOwnProperty.call(e, "docString") &&
                r.uint32(66).string(e.docString),
              e.opsetImport != null && e.opsetImport.length)
            )
              for (var n = 0; n < e.opsetImport.length; ++n)
                h.onnx.OperatorSetIdProto.encode(
            ...
            if (
              (e.domain != null &&
                Object.hasOwnProperty.call(e, "domain") &&
                r.uint32(82).string(e.domain),
              e.attributeProto != null && e.attributeProto.length)
            )
          ...
          (t.verify = function (e) {
            ...
            if (
              e.attributeProto != null &&
              e.hasOwnProperty("attributeProto")
            ) {
          ...
          (t.fromObject = function (e) {
            if (e instanceof h.onnx.FunctionProto) return e;
          ...
          (t.toObject = function (e, r) {
            ...
            if (
              (e.domain != null &&
                e.hasOwnProperty("domain") &&
                (n.domain = e.domain),
              e.attributeProto && e.attributeProto.length)
            ) {
              n.attributeProto = [];
...
var ye,
  ...
  fe = L(() => {
    ...
    (hr = class {
      ...
      (Ze = class a {
        static calcShape(t, o, e = !1) {
          let r = t.length,
            n = o.length;
          if (r === 0) return o;
          if (n === 0) return t;
          let s = Math.max(t.length, o.length),
            i = new Array(s);
          if (e) {
            if (r < 2 || n < 2) return;
            let u = pi.calcMatMulShape(
              [t[r - 2], t[r - 1]],
              [o[n - 2], o[n - 1]]
            );
            if (u === void 0) return;
        ...
        static calc(t, o, e, r, n) {
          ...
          if (s) {
            ...
            let i = U.size(s),
              u = r ? t : new $e(s, n || t.type);
            if (s.length === 0) u.set([], e(t.get([]), o.get([])));
            else {
              let l = new Array(s.length),
                c = new Array(t.dims.length),
                p = new Array(o.dims.length),
                d = 0,
                T = 0,
                w = !1,
                v = !1;
              t.dims.length === 0 && ((d = t.get([])), (w = !0)),
                o.dims.length === 0 && ((T = o.get([])), (v = !0));
              let S;
              for (let A = 0; A < i; A++) {
                S = A;
                for (let C = s.length - 1; C >= 0; C--)
                  (l[C] = S % s[C]), (S = Math.floor(S / s[C]));
                w || (a.fillIndex(l, t.dims, c), (d = t.get(c))),
                  v || (a.fillIndex(l, o.dims, p), (T = o.get(p))),
                  u.set(l, e(d, T));
              }
            }
            return u;
        ...
        static isValidBroadcast(t, o) {
          ...
          if (e > r) return !1;
          for (let n = 1; n <= e; n++)
            if (t[e - n] !== 1 && t[e - n] !== o[r - n]) return !1;
          return !0;
        }
      ...
      (We = class a {
        static tensorDataTypeFromProto(t) {
          switch (t) {
            ...
            default:
              throw new Error(
                `unsupported data type: ${ye.onnx.TensorProto.DataType[t]}`
              );
          }
        }
        ...
        static tensorValueTypeFromProto(t) {
          return {
            tensorType: a.tensorDataTypeFromProto(t.elemType),
            shape: {
              dims: a.tensorDimsFromProto(t.shape.dim.map((o) => o.dimValue)),
            },
          };
        }
      ...
      (U = class a {
        ...
        static sizeFromDimension(t, o) {
          if (o < 0 || o > t.length)
            throw new Error(
              `invalid dimension of ${o} for sizeFromDimension as Tensor has ${t.length} dimensions.`
            );
        ...
        static sizeToDimension(t, o) {
          if (o < 0 || o > t.length)
            throw new Error(
              `invalid dimension of ${o} for sizeToDimension as Tensor has ${t.length} dimensions.`
            );
        ...
        static calculateReshapedDims(t, o) {
          ...
          if (n !== -1) {
            if (i % s !== 0)
              throw new Error(
                `the input tensor cannot be reshaped to the requested shape. Input shape: [${t}] Output shape: [${o}]`
              );
            r[n] = i / s;
          } else if (s !== i)
            throw new Error(
        ...
        static areEqual(t, o) {
          return t.length !== o.length ? !1 : t.every((e, r) => e === o[r]);
        }
        ...
        static flattenShape(t, o) {
          o < 0 && (o += t.length);
          let e = t.reduce((s, i) => s * i, 1),
            r = t.slice(o).reduce((s, i) => s * i, 1);
          return [e / r, r];
        }
      ...
      (mr = class a {
        ...
        static computeConvOutputShape(t, o, e, r, n, s, i) {
          ...
          let u = [t[0], o[0]];
          return a.computeShapeHelper(!1, t, u, e, r, n, s, i), u;
        }
      ...
      (br = -34028234663852886e22),
      (gr = 34028234663852886e22);
  });
function Hd(a) {
  switch (a) {
    case "bool":
...
function Fu(a) {
  switch (a) {
    ...
    default:
      throw new Error(
        `cannot calculate sizeof() on type ${ne.onnx.TensorProto.DataType[a]}`
      );
  }
}
function qd(a, t) {
...
function hi(a, t) {
  if (
    t === ne.onnx.TensorProto.DataType.INT64 ||
    t === di.TensorDataType.INT64
  ) {
    if (a.greaterThanOrEqual(2147483648) || a.lessThan(-2147483648))
      throw new TypeError("int64 is not supported");
  } else if (
    t === ne.onnx.TensorProto.DataType.UINT32 ||
    t === di.TensorDataType.UINT32 ||
    t === ne.onnx.TensorProto.DataType.UINT64 ||
    t === di.TensorDataType.UINT64
  ) {
...
function $u(a, t, o) {
  switch (t) {
    ...
    case ne.onnx.TensorProto.DataType.INT8:
      return a.getInt8(o);
    case ne.onnx.TensorProto.DataType.UINT16:
      return a.getUint16(o, !0);
    case ne.onnx.TensorProto.DataType.INT16:
      return a.getInt16(o, !0);
    case ne.onnx.TensorProto.DataType.FLOAT:
      return a.getFloat32(o, !0);
    case ne.onnx.TensorProto.DataType.INT32:
      return a.getInt32(o, !0);
    case ne.onnx.TensorProto.DataType.UINT32:
      return a.getUint32(o, !0);
    case ne.onnx.TensorProto.DataType.INT64:
      return hi(Vt.fromBits(a.getUint32(o, !0), a.getUint32(o + 4, !0), !1), t);
    case ne.onnx.TensorProto.DataType.DOUBLE:
      return a.getFloat64(o, !0);
    case ne.onnx.TensorProto.DataType.UINT64:
      return hi(Vt.fromBits(a.getUint32(o, !0), a.getUint32(o + 4, !0), !0), t);
    default:
      throw new Error(
        `cannot read from DataView for type ${ne.onnx.TensorProto.DataType[t]}`
      );
  }
}
var ku,
    ...
    (di = V.experimental.fbs),
      ($e = class a {
        constructor(t, o, e, r, n, s = ku.Guid.create()) {
          ...
          let i = this.size,
            u = e === void 0 && r === void 0 && n === void 0;
          if (n !== void 0 && n.length !== i)
        ...
        get strides() {
          return (
            this._strides || (this._strides = U.computeStrides(this.dims)),
            this._strides
          );
        }
        static fromProto(t) {
          ...
          let o = We.tensorDataTypeFromProto(t.dataType),
            e = We.tensorDimsFromProto(t.dims),
            r = new a(e, o);
          if (o === "string")
            ...
            t.rawData &&
            typeof t.rawData.byteLength == "number" &&
            t.rawData.byteLength > 0
          ) {
            let n = r.data,
              s = new DataView(
                t.rawData.buffer,
                t.rawData.byteOffset,
                t.rawData.byteLength
              ),
              i = Fu(t.dataType),
              u = t.rawData.byteLength / i;
        ...
        static fromOrtTensor(t) {
          if (!t)
            throw new Error("cannot construct Value from an empty tensor");
          let o = We.tensorDimsFromORTFormat(t),
            e = We.tensorDataTypeFromProto(t.dataType()),
            r = new a(o, e);
          if (e === "string")
            ...
            t.rawDataArray() &&
            typeof t.rawDataLength() == "number" &&
            t.rawDataLength() > 0
          ) {
            let n = r.data,
              s = new DataView(
                t.rawDataArray().buffer,
                t.rawDataArray().byteOffset,
                t.rawDataLength()
              ),
              i = Fu(t.dataType()),
              u = t.rawDataLength() / i;
...
function Gu(a) {
  return (
    ...
    "get" + a.charAt(0).toUpperCase() + a.slice(1) + "AtOutCoords"
  );
}
function $r(a, t) {
...
function Zd(a, t) {
  ...
  let e = "r, c",
    ...
    s = "rp1, cp1",
    i = "";
  if (o > 2) for (let u = 0; u < o - 2; ++u) i = i + `${t[u]},`;
  return `getA(${i}${e}),
          rEdge ? 0. : getA(${i}${n}),
          cEdge ? 0. : getA(${i}${r}),
...
var Uu,
  ...
  Vu = L(() => {
    ...
    Bt();
    Tr();
    (Uu = { name: "pack", inputNames: ["A"], inputTypes: [1] }),
      (Kd = (a, t) => {
        let o = H(a.session.backend.glContext.version),
          e = t.dims,
          r = e.length,
          n = t.dims.length,
          s = Qe(n),
          i = Br("rc", n),
          u = Qd(n, i, e[e.length - 2], e[e.length - 1]),
          l;
        r === 0
          ? (l = [1, 1])
          : r === 1
      ...
      `;
        return {
          ...Uu,
          hasMain: !0,
          output: { dims: t.dims, type: t.type, textureType: 2 },
          shaderSource: d,
        };
      }),
...
function Hu(a, t) {
  ...
  return (
    a.length === 0 || t.length === 0
      ? (o = !0)
      : a.length < 2 || t.length < 2
      ? (o = a[a.length - 1] === t[t.length - 1])
      : (o =
          a[a.length - 1] === t[t.length - 1] &&
          a[a.length - 2] === t[t.length - 2]),
    o
  );
}
function rh(a) {
  ...
  qu = L(() => {
    ...
    (eh = (a) => ({
      ...
      `;
        ...
        let i = H(a.session.backend.glContext.version),
          u = `
      ${rh(r)}
      ${nh(n)}
      ${Nt()}
    ...
    `;
        return {
          ...o,
          output: { dims: n, type: t.type, textureType: 2 },
          shaderSource: u,
          hasMain: !0,
        };
      }),
...
var gi,
  ju = L(() => {
    ...
    gi = (a, t) => {
      let o = t.shape,
        e = H(a.session.backend.glContext.version),
        r = `
    ...
    void main() {
      ...
      ${e.output} = encodeAsUint8(value);
        ...
        n = {
          ...
          inputTypes: [0],
          inputNames: ["X"],
          output: { dims: o, type: t.tensor.type, textureType: 3 },
          shaderSource: r,
          hasMain: !0,
        };
...
var Yu,
  ...
  Ku = L(() => {
    ...
    Bt();
    Tr();
    (Yu = { name: "unpack", inputNames: ["A"], inputTypes: [2] }),
      (oh = (a, t) => {
        let o = t.dims.length,
          e = Br("rc", o),
          r = e.slice(-2),
          n = Qe(o),
          s = Nt(),
          u = t.dims.length === 0 ? "" : ih(o, e),
          l = o <= 1 ? "rc" : `vec2(${r.join(",")})`,
          c = H(a.session.backend.glContext.version),
          p = `
    ${s}
    void main() {
...
var Xn,
  ...
  ln = L(() => {
    ...
    (Xn = class {
      constructor(t, o = 1) {
        if (o === 1)
          (this.internalFormat = t.R32F),
            (this.format = t.RED),
            (this.textureType = t.FLOAT),
            (this.channelSize = o);
        else if (o === 4)
          (this.internalFormat = t.RGBA32F),
            (this.format = t.RGBA),
            (this.textureType = t.FLOAT),
            (this.channelSize = o);
      ...
      encode(t, o) {
        ...
        return (
          ...
          o * this.channelSize > t.length
            ? (ce.warning(
                "Encoder",
                "Source data too small. Allocating larger array"
              ),
              (r = t),
              (e = this.allocate(o * this.channelSize)),
              r.forEach((n, s) => (e[s] = n)))
            : ((r = t), (e = r)),
          e
        );
      ...
      decode(t, o) {
        return this.channelSize === 1
          ? t.filter((r, n) => n % 4 === 0).subarray(0, o)
          : t.subarray(0, o);
      }
    }),
      (un = class {
        constructor(t, o = 1, e) {
          ...
          (this.internalFormat = t.RGBA),
            (this.format = t.RGBA),
            (this.channelSize = o),
            (this.textureType = e || t.FLOAT);
        }
        encode(t, o) {
          let e = t;
          return (
            this.channelSize === 1 &&
              (ce.verbose("Encoder", "Exploding into a larger array"),
              (e = this.allocate(o)),
              t.forEach((r, n) => (e[n * 4] = r))),
            e
          );
        }
        allocate(t) {
      ...
      (Kn = class {
        constructor(t, o = 1) {
          this.channelSize = 4;
          if (o === 1)
            (this.internalFormat = t.ALPHA),
              (this.format = t.ALPHA),
              (this.textureType = t.UNSIGNED_BYTE),
              (this.channelSize = o);
          else if (o === 4)
            (this.internalFormat = t.RGBA),
              (this.format = t.RGBA),
  ...
  Zu = L(() => {
    ...
    (fn = (a, t, o) => {
      let e = o === 0 || o === 1 ? 1 : 4,
        r = o === 2,
        n = o === 1 || o === 2,
        s = o === 4 ? t.length - 1 : void 0,
        i =
          o === 4 ? t.map((u, l) => (l === t.length - 1 ? u * 4 : u)) : void 0;
      ...
      (yi = (a, t, o = 1, e, r) => {
        let n = !!(r && r.isPacked),
          [s, i] = a.computeTextureWH((n && e) || t, r),
          u = t.length,
          l = t.slice(0);
        if ((u === 0 && (l = [1]), o === 1)) e = t;
        else if (n) {
      ...
      (Jn = class {
        ...
        executeProgram(t, o) {
          if (o.length < t.inputNames.length)
            throw new Error(
              `Input size mustn't be less than ${t.inputNames.length}.`
            );
          ...
          let r = sh(t, e),
            ...
            s = n ? n.programInfo : typeof t.get == "function" ? t.get() : t,
            i = fn(
              this.session.layoutStrategy,
              s.output.dims,
              s.output.textureType
            ),
            u = this.createTextureData(i, s.output.type);
          return (
            n ||
              ((n = this.session.programManager.build(s, e, u)),
              this.session.programManager.setArtifact(r, n)),
            this.runProgram(n, e, u),
            u
          );
        }
        run(t, o) {
        ...
        getOrCreateTextureData(t, o) {
          ...
          if (!e) {
            ...
            if (o === 4) {
              let i = t.dims;
              if (i.length === 4) {
                let u = [i[0], Math.ceil((i[1] * i[2] * i[3]) / 4)],
                  l = fn(this.session.layoutStrategy, u, o),
                  c = t.numberData;
                if ((i[1] * i[2] * i[3]) % 4 !== 0) {
                  let p = i[0],
                    d = i[1] * i[2] * i[3],
            ...
            if (o === 2) {
              let n = yi(this.session.layoutStrategy, t.dims, 1, [], {
                  reverseWH: !0,
                }),
                s = this.createTextureData(n, t.type, t.numberData, t, 1);
              e = this.pack(s);
        ...
        createTextureData(t, o, e, r, n) {
          ce.verbose(
            "InferenceHandler",
            `Creating TextureData: layout:[${JSON.stringify(t)}]`
          );
        ...
        reshapePacked(t, o) {
          ...
          if (Hu(t.dims, o)) {
            ...
            return this.createTextureDataFromTexture(l, t.type, e.texture)
              .tensor;
          }
          let r = bi(t.dims),
            n = bi(o),
            s = this.reshapePacked(t, r),
            i = this.run(Wu(this, s, n), [s]);
          ...
          let s = {
            ...
            tensor:
              ...
              new $e(
                t.unpackedShape,
                o,
                (i) => this.readTexture(s),
                async (i) => this.readTextureAsync(s),
                void 0,
                n
              ),
            texture: e,
        ...
        getTextureData(t, o = !1) {
          return this.session.isInitializer(t)
            ? this.session.getTextureData(t, o)
            : o
            ? this.packedTextureDataCache.get(t)
            : this.unpackedTextureDataCache.get(t);
        }
        setTextureData(t, o, e = !1) {
          this.session.isInitializer(t)
            ? this.session.setTextureData(t, o, e)
            : (e
                ? this.packedTextureDataCache
                : this.unpackedTextureDataCache
              ).set(t, o);
        }
        isTextureLayoutCached(t, o = !1) {
          return !!this.getTextureData(t.dataId, o);
        }
        dispose() {
          this.session.textureManager.clearActiveTextures(),
            this.packedTextureDataCache.forEach((t) =>
              this.session.textureManager.releaseTexture(t)
            ),
            (this.packedTextureDataCache = new Map()),
            this.unpackedTextureDataCache.forEach((t) =>
              this.session.textureManager.releaseTexture(t)
            ),
            (this.unpackedTextureDataCache = new Map());
        }
        readTexture(t) {
          return t.isPacked
            ? this.readTexture(this.unpack(t))
            ...
            : this.session.textureManager.readUint8TextureAsFloat(gi(this, t));
        }
        async readTextureAsync(t) {
          return t.isPacked
            ? this.readTextureAsync(this.unpack(t))
            : this.session.backend.glContext.isFloat32DownloadSupported
...
var tl,
  ...
  ol = L(() => {
    ...
    (tl = {
      ...
      (rl = (a, t, o) => (
        lh(t),
        [a.run({ ...tl, cacheHint: o.cacheKey, get: () => uh(a, t, o) }, t)]
      )),
      (nl = (a) => {
        let t = a.attributes.getFloat("epsilon", 1e-5),
          o = a.attributes.getFloat("momentum", 0.9),
          e = a.attributes.getInt("spatial", 1);
        return Q({ epsilon: t, momentum: o, spatial: e });
      }),
      (uh = (a, t, o) => {
        let e = H(a.session.backend.glContext.version),
          r = t[0].dims.length,
          [n, s] = a.calculateTextureWidthAndHeight(t[1].dims, 0),
          i = `
  float process(int[${r}] indices) {
    ...
    return scale * ( (_A(indices) - mean) / sqrt(variance + float(${o.epsilon})) ) + b;
        ...
        return {
          ...tl,
          output: { dims: t[0].dims, type: t[0].type, textureType: 0 },
          shaderSource: i,
        };
      }),
      (lh = (a) => {
  ...
  Wt = L(() => {
    ...
    (Zn = class {
      ...
      (cn = class {
        constructor(t, o, e) {
          this.name = t;
          e ? (this.dependencies = e) : (this.dependencies = []),
      ...
      (Qn = class {
        ...
        static dfsTraverse(t, o, e, r) {
          ...
          if (n && n.length > 0)
            for (let s = 0; s < n.length; ++s) this.dfsTraverse(n[s], o, e, r);
...
var ht,
  ...
  gl = L(() => {
    ...
    (ht = (a, t, o, e = t[0].type, r) => {
      ...
      (Oh = (a, t, o, e = t[0].type) => {
        let r = a.session.pack ? 2 : 0,
          n = !U.areEqual(t[0].dims, t[1].dims),
          s = t[0].dims,
          i = a.session.pack;
        if (n) {
          let c = Ze.calcShape(t[0].dims, t[1].dims, !1);
          if (!c)
            throw new Error("Can't perform binary op on the given tensors");
          s = c;
          let p = s.length,
            d = t[0].dims.length !== 0 ? t[0].dims.length : 1,
            T = t[1].dims.length !== 0 ? t[1].dims.length : 1,
            w =
              t[0].dims.length !== 0
            ...
            v =
              t[1].dims.length !== 0
                ...
                : "bindices[0] = 0;",
            S = H(a.session.backend.glContext.version),
            A = i
              ? `
      ${o.body}
      void main() {
      ...
      float process(int indices[${p}]) {
        ...
        return ${o.name}(_A(aindices), _B(bindices));
          ...
          return {
            ...
            inputNames: ["A", "B"],
            inputTypes: [r, r],
            output: { dims: s, type: e, textureType: r },
            shaderSource: A,
            hasMain: i,
          };
        }
        let u = H(a.session.backend.glContext.version),
          l = `
    ${o.body}
    void main() {
    ...
    `;
        return {
          ...
          inputNames: ["A", "B"],
          inputTypes: [r, r],
          output: { dims: t[0].dims, type: e, textureType: r },
          shaderSource: l,
          hasMain: !0,
        };
      }),
      (il = (a, t) => [a.run(ht(a, t, ch()), t)]),
      (al = (a, t) => [a.run(ht(a, t, yh(), "bool"), t)]),
      (sl = (a, t) => [a.run(ht(a, t, ph()), t)]),
      (ul = (a, t) => [a.run(ht(a, t, mh(), "bool"), t)]),
      (ll = (a, t) => [a.run(ht(a, t, bh(), "bool"), t)]),
      (fl = (a, t) => [a.run(ht(a, t, gh(), "bool"), t)]),
      (cl = (a, t) => [a.run(ht(a, t, dh()), t)]),
      (pl = (a, t) => [a.run(ht(a, t, Th(), "bool"), t)]),
      (dl = (a, t) => [a.run(ht(a, t, wh()), t)]),
      (hl = (a, t) => [a.run(ht(a, t, vh()), t)]),
      (ml = (a, t) => [a.run(ht(a, t, hh()), t)]),
      (bl = (a, t) => [a.run(ht(a, t, xh(), "bool"), t)]);
  });
var yl,
  Tl,
  Sh,
  xl = L(() => {
    "use strict";
    fe();
    (yl = (a, t, o) => (Sh(t), [a.cast(t[0], o)])),
      (Tl = (a) => We.tensorDataTypeFromProto(a.attributes.getInt("to"))),
      (Sh = (a) => {
...
var Ah,
  ...
  vl = L(() => {
    ...
    (Ah = (a, t) => ({
      name: "Concat (packed)",
      inputNames: Array.from({ length: a }, (o, e) => `X${e}`),
      inputTypes: Array(a).fill(2),
      cacheHint: t,
    })),
      (Ph = (a, t, o, e) => {
        ...
        let s = n.length,
          ...
          c = o.map((j) => j.dims),
          p = Dt(s),
          d = new Array(c.length - 1);
        d[0] = c[0][e];
        for (let j = 1; j < d.length; j++) d[j] = d[j - 1] + c[j][e];
        let T = p[e],
          w = p.slice(-2),
          v = p.join(),
          S = `if (${T} < ${d[0]}) {
        ...
        S += `
            return getChannel(
              getX${A}(${eo(p, T, C)}),
              vec2(${eo(w, T, C)}));`;
        let F = H(a.session.backend.glContext.version),
          J = `
          ${l}
...
var _l,
  ...
  Sl = L(() => {
    ...
    (_l = (a, t, o) => (
      kh(t),
      a.session.pack && t[0].dims.length > 1
        ? [a.run(wl(a, t, o), t)]
        : [a.run(Lh(a, t, o), t)]
    )),
      (Eh = (a, t) => ({
      ...
      (Dh = (a, t, o, e) => {
        ...
        let s = n.length,
          ...
          u = 0;
        for (let T = 0; T < i.length; ++T) (u += o[T].dims[e]), (i[T] = u);
        let l = "";
...
`
      ...
      (Fh = (a, t) => {
        ...
        for (let e = 0; e < a; ++e)
          e === 0
            ? o.push(`	if (textureIndex == ${e}) { return _X${e}(indices); }`)
            : e === a - 1
            ? o.push(`	else { return _X${e}(indices); }`)
            : o.push(
                `	else if (textureIndex == ${e}) { return _X${e}(indices); }`
              );
        return (
          o.push("	}"),
          o.join(`
`)
      ...
      ($h = (a) => {
        ...
        for (let o = 0; o < a.length; ++o)
          o === 0
            ? t.push(`	if (index == ${o}) { return ${a[o]}; }`)
            : o === a.length - 1
            ? t.push(`	else { return ${a[o]}; }`)
            : t.push(`	else if (index == ${o}) { return ${a[o]}; }`);
        return (
          t.push("	}"),
          t.join(`
`)
      ...
      (Il = (a) => Q({ axis: a.attributes.getInt("axis") })),
      (kh = (a) => {
...
var em,
  ...
  Ii = L(() => {
    ...
    (em = (a, t, o, e) => {
      let r = a.session.pack ? 2 : 0,
        n = H(a.session.backend.glContext.version);
      return {
        ...t,
     ...
     `,
      ...
      (Al = (a, t) => [a.run(Ee(a, t[0], Bh()), t)]),
      (Pl = (a, t) => [a.run(Ee(a, t[0], Nh()), t)]),
      (El = (a, t) => [a.run(Ee(a, t[0], Rh()), t)]),
      (Dl = (a, t) => [a.run(Ee(a, t[0], Mh()), t)]),
      (_i = (a, t, o) => [a.run(Ee(a, t[0], xi(o.min, o.max), o.cacheKey), t)]),
      (Ll = (a) =>
        Q({
          min: a.attributes.getFloat("min", br),
          max: a.attributes.getFloat("max", gr),
        })),
      (Cl = (a, t) => {
        let o = tm(a, t);
        return _i(a, [t[0]], o);
      ...
      (tm = (a, t) => {
        if (
          t.length >= 3 &&
          (!a.session.isInitializer(t[1].dataId) ||
            !a.session.isInitializer(t[2].dataId))
        )
          throw new Error("dynamic clip attributes are not allowed");
        let o = t.length >= 3 ? t[1].numberData[0] : br,
          e = t.length >= 3 ? t[2].numberData[0] : gr;
        return Q({ min: o, max: e });
      }),
      (Fl = (a, t) => [a.run(Ee(a, t[0], Gh()), t)]),
      ($l = (a, t) => [a.run(Ee(a, t[0], Uh()), t)]),
      (kl = (a, t, o) => [a.run(Ee(a, t[0], zh(o.alpha), o.cacheKey), t)]),
      (Bl = (a) => Q({ alpha: a.attributes.getFloat("alpha", 1) })),
      (Nl = (a, t) => [a.run(Ee(a, t[0], Vh()), t)]),
      (Rl = (a, t) => [a.run(Ee(a, t[0], Wh()), t)]),
      (Oi = (a, t) => [a.run(Ee(a, t[0], Hh()), t)]),
      (Ml = (a, t, o) => [a.run(Ee(a, t[0], qh(o.alpha), o.cacheKey), t)]),
      (Gl = (a) => Q({ alpha: a.attributes.getFloat("alpha", 0.01) })),
      (Ul = (a, t) => [a.run(Ee(a, t[0], jh()), t)]),
      (zl = (a, t) => [a.run(Ee(a, t[0], Yh()), t)]),
      (Vl = (a, t) => [a.run(Ee(a, t[0], Xh()), t)]),
      (Wl = (a, t) => [a.run(Ee(a, t[0], wi()), t)]),
      (Hl = (a, t) => [a.run(Ee(a, t[0], vi()), t)]),
      (ql = (a, t) => [a.run(Ee(a, t[0], Kh()), t)]),
      (jl = (a, t) => [a.run(Ee(a, t[0], Jh()), t)]),
      (Yl = (a, t) => [a.run(Ee(a, t[0], Zh()), t)]),
      (Xl = (a, t) => [a.run(Ee(a, t[0], Qh()), t)]);
  });
function Rt(a) {
  let t;
  switch (a.activation) {
...
var nm,
  ...
  Jl = L(() => {
    ...
    (nm = (a, t) => ({
      name: "GroupedConv",
      inputNames: a ? ["X", "W", "Bias"] : ["X", "W"],
      inputTypes: a ? [0, 0, 0] : [0, 0],
      cacheHint: t,
    })),
      (om = (a, t, o, e) => {
        let n = t.length > 2 ? "value += getBias(output_channel);" : "",
          s = t[0].dims.slice(),
          i = t[1].dims.slice(),
          u = i[0] / e.group;
        ce.verbose(
          "GroupedConv",
          `autpPad:${e.autoPad}, dilations:${e.dilations}, group:${e.group}, kernelShape:${e.kernelShape}, pads:${e.pads}, strides:${e.strides}`
        );
        let l = Rr(s, i, e.dilations, e.pads, e.strides),
          c = H(a.session.backend.glContext.version),
          { activationFunction: p, applyActivation: d } = Rt(e),
          T = `
    ...
    (im = (a) => ({
      ...
      (am = (a, t, o, e, r, n) => {
        let s = o.dims,
          ...
          l = 3,
          c = r.length,
          p = [i[1] * i[2] * i[3], r[2] * r[3]],
          d = i[2] * i[3],
          T = Nt(),
          w = H(a.session.backend.glContext.version),
          v = "";
        for (let A = 0; A <= 1; A++)
          for (let C = 0; C <= 1; C++)
            v += `
...
function um(a, t, o) {
  let e = t[0].dims,
    r = t[1].dims,
    n = Ze.calcShape(e, r, !0);
  if (!n) throw new Error("Can't use matmul on the given tensors");
  let s = Qe(n.length),
    i = Dt(),
    { activationFunction: u, applyActivation: l } = Rt(o),
    c = t.length > 2,
    p = c ? "value += getBiasForMatmul();" : "",
    d = c ? `${Ai(s, i, t[2].dims, n, !1)}` : "",
    T = n.length,
    w = e.length,
    v = r.length,
    S = e[e.length - 1],
...
function Ai(a, t, o, e, r) {
  ...
  i < 2 && s > 0
    ? (n = "coords")
    : (n = o.map((v, S) => `coords.${t[S + u]}`).join(", "));
  let c = Ze.getBroadcastDims(o, e).map((v) => `coords.${t[v + u]} = 0;`).join(`
`),
    d = U.size(o) === 1,
    T = "vec4(outputValue.xx, outputValue.yy)";
  return (
    d && (T = "vec4(outputValue.x)"),
    r
      ? `
...
var ef,
  ...
  ro = L(() => {
    ...
    Pi();
    (ef = (a, t, o) => (
      lm(t), a.session.pack ? [a.run(no(a, t, o), t)] : [a.run(Si(t, o), t)]
    )),
      (tf = (a) => Nr(a.attributes)),
      (sm = (a, t) => ({
        name: "MatMul",
    ...
    lm = (a) => {
      ...
      if (
        (a[0].type !== "float32" && a[0].type !== "float64") ||
        (a[1].type !== "float32" && a[1].type !== "float64")
      )
...
function pm(a, t, o, e) {
  let r = [],
    ...
    p = c - u,
    d = c - l;
  (r = s.map((F, J) => `coords.${t[J + p]}`)),
    (r[u - 1] = "i*2"),
    r.join(", "),
    (n = i.map((F, J) => `coords.${t[J + d]}`)),
    (n[l - 2] = "i*2"),
    n.join(", ");
  let T = Ze.getBroadcastDims(s, e),
    w = Ze.getBroadcastDims(i, e),
    v = T.map((F) => `coords.${t[F + p]} = 0;`).join(`
`),
    ...
    (fm = (a, t) => ({
      ...
      (cm = (a, t, o, e) => {
        let r = o.length > 2,
          ...
          s = o[0].dims,
          i = o[1].dims,
          u = Ze.calcShape(s, i, !0),
          l = !U.areEqual(o[0].dims, o[1].dims);
        ...
        let c = s[s.length - 1],
          ...
          S = u.length,
          A = Dt(),
          { activationFunction: C, applyActivation: F } = Rt(e),
          J = r ? `${Ai(v, A, o[2].dims, u, !0)}` : "",
          j = l ? `${pm(v, A, o, u)}` : "",
          ie = l ? "getAAtOutCoordsMatmul(i)" : `getA(${dm(A, d)})`,
          G = l ? "getBAtOutCoordsMatmul(i)" : `getB(${hm(A, T)})`,
          Te = l
            ? ""
            : `${v} rc =
...
var rf,
  nf = L(() => {
    ...
    rf = (a, t, o) => {
      let e = t[0].dims,
        r = t[1].dims,
        n = Rr(e, r, o.dilations, o.pads, o.strides),
        s = a.run(Zl(a, t[0], t[1], n, o), [t[0]]),
        i = a.reshapePacked(t[1], [r[0], r[1] * r[2] * r[3]]),
        u = t.length === 3 ? [i, s, t[2]] : [i, s],
        l = a.run(no(a, u, o), u);
...
var gm,
  ...
  sf = L(() => {
    ...
    (gm = (a, t) => ({
      name: "ConvDotProduct",
      inputNames: a ? ["Im2Col", "K", "B"] : ["Im2Col", "K"],
      inputTypes: a ? [0, 4, 0] : [0, 4],
      cacheKey: t.activationCacheKey,
    })),
      (ym = (a, t, o, e, r) => {
        let n = o[0].dims,
          s = o[1].dims,
          i = [s[0], Math.ceil((n[1] * s[2] * s[3]) / 4)],
          u = Ei(n, s, e),
          [l, c] = a.calculateTextureWidthAndHeight(i, 4),
          p = U.computeStrides(u),
          [d, T] = a.calculateTextureWidthAndHeight(u, 4),
          w = e.length,
          v = o.length < 3 ? "0.0" : "_B(b)",
          S = Math.ceil((n[1] * s[2] * s[3]) / 4),
          { activationFunction: A, applyActivation: C } = Rt(r),
          F = H(a.session.backend.glContext.version),
          J = `
${A}
float process(int indices[${w}]) {
  ...
  return value;
        ...
        return {
          ...t,
          output: { dims: e, type: o[0].type, textureType: 0 },
          shaderSource: J,
        };
      }),
      (af = (a, t, o, e) => {
  ...
  to = L(() => {
    ...
    (Rr = (a, t, o, e, r) => {
      let n = a[0],
        ...
        i = s.length,
        u = t[0],
        c = t.slice(2).map((w, v) => w + (w - 1) * (o[v] - 1)),
        d = s
          .map((w, v) => w + e[v] + e[v + i])
          .map((w, v) => Math.floor((w - c[v] + r[v]) / r[v]));
      return [n, u].concat(...d);
    }),
      (Li = (a, t, o) => (_m(t, o), Tm(a, t, o))),
      (Tm = (a, t, o) => {
        let e = vm(o, t),
          r = a.session.pack,
          n = e.kernelShape[0] === 1 && e.kernelShape[1] === 1;
        return e.group > 1
          ? [a.run(Kl(a, t, e), t)]
          : n && r
          ? [xm(a, t, e)]
          : r && t[0].dims.length === 4 && t[0].dims[0] === 1 && !n
          ? [rf(a, t, e)]
          : [wm(a, t, e)];
      }),
      (xm = (a, t, o) => {
        let e = t[0].dims,
          r = t[1].dims,
          n = Rr(e, r, o.dilations, o.pads, o.strides),
          s = a.reshapeUnpacked(t[0], [e[1], e[2] * e[3]]),
          i = a.reshapeUnpacked(t[1], [r[0], r[1]]),
          u = t.length > 2 ? [i, s, t[2]] : [i, s],
          l = a.run(Si(u, o), u);
      ...
      (wm = (a, t, o) => {
        let e = t[0].dims,
          r = t[1].dims,
          n = Rr(e, r, o.dilations, o.pads, o.strides),
          s = a.run(of(a, t[0], t[1], n, o), [t[0]]),
          i = t.length === 3 ? [s, t[1], t[2]] : [s, t[1]];
        return a.run(af(a, t, n, o), i);
      }),
      (vm = (a, t) => {
        let o = a.kernelShape.slice();
        if (a.kernelShape.length === 0)
          for (let n = 2; n < t[1].dims.length; ++n) o.push(t[1].dims[n]);
        let e = a.pads.slice();
        ...
        return (
          Object.assign(r, { kernelShape: o, pads: e, cacheKey: a.cacheKey }), r
        );
      }),
      (Ci = (a) => {
        let t = a.attributes,
          o = Nr(t),
          e = t.getString("auto_pad", "NOTSET"),
          r = t.getInts("dilations", [1, 1]),
          n = t.getInt("group", 1),
          s = t.getInts("kernel_shape", []),
          i = t.getInts("pads", [0, 0, 0, 0]),
      ...
      (_m = (a, t) => {
        ...
        let o = a[0].dims[1],
          e = a[1].dims[1] * t.group;
        if (o !== e)
          throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");
        if (
          a.length === 3 &&
          (a[2].dims.length !== 1 || a[1].dims[0] !== a[2].dims[0])
        )
        ...
        if (
          ...
          t.kernelShape.length !== a[1].dims.length - 2
        )
...
var Om,
  ...
  ff = L(() => {
    ...
    ae();
    xr();
    (Om = (a, t, o, e, r, n) => (a - 1) * t + o + (e - 1) * r + 1 - n),
      (Im = (a, t, o, e, r) => {
        let n = Math.floor(a / 2);
        t === "SAME_UPPER"
          ? ((o[e] = n), (o[r] = a - n))
          : t === "SAME_LOWER" && ((o[e] = a - n), (o[r] = n));
      }),
      (Sm = (a, t, o, e, r, n, s, i) => {
        let u = a.length - 2,
          l = i.length === 0;
        for (let c = 0; c < u; ++c) {
          let p = l ? a[c + 2] * n[c] : i[c],
            d = Om(a[c + 2], n[c], r[c], t[c], o[c], p);
          Im(d, e, r, c, c + u),
            l &&
              i.push(
                n[c] * (a[c + 2] - 1) +
      ...
      (Em = (a, t, o, e) => {
        let n = t.length > 2 ? "getB(output_channel)" : "0.0",
          s = t[0].dims,
          i = t[1].dims,
          u = i[1],
          l = i[0] / e.group,
          c = [t[0].dims[0], t[1].dims[1] * e.group, ...e.outputShape],
          p = H(a.session.backend.glContext.version),
          { activationFunction: d, applyActivation: T } = Rt(e),
          w = `
  const ivec2 strides = ivec2(${e.strides[0]}, ${e.strides[1]});
  const ivec2 pads = ivec2(${e.pads[0]}, ${e.pads[1]});
  ${d}
...
`;
      ...
      (Lm = (a, t, o) => a.run(Dm(a, t, o), t)),
      (Cm = (a, t) => {
        let o = a.kernelShape.slice();
        if (a.kernelShape.length === 0)
          for (let i = 2; i < t[1].dims.length; ++i) o.push(t[1].dims[i]);
        let e = a.pads.slice(),
          r = a.outputShape.slice(),
          n = t[0].dims;
      ...
      (lf = (a) => {
        let t = a.attributes,
          ...
          n = t.getInt("group", 1),
          s = t.getInts("kernel_shape", []),
          i = t.getInts("output_padding", [0, 0]),
          u = t.getInts("output_shape", []),
      ...
      (Fm = (a, t) => {
        ...
        if (
          ...
          t.outputShape.length !== a[0].dims.length - 2
        )
...
var cf,
  ...
  oo = L(() => {
    ...
    fe();
    ae();
    (cf = { name: "Transpose", inputNames: ["A"], inputTypes: [0] }),
      (wr = (a, t, o) => (
        Nm(t),
        [
          a.run(
            { ...cf, cacheHint: o.cacheKey, get: () => $m(a, t[0], o.perm) },
            t
          ),
        ]
      )),
      (pf = (a) => Q({ perm: a.attributes.getInts("perm", []) })),
      ($m = (a, t, o) => {
        let e = t.dims;
        o = df(e, o);
        let r = km(e, o),
      ...
      float process(int indices[${n}]) {
        ...
        return {
          ...cf,
          output: { dims: r, type: t.type, textureType: 0 },
          shaderSource: s,
        };
      }),
      (df = (a, t) => (
        t && t.length !== a.length && (t = [...a.keys()].reverse()), t
      )),
      (km = (a, t) => ((t = df(a, t)), U.sortBasedOnPerm(a, t))),
      (Bm = (a, t, o) => {
        let e = [];
  ...
  bf = L(() => {
    ...
    (hf = (a, t, o) => {
      ...
      let e = o.blocksize,
        ...
        s =
          o.mode === "DCR"
            ? [t[0].dims[0], e, e, t[0].dims[1] / r, t[0].dims[2], t[0].dims[3]]
            : [
                t[0].dims[0],
                t[0].dims[1] / r,
                e,
...
var gf,
  ...
  Tf = L(() => {
    ...
    (gf = (a, t, o) => {
      ...
      (yf = (a) => a.attributes.getInt("axis", 1)),
      (Mm = (a, t) => {
...
var xf,
  ...
  vf = L(() => {
    ...
    fe();
    ae();
    (xf = (a, t, o) => (Vm(t, o.axis), [a.run(zm(a, t, o), t)])),
      (wf = (a) => Q({ axis: a.attributes.getInt("axis", 0) })),
      (Gm = { name: "Gather", inputNames: ["A", "B"], inputTypes: [0, 0] }),
      (Um = (a, t, o, e) => {
        let r = o[0].dims.slice(),
          n = o[1].dims.slice(),
        ...
        for (let d = 0; d < s.length; d++)
          d < e
            ? ((s[d] = r[d]), i.push(`inputIdx[${d}] = outputIdx[${d}];`))
            : d < e + n.length
            ? ((s[d] = n[d - e]),
              i.push(`indexDataIdx[${d - e}] = outputIdx[${d}];`))
            : ((s[d] = r[d - n.length + 1]),
              i.push(`inputIdx[${d - n.length + 1}] = outputIdx[${d}];`));
        let u = s.length || 1,
          l = r.length,
          c = n.length || 1,
          p = `
...
var Fi,
  ...
  Sf = L(() => {
    ...
    fe();
    ae();
    (Fi = (a, t, o) => (qm(t, o), [a.run(Wm(t, o), t)])),
      (_f = (a, t) => {
        let o = a.attributes.getInt("transA", 0) !== 0,
          e = a.attributes.getInt("transB", 0) !== 0,
          r = a.attributes.getFloat("alpha", 1),
          n = a.attributes.getFloat("beta", 1);
      ...
      (Wm = (a, t) => {
        let o = {
          name: "Gemm",
          inputNames: a.length === 3 ? ["A", "B", "C"] : ["A", "B"],
          inputTypes: a.length === 3 ? [0, 0, 0] : [0, 0],
          key: t.cacheKey,
        };
      ...
      (Hm = (a, t, o) => {
        ...
        let c = i.length,
          p = t.length === 3 ? `int c[${t[2].dims.length}];` : "",
          d = t.length === 3 ? "bcastIndices_C(indices, c);" : "",
          T = t.length === 3 ? "value += beta * _C(c);" : "",
          w = `
      ...
      (qm = (a, t) => {
        ...
        if (
          (a[0].type !== "float32" && a[0].type !== "float64") ||
          (a[1].type !== "float32" && a[1].type !== "float64") ||
          (a.length === 3 && a[2].type !== "float32" && a[2].type !== "float64")
        )
          throw new Error("Invalid input type.");
        if (
          a[0].type !== a[1].type ||
          (a.length === 3 && a[0].type !== a[2].type)
        )
...
var Af,
  ...
  Ef = L(() => {
    ...
    Ue();
    ae();
    (Af = (a, t, o) => (Jm(t), [a.run(Xm(a, t, o), t)])),
      (Pf = (a) => {
        let t = a.attributes.getFloat("scale"),
          o = a.attributes.getFloats("bias");
        return Q({ scale: t, bias: o });
      }),
      (jm = { name: "ImageScaler", inputNames: ["X"], inputTypes: [0] }),
      (Ym = (a, t, o, e) => {
        let r = o[0].dims.slice(),
          n = r.length,
          i = `
          ...
          variables: [
            {
              name: "bias",
              type: "float",
              arrayLength: e.bias.length,
              data: e.bias,
            },
            { name: "scale", type: "float", data: e.scale },
          ],
          shaderSource: i,
        };
      }),
      ...
      (Km = (a) => {
        ...
        for (let o = 0; o < a; ++o)
          o === 0
            ? t.push(`	if (channel == ${o}) { return bias[${o}]; }`)
            : o === a - 1
            ? t.push(`	else { return bias[${o}]; }`)
            : t.push(`	else if (channel == ${o}) { return bias[${o}]; }`);
        return (
          t.push("	}"),
          t.join(`
`)
...
var Lf,
  ...
  Ff = L(() => {
    ...
    (Lf = (a, t, o) => {
      ...
      (Cf = (a) => a.attributes.getFloat("epsilon", 1e-5)),
      (Df = {
      ...
      vec4 process(int[2] indices) {
        ...
        return {
          ...a,
          output: { dims: n, type: t.type, textureType: 4 },
          shaderSource: s,
        };
      }),
      (Qm = (a) => ({ ...Df, get: () => Zm(Df, a) })),
      ...
      (tb = (a, t, o, e, r) => {
        let n = H(a.session.backend.glContext.version),
          [s, i] = a.calculateTextureWidthAndHeight(r, 4),
          [u, l] = [s / 4, i],
          c = `
      ...
      float process(int[4] indices) {
        ...
        return {
          ...
          variables: [{ name: "epsilon", type: "float", data: e }],
          shaderSource: c,
        };
      }),
      (rb = (a, t, o, e) => {
...
function ob(a, t) {
  let o = a[0].dims[1],
    e = a[0].dims.length,
    r = -Math.floor((t.size - 1) / 2),
    n = Math.ceil((t.size - 1) / 2),
    s = `float(${t.alpha}) / float(${t.size})`,
    i = `float(${t.bias})`,
    u = `float(${t.beta})`,
    l = `
  ...
  return {
    ...
    output: { dims: a[0].dims, type: a[0].type, textureType: 0 },
    shaderSource: l,
  };
}
function ib(a, t) {
...
var $f,
  ...
  Nf = L(() => {
    ...
    Ue();
    ae();
    ($f = (a, t, o) => (ab(t), [a.run(ib(t, o), t)])),
      (kf = (a) => {
        let t = a.attributes.getFloat("alpha", 1e-4),
          o = a.attributes.getFloat("beta", 0.75),
          e = a.attributes.getFloat("bias", 1),
          r = a.attributes.getInt("size");
...
var sb,
  ...
  Uf = L(() => {
    ...
    we();
    ae();
    (sb = { name: "Pad", inputNames: ["A"], inputTypes: [0] }),
      ($i = (a, t, o) => (
        fb(t),
        [a.run({ ...sb, cacheHint: o.cacheKey, get: () => lb(a, t[0], o) }, t)]
      )),
      (Rf = (a) => {
        let t = a.attributes.getString("mode", "constant"),
          o = a.attributes.getFloat("value", 0),
          e = a.attributes.getInts("pads");
      ...
      (Gf = (a) => a.attributes.getString("mode", "constant")),
      (ub = (a, t, o) => {
        if (
          !a.session.isInitializer(t[1].dataId) ||
          (t.length >= 3 && !a.session.isInitializer(t[2].dataId))
        )
          throw new Error("dynamic pad attributes are not allowed");
        let e = Array.from(t[1].integerData),
          r = t.length >= 3 ? t[2].floatData[0] : 0;
        return Q({ mode: o, pads: e, value: r });
      }),
      (lb = (a, t, o) => {
        let e = U.padShape(t.dims.slice(), o.pads),
          r = e.length,
          s = `
      ${pb(a, t, o)}
      float process(int[${r}] indices) {
        ...
        return {
          ...
          inputNames: ["A"],
          inputTypes: [0],
          output: { dims: e, type: t.type, textureType: 0 },
          shaderSource: s,
        };
      }),
      (fb = (a) => {
      ...
      (pb = (a, t, o) => {
        let e = H(a.session.backend.glContext.version),
          [r, n] = a.calculateTextureWidthAndHeight(t.dims, 0),
          s = U.computeStrides(t.dims);
        switch (o.mode) {
          case "constant":
...
var Vf,
  ...
  ec = L(() => {
    ...
    (Vf = (a, t, o) => {
      ...
      return [a.run({ ...e, get: () => Hf(t, e, !1, o) }, t)];
    }),
      (Wf = (a) => {
        let t = a.attributes.getString("auto_pad", "NOTSET"),
          o = a.attributes.getInt("ceil_mode", 0),
          e = a.attributes.getInt("count_include_pad", 0) !== 0,
          r = a.attributes.getInts("kernel_shape"),
          n = a.attributes.getInts("strides", []),
          s = a.attributes.getInts("pads", []);
        if (o !== 0)
          throw new Error(
      ...
      `;
        return {
          ...t,
          output: { dims: n, type: a[0].type, textureType: 0 },
          shaderSource: c,
        };
      }),
      (qf = (a, t, o) => {
        ...
        return [a.run({ ...e, get: () => Hf(t, e, !0, o) }, t)];
      }),
      (jf = (a) => {
      ...
      (Yf = (a, t, o) => {
        ...
        return [a.run({ ...e, get: () => Kf(t, e, !1, o) }, t)];
      }),
      (Xf = (a) => {
        let t = a.attributes.getString("auto_pad", "NOTSET"),
          o = a.attributes.getInt("ceil_mode", 0),
          e = a.attributes.getInts("kernel_shape"),
          r = a.attributes.getInts("strides", []),
          n = a.attributes.getInts("pads", []),
          s = a.attributes.getInt("storage_order", 0),
          i = a.attributes.getInts("dilations", []);
        if (s !== 0)
          throw new Error(
    ...
    `;
      ...
      (Jf = (a, t, o) => {
        let e = a[0].dims.slice(),
          r = Object.hasOwnProperty.call(t, "dilations"),
          n = t.kernelShape.slice(),
          s = t.strides.slice(),
          i = r ? t.dilations.slice() : [],
          u = t.pads.slice();
        mr.adjustPoolAttributes(o, e, n, s, i, u);
        let l = mr.computePoolOutputShape(o, e, s, i, n, u, t.autoPad),
          c = Object.assign({}, t);
        return (
          r
            ? Object.assign(c, {
      ...
      (zf = { name: "GlobalMaxPool", inputNames: ["X"], inputTypes: [0] }),
      (Zf = (a, t) => (
        ao(t), [a.run({ ...zf, get: () => Kf(t, zf, !0, bb) }, t)]
      )),
      (ao = (a) => {
      ...
      (Qf = (a, t, o, e, r) => {
        ...
        if (t.kernelShape.length <= 2) {
          let s = t.kernelShape[t.kernelShape.length - 1],
            i = t.strides[t.strides.length - 1],
          ...
          for (int i = 0; i < ${s}; i++) {
            ...
            let v = t.kernelShape[t.kernelShape.length - 2],
              S = t.strides[t.strides.length - 2],
              A = t.pads[t.pads.length / 2 - 2],
      ...
      `;
          ...
          let s = U.size(t.kernelShape),
            i = U.computeStrides(t.kernelShape),
            u = i.length,
            l = t.pads.length,
            c = gb(u),
            p = io(a, "inputDims"),
            d = io(t.pads, "pads"),
            T = io(i, "kernelStrides"),
            w = io(t.strides, "strides"),
            v = t.pads.reduce((C, F) => C + F),
            S = "";
          return (
            v
              ? (S = `
...
var vr,
  ...
  uc = L(() => {
    ...
    (vr = (a, t, o, e, r) => {
      ...
      return [
        a.run(
          { ...n, cacheHint: o.cacheKey, get: () => yb(a, t, o, e, r, n) },
          t
        ),
      ];
    }),
      (er = (a) => {
        let t = a.attributes.getInts("axes", []),
          o = a.attributes.getInt("keepdims", 1) === 1;
      ...
      (yb = (a, t, o, e, r, n) => {
        let s = [],
          i = t[0].dims.length || 1,
          u = [],
          l = U.normalizeAxes(o.axes, t[0].dims.length),
          c = r(t, l),
          p = c[1];
        for (let w = 0; w < t[0].dims.length; w++)
          l.indexOf(w) >= 0 || l.length === 0
            ? (o.keepDims && s.push(1),
              (p = `
          for(int j${w} = 0; j${w} < ${t[0].dims[w]}; j${w}++) {
            ...
            : (u.push(`inputIdx[${w}] = outputIdx[${s.length}];`),
              s.push(t[0].dims[w]));
        let T = `
...
`)}
        ...
        return {
          ...n,
          output: { dims: s, type: t[0].type, textureType: 0 },
          shaderSource: T,
        };
      }),
      (Tb = (a) => {
      ...
      (nc = (a, t, o) =>
        vr(a, t, o, "ReduceMax", (r, n) => {
          let s = [];
          for (let i = 0; i < r[0].dims.length; i++)
            (n.indexOf(i) >= 0 || n.length === 0) &&
              s.push(`inputIdx[${i}] = 0;`);
          return [
            `${s.join(`
`)}
...
value = _A(inputIdx);`,
      ...
      (ac = (a, t, o) =>
        vr(a, t, o, "ReduceLogSum", () => [
          "value = 0.0;",
          "value += _A(inputIdx);",
          "value = log(value);",
        ])),
      (sc = (a, t, o) =>
        vr(a, t, o, "ReduceLogSumSquare", () => [
          "float t; value = 0.0;",
...
var lc,
  fc = L(() => {
    ...
    lc = (a, t) => {
      ...
      return a.session.pack
        ? [a.reshapePacked(t[0], o)]
        : [a.reshapeUnpacked(t[0], o)];
    };
  });
var cc,
  ki,
  ...
  Ni = L(() => {
    ...
    we();
    ae();
    (cc = { name: "Upsample", inputNames: ["X"], inputTypes: [0] }),
      (ki = (a, t, o) => (
        Bi(t, o),
        [a.run({ ...cc, cacheHint: o.cacheKey, get: () => xb(a, t, o) }, t)]
      )),
      (pc = (a) => dn(a, 7)),
      (dc = (a) => dn(a, 9)),
      (dn = (a, t) => {
        let o = t >= 10,
          e = a.attributes.getString("mode", "nearest");
        if (e !== "nearest" && e !== "linear" && (t < 11 || e !== "cubic"))
          throw new Error(`unrecognized mode: ${e}`);
        let r = [];
        t < 9 && ((r = a.attributes.getFloats("scales")), so(r, e, o));
        let n = a.attributes.getFloat("extrapolation_value", 0),
          s =
            t > 10
              ? a.attributes.getString(
        ...
        let i = s === "tf_crop_and_resize",
          u = i,
          l =
            e === "nearest" && t >= 11
              ? a.attributes.getString("nearest_mode", "round_prefer_floor")
              : "";
        if (
          [
            "round_prefer_floor",
        ...
        let c = a.attributes.getFloat("cubic_coeff_a", -0.75),
          p = a.attributes.getInt("exclude_outside", 0) !== 0;
        if (p && e !== "cubic")
          throw new Error(
        ...
        let d =
            t < 11
              ? !0
              : e === "nearest" && s === "asymmetric" && l === "floor",
          T = 0,
          w = 0,
          v = 0;
        return (
      ...
      (xb = (a, t, o) => {
        let e = H(a.session.backend.glContext.version),
          [r, n] = a.calculateTextureWidthAndHeight(t[0].dims, 0),
          s = t[0].dims.map((v, S) => Math.floor(v * o.scales[S])),
          [i, u] = a.calculateTextureWidthAndHeight(s, 0),
          l = s.length,
          c = new Array(l),
          p = new Array(l),
          d = `
      ...
      `;
        for (let v = l - 1; v >= 0; v--)
          (c[v] = v === l - 1 ? 1 : c[v + 1] * s[v + 1]),
            (p[v] = v === l - 1 ? 1 : p[v + 1] * t[0].dims[v + 1]),
            (d += `
    ...
    float process(int indices[2]) {
      ...
      (Bi = (a, t) => {
        if (
          !a ||
          (t.opset < 9 && a.length !== 1) ||
          (t.opset >= 9 && t.opset < 11 && a.length !== 2) ||
          (t.opset >= 11 && a.length < 2)
        )
...
var Ri,
  ...
  bc = L(() => {
    ...
    Tr();
    Ni();
    (Ri = { name: "Resize", inputNames: ["A"], inputTypes: [2] }),
      (Mi = (a, t, o) => (
        Bi(t, o),
        [a.run({ ...Ri, cacheHint: o.cacheKey, get: () => wb(a, t, o) }, t)]
      )),
      (hc = (a) => dn(a, 10)),
      (mc = (a) => dn(a, 11)),
      (wb = (a, t, o) => {
        ...
        if (
          ...
          return {
            ...Ri,
            output: { dims: n, type: t[0].type, textureType: 2 },
            hasMain: !0,
        ...
        if (i < 2)
          throw new Error(
            `output dimension should be at least 2, but got ${i}`
          );
        let u = n[i - 2],
          l = n[i - 1],
          c = t[0].dims;
        if (i !== c.length)
          throw new Error(
            `output dimension should match input ${c.length}, but got ${i}`
          );
        let p = c[i - 2],
          d = c[i - 1],
          T = r[i - 2],
...
var Gi,
  ...
  _c = L(() => {
    ...
    fe();
    ae();
    (Gi = { name: "Slice", inputNames: ["A"], inputTypes: [0] }),
      (Tc = (a, t, o) => (
        Sb(t),
        [a.run({ ...Gi, cacheHint: o.cacheKey, get: () => wc(a, t[0], o) }, t)]
      )),
      (xc = (a) => {
        let t = a.attributes.getInts("starts"),
          o = a.attributes.getInts("ends"),
          e = a.attributes.getInts("axes", []);
        return Q({ starts: t, ends: o, axes: e });
      }),
      (wc = (a, t, o) => {
        let e = o.axes.length === 0 ? t.dims.slice(0).map((p, d) => d) : o.axes,
          r = U.normalizeAxes(e, t.dims.length),
          n = o.starts.map((p, d) =>
            p > t.dims[r[d]] - 1
              ? t.dims[r[d]]
              : U.normalizeAxis(p, t.dims[r[d]])
          ),
          s = o.ends.map((p, d) =>
            p > t.dims[r[d]] - 1
              ? t.dims[r[d]]
      ...
      (vc = (a, t) => {
        ...
        let o = Ab(a, t);
        return [
          a.run({ ...Gi, cacheHint: o.cacheKey, get: () => wc(a, t[0], o) }, [
            t[0],
          ]),
        ];
      }),
      (Ab = (a, t) => {
        if (
          !a.session.isInitializer(t[1].dataId) ||
          !a.session.isInitializer(t[2].dataId) ||
          (t.length >= 4 && !a.session.isInitializer(t[3].dataId)) ||
          (t.length >= 5 && !a.session.isInitializer(t[4].dataId))
        )
          throw new Error("dynamic slice attributes are not allowed");
        if (t.length >= 5 && t[4].integerData.some((s) => s !== 1))
          throw new Error("currently non-1 steps is not supported for Slice");
        let o = Array.from(t[1].integerData),
          e = Array.from(t[2].integerData),
          r = t.length >= 4 ? Array.from(t[3].integerData) : [],
          n = `${r};${o};${e}`;
...
var Oc,
  ...
  Fc = L(() => {
    ...
    ae();
    oo();
    (Oc = { name: "SoftmaxComputeMax", inputNames: ["A"], inputTypes: [0] }),
      (Ic = {
      ...
      (Ac = (a, t, o) => {
        Cc(t);
        let e = t[0].dims.slice(),
          r = U.normalizeAxis(o.axis, e.length),
          n = U.sizeToDimension(e, r),
          s = U.sizeFromDimension(e, r);
        return Lc(a, t, o, n, s);
      }),
      (Pc = (a) => Q({ axis: a.attributes.getInt("axis", 1) })),
      (Ec = (a) => Q({ axis: a.attributes.getInt("axis", -1) })),
      (Dc = (a, t, o) => {
        Cc(t);
        let e = t[0].dims.slice(),
          r = U.normalizeAxis(o.axis, e.length),
          ...
          c;
        s &&
          ((u = Array.from({ length: n }).map((w, v) => v)),
          (u[r] = n - 1),
          (u[n - 1] = r),
          u.map((w) => i.push(e[w])),
          (c = Q({ perm: u })),
          (l = wr(a, t, c)));
        let p = s ? U.sizeToDimension(i, n - 1) : U.sizeToDimension(e, n - 1),
          d = s ? U.sizeFromDimension(i, n - 1) : U.sizeFromDimension(e, n - 1),
          T = Lc(a, s ? l : t, o, p, d);
        return s ? wr(a, T, c) : T;
      }),
      (Lc = (a, t, o, e, r) => {
        let n = Eb(a, t[0], e, r, [e]),
          s = a.run({ ...Oc, cacheHint: o.cacheKey, get: () => n }, t),
          i = Db(a, t[0], e, r, n.output.dims, [e]),
          u = a.run({ ...Ic, cacheHint: o.cacheKey, get: () => i }, [t[0], s]),
          l = Lb(a, t[0], e, r, n.output.dims, i.output.dims);
        return [
          a.run({ ...Sc, cacheHint: o.cacheKey, get: () => l }, [t[0], s, u]),
        ];
      }),
      (Eb = (a, t, o, e, r) => {
        let [n, s] = a.calculateTextureWidthAndHeight(t.dims, 0),
          i = r.length;
        if (o < 1 || e < 1)
          throw new Error(
      ...
      (Db = (a, t, o, e, r, n) => {
        let [s, i] = a.calculateTextureWidthAndHeight(t.dims, 0),
          u = n.length;
        if (o < 1 || e < 1)
          throw new Error(
            "Logical row count N and feature count D must be greater than or equal to 1"
        ...
        let l = H(a.session.backend.glContext.version),
          c = `
      float process(int[${u}] indices) {
        ...
        return {
          ...Ic,
          output: { dims: n, type: t.type, textureType: 0 },
          shaderSource: c,
        };
      }),
      (Lb = (a, t, o, e, r, n) => {
...
var $c,
  ...
  Nc = L(() => {
    ...
    fe();
    ae();
    ($c = { name: "Split", inputNames: ["A"], inputTypes: [0] }),
      (kc = (a, t, o) => {
        $b(t);
        let e = U.normalizeAxis(o.axis, t[0].dims.length),
          r = Cb(a, t, e, o),
          n = [];
        for (let s = 0; s < r; ++s)
          n.push(
      ...
      (Bc = (a) => {
        let t = a.attributes.getInt("axis", 0),
          o = a.attributes.getInts("split", []),
          e = a.outputs.length;
      ...
      (Fb = (a, t, o, e, r) => {
        let [n, s] = an.splitShape(t.dims, e, o.split, o.numOutputs),
          i = s[r],
          u = n[r],
          c = `
    ...
    `;
        return {
          ...
          output: { dims: u, type: t.type, textureType: 0 },
          shaderSource: c,
        };
      }),
      ($b = (a) => {
...
var Ui,
  ...
  Gc = L(() => {
    ...
    (Ui = (a, t, o) => {
      ...
      (Rc = (a, t) => (Bb(t), Ui(a, [t[0]], Array.from(t[1].integerData)))),
      (Mc = (a) => a.attributes.getInts("axes")),
      (kb = (a) => {
...
var Uc,
  ...
  zc = L(() => {
    ...
    (Uc = (a, t) => {
      ...
      void main() {
        vec4 result = ${t
          .map((i, u) => `${e.texture2D}(X${u},TexCoords)`)
          .join(" + ")};
        ${e.output} = result;
      }
    `;
        return {
          ...o,
          output: { dims: r, type: t[0].type, textureType: 0 },
          hasMain: !0,
          shaderSource: s,
        };
      }),
    ...
    (Vc = (a, t) => {
      ...
      (Mb = (a, t, o) => {
        ...
        for (let u = 0; u < e.length; u++)
          (r[u] = e[u] * t[1].numberData[u]),
            n.push(
              `inputIdx[${u}] = int(mod(float(outputIdx[${u}]), ${e[u]}.));`
            );
        let s = r.length,
          i = `
...
var zi,
  ...
  jc = L(() => {
    ...
    (zi = (a, t, o) => {
      ...
      (Hc = (a, t) => (zb(t), zi(a, [t[0]], Array.from(t[1].integerData)))),
      (qc = (a) => a.attributes.getInts("axes")),
      (Ub = (a) => {
        if (!a || a.length !== 1)
...
var Yc,
  Xc = L(() => {
    ...
    Yc = [
      ...
      ["Concat", "", "4+", _l, Il],
      ["Conv", "", "1+", Li, Ci],
      ["ConvTranspose", "", "1+", uf, lf],
      ["Cos", "", "7+", $l],
      ["Div", "", "7+", sl],
      ["Dropout", "", "7+", Oi],
      ["DepthToSpace", "", "1+", hf, mf],
      ["Equal", "", "7+", ul],
      ["Elu", "", "6+", kl, Bl],
      ["Exp", "", "6+", Nl],
      ["Flatten", "", "1+", gf, yf],
      ["Floor", "", "6+", Rl],
      ["FusedConv", "com.microsoft", "1+", Li, Ci],
      ["Gather", "", "1+", xf, wf],
      ["Gemm", "", "7-10", Fi, Of],
      ["Gemm", "", "11+", Fi, If],
      ["GlobalAveragePool", "", "1+", qf, jf],
      ["GlobalMaxPool", "", "1+", Zf],
      ["Greater", "", "7+", ll],
      ["Identity", "", "1+", Oi],
      ["ImageScaler", "", "1+", Af, Pf],
      ["InstanceNormalization", "", "6+", Lf, Cf],
      ["LeakyRelu", "", "6+", Ml, Gl],
      ["Less", "", "7+", fl],
      ["LRN", "", "1+", $f, kf],
      ["Log", "", "6+", Ul],
      ...
      ["Pow", "", "7+", dl],
      ["PRelu", "", "7+", hl],
      ["ReduceLogSum", "", "1+", ac, er],
      ["ReduceMax", "", "1+", nc, er],
      ["ReduceMean", "", "1+", rc, er],
      ["ReduceMin", "", "1+", oc, er],
      ["ReduceProd", "", "1+", ic, er],
      ["ReduceSum", "", "1-12", tc, er],
      ["ReduceSumSquare", "", "1+", sc, er],
      ["Relu", "", "6+", Wl],
      ["Reshape", "", "5+", lc],
      ["Resize", "", "10", Mi, hc],
      ["Resize", "", "11+", Mi, mc],
...
var Kc,
  ...
  Zc = L(() => {
    ...
    (Kc =
      /@inline[\s\n\r]+(\w+)[\s\n\r]+([0-9a-zA-Z_]+)\s*\(([^)]*)\)\s*{(([^}]|[\n\r])*)}/gm),
      (Vb = "(\\w+)?\\s+([_0-9a-zA-Z]+)\\s+=\\s+__FUNC__\\((.*)\\)\\s*;");
  });
function Mr(a, t) {
  let o = [],
    e = [],
    r = t != null && Array.isArray(t) && t.length === 0,
    n = t == null || r ? null : Wb(t, a).sort(),
    s = 0;
  for (let i = 0; i < a.length; ++i) {
    if (n != null) {
      if (n[s] === i && a[i] !== 1)
        throw new Error(
          `Can't squeeze axis ${i} since its dim '${a[i]}' is not 1`
        );
      (n[s] == null || n[s] > i) && a[i] === 1 && (o.push(a[i]), e.push(i)),
        n[s] <= i && s++;
    }
...
function Wb(a, t) {
  let o = t.length;
  return (
    (a = a == null ? t.map((e, r) => r) : [].concat(a)),
    Fr(
      a.every((e) => e >= -o && e < o),
      () =>
        `All values in axis param must be in range [-${o}, ${o}) but got axis ${a}`
    ),
    Fr(
      a.every(Hb),
      () => `All values in axis param must be integers but got axis ${a}`
    ),
    a.map((e) => (e < 0 ? o + e : e))
  );
}
  ...
  Vi = L(() => {
    ...
    uo = class {
      ...
      computeTextureWH(t, o) {
        ...
        return (
          o && o.isPacked && ((e[0] /= 2), (e[1] /= 2)),
          o && o.reverseWH ? [e[1], e[0]] : e
        );
      }
      computeTexture(t, o) {
        let e = o && o.isPacked;
        ...
        if (o && o.breakAxis !== void 0) {
          let i =
              o.breakAxis >= t.length
                ? 1
                : t.slice(o.breakAxis).reduce((l, c) => l * c),
            u =
              o.breakAxis <= 0
                ? 1
                : t.slice(0, o.breakAxis).reduce((l, c) => l * c);
          if (i > r || u > r)
            ce.verbose(
              "TextureLayout",
              `Given width/height preferences were unattainable: shape:${t}, breakAxis:${o.breakAxis}`
            );
          else return [i, u];
        }
        let n = t.slice(0);
    ...
    `;
      ...
      getOutputUnpacked3DCoords(o, e) {
        ...
        let i = ["r", "c", "d"],
          u = s
            .map((l, c) => {
              let p = `int ${i[c]} = index / ${l}`,
                d =
                  c === s.length - 1
                    ? `int ${i[c + 1]} = index - ${i[c]} * ${l}`
                    : `index -= ${i[c]} * ${l}`;
              return `${p}; ${d};`;
            })
            .join("");
        ...
        return (
          this.context.programInfo.inputNames.forEach((r, n) => {
            let s = this.context.inputTextureLayouts[n],
              i = Yn(r);
            s.isPacked
              ? (o[i] = this.getPackedSamplerFromInput(i, r, s))
              : (o[i] = this.getUnpackedSamplerFromInput(i, r, s));
            let u = Gu(r);
            s.unpackedShape.length <= e.unpackedShape.length &&
              (s.isPacked
                ? (o[u] = this.getPackedSamplerAtOutputCoords(u, s, e, r))
                : (o[u] = this.getUnpackedSamplerAtOutputCoords(u, s, e, r)));
          }),
          o
        );
      }
      getPackedSamplerAtOutputCoords(o, e, r, n) {
        let s = e.unpackedShape,
          i = r.unpackedShape,
          l = Yn(n),
          c = s.length,
          p = i.length,
          d = Ze.getBroadcastDims(s, i),
          T = Qe(p),
          w = p - c,
          v,
          S = Dt();
        c === 0
          ...
          : p < 2 && d.length >= 1
          ? (v = "coords = 0;")
          : (v = d.map((He) => `coords.${S[He + w]} = 0;`).join(`
`));
        let A = "";
        p < 2 && c > 0
          ? (A = "coords")
          : (A = s.map((He, Le) => `coords.${S[Le + w]}`).join(", "));
      ...
      `;
        ...
        `);
          ...
          let He = c - 2,
            Le = c - 1;
          d.indexOf(He) > -1 && d.indexOf(Le) > -1
            ? (C = "return vec4(outputValue.x);")
            : d.indexOf(He) > -1
            ? (C =
                "return vec4(outputValue.x, outputValue.y, outputValue.x, outputValue.y);")
            : d.indexOf(Le) > -1 &&
              (C = "return vec4(outputValue.xx, outputValue.zz);");
        }
        let G = `
    ...
    `;
      ...
      getUnpackedSamplerAtOutputCoords(o, e, r, n) {
        ...
        u === 0
          ...
          : l < 2 && w.length >= 1
          ? (S = "coords = 0;")
          : (S = w.map((J) => `coords.${A[J + v]} = 0;`).join(`
`));
        let C = "";
        l < 2 && u > 0
          ? (C = "coords")
          : (C = e.unpackedShape
              .map((J, j) => `coords.${A[j + v]}`)
              .join(", "));
        let F = `
        float ${o}() {
          ${T} coords = getOutputCoords();
      ...
      getPackedSampler1D(o, e, r) {
        let n = [r.width, r.height],
          s = [n[1], n[0]],
          i = H(this.context.glContext.version),
          l = `vec4 ${o}(int index) {
      ...
      getPackedSampler3D(o, e, r) {
        let n = r.unpackedShape,
          s = [r.width, r.height],
          i = [s[0], s[1]],
          u = H(this.context.glContext.version);
        if (n[0] === 1) {
          let v = n.slice(1),
            S = [1, 2],
            A = $r(n, v),
          ...
          F.unpackedShape = A;
          let J = this.getPackedSamplerFromInput(o, e, F),
            ie = `${J.routineBody}
      vec4 ${o}(int b, int row, int col) {
        ...
        let l = i[0],
          ...
          p = Math.ceil(n[2] / 2),
          d = p * Math.ceil(n[1] / 2),
          w = `vec4 ${o}(int b, int row, int col) {
      ...
      getPackedSamplerND(o, e, r) {
        let n = r.unpackedShape,
          ...
          p = l[0],
          d = Math.ceil(n[s - 1] / 2),
          T = d * Math.ceil(n[s - 2] / 2),
          w = "int b, int row, int col",
          v = `b * ${T} + (row / 2) * ${d} + (col / 2)`;
        for (let C = 2; C < s - 1; C++)
          (w = `int b${C}, ` + w),
            (T *= n[s - C - 1]),
      ...
      getUnpackedSampler2D(o, e, r) {
        ...
        let { newShape: i, keptDims: u } = Mr(n),
          l = i;
      ...
      getUnpackedSampler3D(o, e, r) {
        ...
        if (c.length < n.length) {
          ...
          S.unpackedShape = w;
          let A = this.getUnpackedSamplerFromInput(o, e, S),
            C = l.reverse(),
            F = `
          ${A.routineBody}
    ...
    `;
      ...
      valueFrom() {
        let o = {};
        return (
          this.context.programInfo.inputNames.forEach((e, r) => {
            let n = this.context.inputTextureLayouts[r],
              i = (n.unpackedShape.length > 0 ? n.unpackedShape : n.shape)
                .length,
              u = `_${e}`;
            (o[u] = new R(
              this.getValueFromSingle(e, i, n.width, n.height, !1),
              [
              ...
              (u = u + "_T"),
              (o[u] = new R(
                this.getValueFromSingle(e, i, n.width, n.height, !0),
                [
                  `shapeUtils.indicesToOffset${u}`,
                  "coordinates.offsetToCoords",
                  "fragcolor.getColorAsFloat",
...
var fo,
  tp = L(() => {
    ...
    fo = class a extends dt {
      ...
      encodeFloat32() {
        return {
          encode: new R(`highp vec4 encode(highp float f) {
      ...
      decodeFloat32() {
        return {
          decode: new R(`highp float decode(highp vec4 rgba) {
        return rgba.r;
      }
        `),
        };
      ...
      static isLittleEndian() {
        let t = new ArrayBuffer(4),
          o = new Uint32Array(t),
          e = new Uint8Array(t);
        if (((o[0] = 3735928559), e[0] === 239)) return !0;
        if (e[0] === 222) return !1;
  ...
  np = L(() => {
    ...
    po = class a extends dt {
        ...
        return (
          this.context.programInfo.inputNames.forEach((e, r) => {
            ...
            if (n.length <= t) {
              ...
              for (let p = 0; p < s; ++p)
                l += `
          realIndices[${p}] = int( mod(float(bcastedIndices[${i + p}]), ${
                  n[p]
                }.0) );
          `;
              let c = `
      ...
      indicesToOffset() {
        let t = {};
        return (
          this.context.programInfo.inputNames.forEach((o, e) => {
            let r = this.context.inputTextureLayouts[e].shape,
              n = this.context.inputTextureLayouts[e].strides,
              s = r.length,
              i = `indicesToOffset_${o}`;
            (t[i] = new R(a.indexToOffsetSingle(i, s, n))),
              (i = `indicesToOffset_${o}_T`),
              (t[i] = new R(a.indexToOffsetSingle(i, s, n.slice().reverse())));
          }),
          t
        );
      }
        ...
        return (
          this.context.programInfo.inputNames.forEach((o, e) => {
            let r = this.context.inputTextureLayouts[e].shape,
              n = this.context.inputTextureLayouts[e].strides,
              s = r.length,
              i = `offsetToIndices_${o}`;
            (t[i] = new R(a.offsetToIndicesSingle(i, s, n))),
              (i = `offsetToIndices_${o}_T`),
              (t[i] = new R(
                a.offsetToIndicesSingle(i, s, n.slice().reverse())
              ));
          }),
          t
        );
  ...
  ap = L(() => {
    ...
    mo = class {
      constructor(t, o, e, r) {
        ...
        (this.context = new Zn(t, o, e, r)),
          Object.keys(Wi).forEach((s) => {
        ...
        for (let s in this.libs) {
          ...
          for (let l in u) {
            let c = s + "." + l,
              p;
            n[c]
              ? ((p = n[c]), (p.routineBody = u[l].routineBody))
              : ((p = new cn(c, u[l].routineBody)), (n[c] = p));
            let d = u[l].dependencies;
            if (d)
              for (let T = 0; T < d.length; ++T)
                if (n[d[T]]) p.addDependency(n[d[T]]);
                else {
                  let w = new cn(d[T]);
      ...
      preprocess() {
        let t = this.context.programInfo,
          o = t.shaderSource;
        return (
      ...
      ${Mu(
        ...
        this.context.outputTextureLayout.shape.length
          ...
          (o = Jc(o)),
          `${Ru(this.context.glContext.version)}
...
`;
      ...
      selectGlslLibRoutinesToBeIncluded(t) {
        let o = [];
        return (
          Object.keys(this.glslLibRoutineDependencyGraph).forEach((e) => {
            let r = e.split(".")[1];
            t.indexOf(r) !== -1 &&
              o.push(this.glslLibRoutineDependencyGraph[e]);
          }),
  ...
  sp = L(() => {
    ...
    bo = class {
      ...
      run(t, o, e) {
        this.profiler.event(
          "op",
          `ProgramManager.run ${t.programInfo.name ?? "unknown kernel"}`,
          () => {
            ...
            try {
              this.bindOutput(e),
                this.attributesBound || this.bindAttributes(t.attribLocations),
                this.bindUniforms(
                  t.uniformLocations,
                  t.programInfo.variables ?? [],
                  o
                );
            } catch (s) {
      ...
      dispose() {
        this.vertexShader && this.glContext.deleteShader(this.vertexShader),
          this.repo.forEach((t) => this.glContext.deleteProgram(t.program));
      }
      build(t, o, e) {
        return this.profiler.event("backend", "ProgramManager.build", () => {
          let r = new mo(this.glContext, t, o, e),
            n = r.preprocess(),
            s = this.compile(n);
          return {
            programInfo: t,
...
`
        ...
        let o = this.glContext.compileShader(
          ...
          e = this.glContext.createProgram(this.vertexShader, o);
      ...
      bindOutput(t) {
        ...
        ce.verbose(
          "ProrgramManager",
          `Binding output texture to Framebuffer: w/h=${o}/${e}, shape=${t.shape}, type=${t.tensor.type}`
        ),
          this.glContext.attachFramebuffer(t.texture, o, e);
      }
      bindAttributes(t) {
        let o = t.position,
          e = t.textureCoord;
        this.glContext.setVertexAttributes(o, e), (this.attributesBound = !0);
      }
      bindUniforms(t, o, e) {
        let r = this.glContext.gl,
          n = 0;
    ...
    go = class {
      ...
      createTextureFromLayout(t, o, e, r) {
        ...
        if (this.config.reuseTextures) {
          (l = `${i}x${u}_${s.format}_${s.internalFormat}_${s.textureType}`),
            (c = this.inUseTextures.get(l)),
            c || ((c = []), this.inUseTextures.set(l, c));
        ...
        return (
          this.config.reuseTextures &&
            (c.push(p), this.textureLookup.set(p, l)),
          p
        );
      }
      readTexture(t, o, e) {
        return (
          ...
          this.profiler.event("backend", "TextureManager.readTexture", () => {
            let r = t.shape.reduce((s, i) => s * i) * e,
      ...
      readUint8TextureAsFloat(t) {
        return this.profiler.event(
          ...
          () => {
            let o = t.shape.reduce((r, n) => r * n),
              e = this.glContext.readTexture(
                t.texture,
                t.width,
                t.height,
                o * 4,
      ...
      releaseTexture(t, o) {
        ...
        if (
          this.config.reuseTextures &&
          ((e = this.textureLookup.get(t.texture)), e)
        ) {
        ...
        (!e || o) &&
          (ce.verbose(
            "TextureManager",
            `Deleting texture of size ${t.width}x${t.height}`
          ),
          this.glContext.deleteTexture(t.texture));
      }
      toTensorData(t, o) {
        switch (t) {
          case "int16":
  ...
  lp = L(() => {
    ...
    yo = class {
      constructor(t, o) {
        this.backend = t;
        this.context = o;
        (this.layoutStrategy = new uo(t.glContext.maxTextureSize)),
          (this.programManager = new bo(
            this.context.profiler,
            t.glContext,
            this.layoutStrategy
          )),
          (this.textureManager = new go(
            t.glContext,
            this.layoutStrategy,
            this.context.profiler,
            { reuseTextures: t.textureCacheMode === "full" }
          )),
          (this.packedTextureDataCache = new Map()),
          (this.unpackedTextureDataCache = new Map()),
          (this.pack = t.pack),
      ...
      onGraphInitialized(t) {
        let o = t
          .getValues()
          .filter((e) => e.from === -1 && e.tensor)
          .map((e) => e.tensor.dataId);
        this.initializers = new Set(o);
      }
      isInitializer(t) {
        return this.initializers ? this.initializers.has(t) : !1;
      }
      addInitializer(t) {
      ...
      setTextureData(t, o, e = !1) {
        ce.verbose("WebGLSessionHandler", "Storing Texture data in cache"),
          e
            ? this.packedTextureDataCache.set(t, o)
            : this.unpackedTextureDataCache.set(t, o);
      }
      dispose() {
        this.programManager.dispose(),
          this.textureManager.clearActiveTextures(),
          this.packedTextureDataCache.forEach((t) =>
            this.textureManager.releaseTexture(t, !0)
          ),
          (this.packedTextureDataCache = new Map()),
          this.unpackedTextureDataCache.forEach((t) =>
            this.textureManager.releaseTexture(t, !0)
    ...
    hn = class {
      ...
      readTexture(t, o, e, r, n, s) {
        ...
        return (
          ...
          i.readPixels(0, 0, o, e, i.RGBA, u.textureType, l),
          this.checkError(),
          u.decode(l, r)
        );
      }
      ...
      setVertexAttributes(t, o) {
        let e = this.gl;
        e.vertexAttribPointer(t, 3, e.FLOAT, !1, 20, 0),
          e.enableVertexAttribArray(t),
          o !== -1 &&
            (e.vertexAttribPointer(o, 2, e.FLOAT, !1, 20, 12),
      ...
      compileShader(t, o) {
        ...
        if (
          (e.shaderSource(r, t),
          e.compileShader(r),
          e.getShaderParameter(r, e.COMPILE_STATUS) === !1)
        )
...
${t}`);
      ...
      getEncoder(t, o, e = 0) {
        ...
        switch (t) {
          case "float":
            return e === 1 || this.isRenderFloat32Supported
              ? new un(this.gl, o)
              : new un(
                  this.gl,
                  o,
      ...
      queryVitalParameters() {
        ...
        (this.isBlendSupported =
          ...
          (this.maxTextureImageUnits = t.getParameter(
      ...
      checkFloat32Blend() {
        ...
        try {
          ...
          t.disable(t.BLEND),
            ...
            n && t.deleteShader(n),
            e &&
              (t.bindFramebuffer(t.FRAMEBUFFER, null), t.deleteFramebuffer(e)),
            o && (t.bindTexture(t.TEXTURE_2D, null), t.deleteTexture(o));
        }
      }
      beginTimer() {
      ...
      isTimerResultAvailable(t) {
        ...
        if (this.version === 2 && this.disjointTimerQueryWebgl2Extension) {
          ...
          (o = r.getQueryParameter(t, r.QUERY_RESULT_AVAILABLE)),
            (e = r.getParameter(n.GPU_DISJOINT_EXT));
        } else throw new Error("WebGL1 profiling currently not supported");
        return o && !e;
      }
      getTimerResult(t) {
      ...
      async waitForQueryAndGetTime(t) {
        return (
          await mi(() => this.isTimerResultAvailable(t)), this.getTimerResult(t)
        );
      }
      ...
      async addItemToPoll(t, o) {
        this.itemsToPoll.push({ isDoneFn: t, resolveFn: o }),
          !(this.itemsToPoll.length > 1) &&
            (await mi(() => (this.pollItems(), this.itemsToPoll.length === 0)));
      }
    };
  });
function Hi(a) {
  let t;
  if (
    ((!a || a === "webgl2") && "webgl2" in Gr
      ? (t = Gr.webgl2)
      : (!a || a === "webgl") && "webgl" in Gr && (t = Gr.webgl),
    !t)
  )
    try {
      let e = Xb();
...
function cp(a, t) {
  ...
  if (
    (!t || t === "webgl") &&
    ((e = a.getContext("webgl", r) || a.getContext("experimental-webgl", r)), e)
  )
    try {
      return new hn(e, 1);
    } catch (n) {
  ...
  dp = L(() => {
    ...
    To = class {
      ...
      initialize() {
        try {
          return (
            (this.glContext = Hi(this.contextId)),
          ...
          return (
            ce.warning(
              "WebGLBackend",
              `Unable to initialize WebGLBackend. ${t}`
            ),
            !1
          );
        }
      ...
      (xo = class {
        ...
        initialize(t) {
          this.profiler.event("session", "ExecutionPlan.initialize", () => {
            ...
            (this._ops = t.map((e, r) => new ji(e, o[r]))),
              this.reset(),
              (this._starter = []),
              this._ops.forEach((e, r) => {
                let n = !0;
        ...
        async execute(t, o) {
          return this.profiler.event(
            ...
            async () => {
              this.reset();
              let e = t.createInferenceHandler(),
              ...
              for (; u < n.length; ) {
                ...
                ce.verbose(
                  "ExecPlan",
                  `Runing op:${p.node.name} (${T.map(
                    (S, A) =>
                      `'${p.node.inputs[A]}': ${S.type}[${S.dims.join(",")}]`
                  ).join(", ")})`
                );
                let w = await this.profiler.event(
                  "node",
                  p.node.name,
                  async () => p.op.impl(e, T, p.op.context)
                );
                ...
                w.forEach((S, A) => {
                  ...
                  if (this._values[C])
                    throw new Error(
                      `output [${C}] already has value: op:${p.node.name}`
                    );
                  this._values[C] = S;
                });
                let v = new Set();
              ...
              for (let c = 0; c < this.graph.getOutputIndices().length; c++) {
                let p = this.graph.getOutputIndices()[c],
                  d = this._values[p];
                if (d === void 0)
              ...
              return (
                ce.verbose("ExecPlan", "disposing of inferenceHandler"),
                e.dispose(),
                l
              );
            }
...
var oe,
  ...
  gp = L(() => {
    ...
    yr();
    fe();
    (bt = V.experimental.fbs),
      (mn = class a {
        constructor(t) {
          if (((this._attributes = new Map()), t != null)) {
            for (let o of t)
              o instanceof oe.onnx.AttributeProto
                ? this._attributes.set(o.name, [a.getValue(o), a.getType(o)])
                : o instanceof bt.Attribute &&
                  this._attributes.set(o.name(), [a.getValue(o), a.getType(o)]);
        ...
        static getType(t) {
          ...
          switch (o) {
            ...
            default:
              throw new Error(
                `attribute type is not supported yet: ${oe.onnx.AttributeProto.AttributeType[o]}`
              );
          }
        }
        static getValue(t) {
          let o = t instanceof oe.onnx.AttributeProto ? t.type : t.type();
          if (
            o === oe.onnx.AttributeProto.AttributeType.GRAPH ||
            o === oe.onnx.AttributeProto.AttributeType.GRAPHS
          )
          ...
          if (o === oe.onnx.AttributeProto.AttributeType.TENSOR)
            return t instanceof oe.onnx.AttributeProto
              ? $e.fromProto(e)
              : $e.fromOrtTensor(e);
          ...
          return o === oe.onnx.AttributeProto.AttributeType.STRING &&
            t instanceof oe.onnx.AttributeProto
            ? sn(e)
            : o === oe.onnx.AttributeProto.AttributeType.STRINGS &&
              t instanceof oe.onnx.AttributeProto
            ? e.map(sn)
            : e;
        }
            ...
            default:
              throw new Error(
                `unsupported attribute type: ${
                  oe.onnx.AttributeProto.AttributeType[t.type]
                }`
              );
          }
        }
        static getValueNoCheckFromOrtFormat(t) {
          switch (t.type()) {
            ...
            default:
              throw new Error(
                `unsupported attribute type: ${bt.AttributeType[t.type()]}`
              );
          }
        }
      });
...
var Xi,
  ...
  yp = L(() => {
    ...
    yr();
    fe();
    (wo = V.experimental.fbs),
      (Ki = { from: (a, t) => new Yi(a, t) }),
      (Mt = class {
        constructor(t) {
          (this._from = void 0),
            (this._to = []),
            (this.tensor = void 0),
            (this.type = void 0),
            t && (this.type = We.tensorValueTypeFromProto(t.type.tensorType));
        }
        get from() {
          return this._from;
        }
      ...
      (vo = class {
        constructor(t, o) {
          t instanceof Xi.onnx.NodeProto
            ? ((this.name = t.name),
              (this.opType = t.opType),
              (this.attributes = new mn(t.attribute)))
            : t instanceof wo.Node &&
              ((this.name = o ?? t.name()),
              (this.opType = t.opType()),
              (this.attributes = new mn(We.tensorAttributesFromORTFormat(t)))),
            (this.inputs = []),
            (this.outputs = []),
            (this.executeNode = !0);
        }
      ...
      (Yi = class {
        ...
        buildGraphFromOnnxFormat(t) {
          ...
          for (let n of t.initializer) {
            ...
            if (s === void 0) {
              ...
              (i.type = {
                ...
                (s = this._allData.push(i) - 1),
                o.set(n.name, s);
            }
            (this._allData[s]._from = -1),
              (this._allData[s].tensor = $e.fromProto(n));
          }
          ...
          for (let n = 0; n < this._nodes.length; n++) {
            ...
            for (let u of i.output) {
              ...
              if (
                (typeof l > "u" &&
                  ((l = this._allData.push(new Mt()) - 1), o.set(u, l)),
                s.outputs.push(l),
              ...
              if (((this._allData[l]._from = n), i.opType === "Constant")) {
                ...
                s.outputs.pop(),
                  ...
                  (this._allData[l].tensor = $e.fromProto(i.attribute[0].t));
              }
            }
          }
          for (let n = 0; n < this._nodes.length; n++) {
            ...
            for (let u of i.input) {
              ...
              if (typeof l > "u") {
                if (
                  u === "" &&
                  (i.input.length === 3 || i.input.length === 4) &&
                  i.opType === "Resize"
                )
                  continue;
                throw new Error(
                  `unrecognized input '${u}' for node: ${i.name}`
                );
              }
        ...
        buildGraphFromOrtFormat(t) {
          ...
          for (let n = 0; n < t.inputsLength(); n++) {
            ...
            for (let i = 0; i < t.nodeArgsLength(); i++)
              if (t.nodeArgs(i)?.name() === s) {
                let u = new Mt();
                if (
                  t.nodeArgs(i)?.type()?.valueType() !==
                  wo.TypeInfoValue.tensor_type
                )
                  throw new Error("Unexpected value type for the nodeArg.");
                let c = t.nodeArgs(i).type().value(new wo.TensorTypeAndShape()),
                  p = We.tensorDataTypeFromProto(c.elemType()),
                  d = c.shape(),
                  T = [];
          ...
          for (let n = 0; n < t.initializersLength(); n++) {
            let s = t.initializers(n),
              i = o.get(s.name());
            if (i === void 0) {
              let u = new Mt(),
                l = We.tensorDimsFromORTFormat(s),
                c = We.tensorDataTypeFromProto(s.dataType());
              (u.type = { shape: { dims: l }, tensorType: c }),
                (i = this._allData.push(u) - 1),
                o.set(s.name(), i);
            }
            (this._allData[i]._from = -1),
              (this._allData[i].tensor = $e.fromOrtTensor(s));
          }
          for (let n = 0; n < this._allData.length; n++)
            this._allData[n].tensor ||
              (this._allInputIndices.push(n), this._allInputNames.push(r[n]));
          ...
          for (let n = 0; n < t.nodesLength(); n++) {
            ...
            if (!i)
              for (
                let l = 0;
                (i = `unnamed_${s.opType()}_${l}`), !!e.has(i);
                l++
              );
          ...
          for (let n = 0; n < this._nodes.length; n++) {
            ...
            for (let u = 0; u < i?.outputsLength(); u++) {
              ...
              if (
                (typeof c > "u" &&
                  ((c = this._allData.push(new Mt()) - 1), o.set(l, c)),
                s.outputs.push(c),
                this._allData[c]._from !== void 0)
              )
                throw new Error(
                  `multiple nodes output to one data value: ${c}`
                );
              if (((this._allData[c]._from = n), i.opType() === "Constant")) {
                ...
                s.outputs.pop(),
                  (s.executeNode = !1),
                  (this._allData[c]._from = -1),
                  (this._allData[c].tensor = $e.fromOrtTensor(
                    i.attributes(0).t()
                  ));
              }
            }
          ...
          for (let n = 0; n < this._nodes.length; n++) {
            ...
            for (let u = 0; u < i.inputsLength(); u++) {
              ...
              if (typeof c > "u")
                throw new Error(
                  `unrecognized input '${l}' for node: ${i.name()}`
                );
        ...
        checkIsAcyclic() {
          ...
          let o = Array.from(t),
            e = new Array(this._nodes.length).fill("white");
          for (; o.length > 0; ) {
            let r = o.pop();
            e[r] === "gray"
              ? (e[r] = "black")
        ...
        finalizeGraph() {
          ...
          for (let r = 0; r < this._nodes.length; r++)
            (o[r] = e),
              this._nodes[r].executeNode
                ? (e !== r && (this._nodes[e] = this._nodes[r]), e++)
                : this._nodes[r].outputs.forEach((n) => {
          ...
          for (let r = 0; r < this._allData.length; r++) {
            if (
              ...
              this._allOutputIndices.indexOf(r + t) === -1
            ) {
                  ...
                  if (e.inputs.length === 1)
                    try {
                      t.attributes.set("activation_params", "floats", [
                        e.attributes.getFloat("min"),
                        e.attributes.getFloat("max"),
                      ]);
                    } catch {
                    ...
                    e.inputs.length >= 3 &&
                    this._allData[e.inputs[1]].tensor !== void 0 &&
                    this._allData[e.inputs[2]].tensor !== void 0
                  )
                    t.attributes.set("activation_params", "floats", [
                      this._allData[e.inputs[1]].tensor.floatData[0],
                      this._allData[e.inputs[2]].tensor.floatData[0],
                    ]);
                  else continue;
                t.attributes.set("activation", "string", e.opType),
                  this.deleteNode(o[0]);
              }
            }
        }
...
as ORT format: ${n}`);
        ...
        loadFromOnnxFormat(t, o) {
          ...
          (this._opsets = e.opsetImport.map((n) => ({
            domain: n.domain,
            version: it.longToNumber(n.version),
          }))),
            (this._graph = Ki.from(e.graph, o));
        }
        loadFromOrtFormat(t, o) {
          let e = new _.ByteBuffer(t),
            r = Qb.InferenceSession.getRootAsInferenceSession(e).model();
          ...
          for (let s = 0; s < r.opsetImportLength(); s++) {
            ...
            this._opsets.push({
              domain: i?.domain(),
              version: it.longToNumber(i.version()),
            });
          }
...
var Oo,
  wp = L(() => {
    ...
    Oo = class {
      constructor(t = {}) {
        (this._initialized = !1),
          (this.backendHint = t.backendHint),
          (this.profiler = Gn.create(t.profiler)),
          (this.context = {
      ...
      initialize(t, o) {
        ...
        this.profiler.event("session", "Session.initialize", () => {
          let e = this.sessionHandler.transformGraph
            ? this.sessionHandler
            : void 0;
          this._model.load(t, e, o),
            this.sessionHandler.onGraphInitialized &&
              this.sessionHandler.onGraphInitialized(this._model.graph),
            this.initializeOps(this._model.graph),
            (this._executionPlan = new xo(
              this._model.graph,
              this._ops,
              this.profiler
            ));
      ...
      async run(t) {
        ...
        return this.profiler.event("session", "Session.run", async () => {
          let o = this.normalizeAndValidateInputs(t),
            e = await this._executionPlan.execute(this.sessionHandler, o);
      ...
      normalizeAndValidateInputs(t) {
        ...
        if (Array.isArray(t)) {
          if (t.length !== o.length)
            throw new Error(
              `incorrect input array length: expected ${o.length} but got ${t.length}`
            );
        } else {
          if (t.size !== o.length)
            throw new Error(
              `incorrect input map size: expected ${o.length} but got ${t.size}`
            );
          let e = new Array(t.size),
            r = 0;
          for (let n = 0; n < o.length; ++n) {
            let s = t.get(o[n]);
        ...
        if (
          ...
          let e = this._model.graph.getInputIndices(),
            r = this._model.graph.getValues(),
            n = new Array(e.length);
          for (let s = 0; s < e.length; ++s) {
            let i = r[e[s]];
            (n[s] = i.type.shape.dims),
              this.context.graphInputTypes.push(i.type.tensorType),
              this.context.graphInputDims.push(t[s].dims);
          }
          this.validateInputTensorDims(n, t, !0);
        } else this.validateInputTensorDims(this.context.graphInputDims, t, !1);
        return (
          this.validateInputTensorTypes(this.context.graphInputTypes, t), t
        );
      }
      validateInputTensorTypes(t, o) {
        for (let e = 0; e < o.length; e++) {
          ...
          if (r !== n)
            throw new Error(
              `input tensor[${e}] check failed: expected type '${r}' but got ${n}`
            );
        }
      }
      ...
      initializeOps(t) {
        ...
        for (let e = 0; e < o.length; e++)
          this._ops[e] = this.sessionHandler.resolve(
            o[e],
            this._model.opsets,
            t
          );
      ...
      async run(t, o, e) {
        ...
        for (let i in t)
          if (Object.hasOwnProperty.call(t, i)) {
            let u = t[i];
            r.set(i, new $e(u.dims, u.type, void 0, void 0, u.data));
          }
  ...
  Op = L(() => {
    ...
    (Ji = class {
      ...
      async createInferenceSessionHandler(t, o) {
        let e = new Oo(o);
        return (
          typeof t == "string" ? await e.loadModel(t) : await e.loadModel(t),
          new Io(e)
        );
      }
    }),
...
var Pp = me((Ap, ra) => {
  ...
  var Sp = (() => {
    ...
    return (
      typeof __filename < "u" && (a ||= __filename),
      function (t = {}) {
        var o = t,
          e,
          r,
        ...
        if (c) {
          var v = (Qi(), ar(Zi)),
            S = (ta(), ar(ea));
          (p = l ? S.dirname(p) + "/" : __dirname + "/"),
            (d = (m, x) => (
              (m = Ke(m) ? new URL(m) : S.normalize(m)),
              v.readFileSync(m, x ? void 0 : "utf8")
            )),
            (w = (m) => (
              (m = d(m, !0)), m.buffer || (m = new Uint8Array(m)), m
            )),
            (T = (m, x, O, D = !0) => {
              (m = Ke(m) ? new URL(m) : S.normalize(m)),
                v.readFile(m, D ? void 0 : "utf8", (M, q) => {
          ...
          (u || l) &&
            ...
            (d = (m) => {
              ...
              return x.open("GET", m, !1), x.send(null), x.responseText;
            }),
            l &&
              (w = (m) => {
                var x = new XMLHttpRequest();
        ...
        function Le() {
          var m = F.buffer;
          (o.HEAP8 = j = new Int8Array(m)),
            (o.HEAP16 = new Int16Array(m)),
            (o.HEAPU8 = ie = new Uint8Array(m)),
            (o.HEAPU16 = new Uint16Array(m)),
            (o.HEAP32 = G = new Int32Array(m)),
            (o.HEAPU32 = Te = new Uint32Array(m)),
            (o.HEAPF32 = new Float32Array(m)),
            (o.HEAPF64 = He = new Float64Array(m));
        }
        var Y = [],
          Ne = [],
          Se = [],
        ...
        var Ht = (m) => m.startsWith("data:application/octet-stream;base64,"),
          Ke = (m) => m.startsWith("file://"),
          at;
          ...
          if (u || l) {
            if (typeof fetch == "function" && !Ke(m))
              return fetch(m, { credentials: "same-origin" })
                .then((x) => {
                  if (!x.ok) throw `failed to load wasm binary file at '${m}'`;
        ...
        function Tt(m, x, O) {
          return Hr(m)
            .then((D) => WebAssembly.instantiate(D, x))
            .then(O, (D) => {
        ...
        function qt(m, x) {
          ...
          return typeof WebAssembly.instantiateStreaming != "function" ||
            ...
            ? Tt(O, m, x)
            : fetch(O, { credentials: "same-origin" }).then((D) =>
                WebAssembly.instantiateStreaming(D, m).then(x, function (M) {
                  return (
        ...
        var xt,
          Lt = {
            798088: (m, x, O, D) => {
              ...
              if (
                ((m = je(m >>> 0)),
                m.startsWith("./") && (m = m.substring(2)),
                (m = o.ya.get(m)),
                !m)
              )
                return 2;
              if (((x >>>= 0), (O >>>= 0), x + O > m.byteLength)) return 3;
              try {
        ...
        var tt = 0,
          tr = 0,
          ke = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0,
          Be = (m, x, O) => {
            x >>>= 0;
            var D = x + O;
            for (O = x; m[O] && !(O >= D); ) ++O;
          ...
          rr = () => {
            if (!nr) {
              var m = {
                ...
                x;
              for (x in Or) Or[x] === void 0 ? delete m[x] : (m[x] = Or[x]);
              var O = [];
              for (x in m) O.push(`${x}=${m[x]}`);
              nr = O;
            }
            return nr;
          },
          nr,
          xn = [null, [], []],
          Gt = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
        ...
        function jr(m, x, O, D) {
          ...
          function re(P, pe) {
            ...
            var Ft;
            return (
              (Ft = xe(P.getFullYear() - pe.getFullYear())) === 0 &&
                (Ft = xe(P.getMonth() - pe.getMonth())) === 0 &&
                (Ft = xe(P.getDate() - pe.getDate())),
              Ft
            );
          }
          function Fe(P) {
          ...
          function st(P) {
            var pe = P.sa;
            for (
              P = new Date(new Date(P.ta + 1900, 0, 1).getTime());
              0 < pe;

            ) {
              var xe = P.getMonth(),
                Ft = (jt(P.getFullYear()) ? Gt : wn)[xe];
              if (pe > Ft - P.getDate())
                (pe -= Ft - P.getDate() + 1),
                  P.setDate(1),
                  11 > xe
                    ? P.setMonth(xe + 1)
                    : (P.setMonth(0), P.setFullYear(P.getFullYear() + 1));
              else {
            ...
            return (
              (xe = new Date(P.getFullYear() + 1, 0, 4)),
              (pe = Fe(new Date(P.getFullYear(), 0, 4))),
              (xe = Fe(xe)),
              0 >= re(pe, P)
                ? 0 >= re(xe, P)
                  ? P.getFullYear() + 1
          ...
          (ze = {
            "%a": (P) => Jr[P.na].substring(0, 3),
            "%A": (P) => Jr[P.na],
            "%b": (P) => Yt[P.va].substring(0, 3),
            "%B": (P) => Yt[P.va],
            "%C": (P) => q(((P.ta + 1900) / 100) | 0, 2),
            "%d": (P) => q(P.xa, 2),
            "%e": (P) => M(P.xa, 2, " "),
            "%g": (P) => st(P).toString().substring(2),
            "%G": st,
            "%H": (P) => q(P.ua, 2),
            "%I": (P) => (
              (P = P.ua), P == 0 ? (P = 12) : 12 < P && (P -= 12), q(P, 2)
            ),
            "%j": (P) => {
              for (
                var pe = 0, xe = 0;
                xe <= P.va - 1;
                pe += (jt(P.ta + 1900) ? Gt : wn)[xe++]
              );
              return q(P.xa + pe, 3);
            },
            "%m": (P) => q(P.va + 1, 2),
            ...
            "%n": () => `
`,
            "%p": (P) => (0 <= P.ua && 12 > P.ua ? "AM" : "PM"),
            "%S": (P) => q(P.Ba, 2),
            "%t": () => "	",
            "%u": (P) => P.na || 7,
            "%U": (P) => q(Math.floor((P.sa + 7 - P.na) / 7), 2),
            "%V": (P) => {
              var pe = Math.floor((P.sa + 7 - ((P.na + 6) % 7)) / 7);
              if ((2 >= (P.na + 371 - P.sa - 2) % 7 && pe++, pe))
                pe == 53 &&
                  ((xe = (P.na + 371 - P.sa) % 7),
                  xe == 4 || (xe == 3 && jt(P.ta)) || (pe = 1));
              else {
                pe = 52;
            ...
            "%w": (P) => P.na,
            "%W": (P) => q(Math.floor((P.sa + 7 - ((P.na + 6) % 7)) / 7), 2),
            "%y": (P) => (P.ta + 1900).toString().substring(2),
            "%Y": (P) => P.ta + 1900,
            "%z": (P) => {
              P = P.za;
              var pe = 0 <= P;
          ...
          return (
            (O = O.replace(/\0\0/g, "%")),
            (Ve = he(O)),
            Ve.length > x ? 0 : (j.set(Ve, m >>> 0), Ve.length - 1)
          );
        }
        var Yr = {
            a: function (m, x, O) {
            ...
            I: function (m, x, O) {
              return (
                (x >>>= 0),
                ie.copyWithin((m >>> 0) >>> 0, x >>> 0, (x + (O >>> 0)) >>> 0)
              );
            },
            n: function (m, x, O) {
              (m =
                (x + 2097152) >>> 0 < 4194305 - !!m
                  ? (m >>> 0) + 4294967296 * x
                  : NaN),
                (O >>>= 0),
                (m = new Date(1e3 * m)),
                (G[(O >>> 2) >>> 0] = m.getUTCSeconds()),
                (G[((O + 4) >>> 2) >>> 0] = m.getUTCMinutes()),
                (G[((O + 8) >>> 2) >>> 0] = m.getUTCHours()),
                (G[((O + 12) >>> 2) >>> 0] = m.getUTCDate()),
                (G[((O + 16) >>> 2) >>> 0] = m.getUTCMonth()),
                (G[((O + 20) >>> 2) >>> 0] = m.getUTCFullYear() - 1900),
                (G[((O + 24) >>> 2) >>> 0] = m.getUTCDay()),
                (G[((O + 28) >>> 2) >>> 0] =
                  ((m.getTime() -
                    Date.UTC(m.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) /
                    864e5) |
                  0);
            },
            o: function (m, x, O) {
              (m =
                ...
                (O >>>= 0),
                (m = new Date(1e3 * m)),
                (G[(O >>> 2) >>> 0] = m.getSeconds()),
                (G[((O + 4) >>> 2) >>> 0] = m.getMinutes()),
                (G[((O + 8) >>> 2) >>> 0] = m.getHours()),
                (G[((O + 12) >>> 2) >>> 0] = m.getDate()),
                (G[((O + 16) >>> 2) >>> 0] = m.getMonth()),
                (G[((O + 20) >>> 2) >>> 0] = m.getFullYear() - 1900),
                (G[((O + 24) >>> 2) >>> 0] = m.getDay()),
                (G[((O + 28) >>> 2) >>> 0] =
                  ((jt(m.getFullYear()) ? qr : Tn)[m.getMonth()] +
                    m.getDate() -
                    1) |
                  0),
                (G[((O + 36) >>> 2) >>> 0] = -(60 * m.getTimezoneOffset())),
                (x = new Date(m.getFullYear(), 6, 1).getTimezoneOffset());
              var D = new Date(m.getFullYear(), 0, 1).getTimezoneOffset();
              G[((O + 32) >>> 2) >>> 0] =
                (x != D && m.getTimezoneOffset() == Math.min(D, x)) | 0;
            },
            p: function (m) {
              m >>>= 0;
              var x = new Date(
                ...
                O = G[((m + 32) >>> 2) >>> 0],
                D = x.getTimezoneOffset(),
                M = new Date(x.getFullYear(), 6, 1).getTimezoneOffset(),
              ...
              return (
                0 > O
                  ...
                  : 0 < O != (re == D) &&
                    ((M = Math.max(q, M)),
                    x.setTime(x.getTime() + 6e4 * ((0 < O ? re : M) - D))),
                (G[((m + 24) >>> 2) >>> 0] = x.getDay()),
                (G[((m + 28) >>> 2) >>> 0] =
                  ((jt(x.getFullYear()) ? qr : Tn)[x.getMonth()] +
                    x.getDate() -
                    1) |
                  0),
                (G[(m >>> 2) >>> 0] = x.getSeconds()),
                (G[((m + 4) >>> 2) >>> 0] = x.getMinutes()),
                (G[((m + 8) >>> 2) >>> 0] = x.getHours()),
                (G[((m + 12) >>> 2) >>> 0] = x.getDate()),
                (G[((m + 16) >>> 2) >>> 0] = x.getMonth()),
                (G[((m + 20) >>> 2) >>> 0] = x.getYear()),
                (m = x.getTime()),
                (m = isNaN(m) ? -1 : m / 1e3),
                Xr(
                  ((xt = m),
                  1 <= +Math.abs(xt)
                    ? 0 < xt
                      ? +Math.floor(xt / 4294967296) >>> 0
                      : ~~+Math.ceil((xt - +(~~xt >>> 0)) / 4294967296) >>> 0
                    : 0)
                ),
                m >>> 0
              );
            ...
            t: function (m, x, O, D) {
              ...
              (Te[((m >>> 0) >>> 2) >>> 0] = 60 * Math.max(M, Fe)),
                ...
                (re = m(re)),
                Fe < M
                  ? (_t(q, ie, O, 17), _t(re, ie, D, 17))
                  : (_t(q, ie, D, 17), _t(re, ie, O, 17));
            },
            d: () => {
              qe("");
            },
          ...
          te = (function () {
            ...
            if ((yt++, o.instantiateWasm))
              try {
                ...
                C(`Module.instantiateWasm callback failed with error: ${O}`),
                  r(O);
              }
            return (
              qt(x, function (O) {
        ...
        (o._OrtInit = (m, x) => (o._OrtInit = te.M)(m, x)),
          (o._OrtGetLastError = (m, x) => (o._OrtGetLastError = te.N)(m, x)),
          (o._OrtCreateSessionOptions = (m, x, O, D, M, q, re, Fe, st, ze) =>
            (o._OrtCreateSessionOptions = te.O)(
              m,
              x,
              O,
              D,
          ...
          (o._OrtAppendExecutionProvider = (m, x) =>
            (o._OrtAppendExecutionProvider = te.P)(m, x)),
          (o._OrtAddFreeDimensionOverride = (m, x, O) =>
            (o._OrtAddFreeDimensionOverride = te.Q)(m, x, O)),
          (o._OrtAddSessionConfigEntry = (m, x, O) =>
            (o._OrtAddSessionConfigEntry = te.R)(m, x, O)),
          (o._OrtReleaseSessionOptions = (m) =>
            (o._OrtReleaseSessionOptions = te.S)(m)),
          (o._OrtCreateSession = (m, x, O) =>
            (o._OrtCreateSession = te.T)(m, x, O)),
          (o._OrtReleaseSession = (m) => (o._OrtReleaseSession = te.U)(m)),
          (o._OrtGetInputOutputCount = (m, x, O) =>
            (o._OrtGetInputOutputCount = te.V)(m, x, O)),
          (o._OrtGetInputName = (m, x) => (o._OrtGetInputName = te.W)(m, x)),
          (o._OrtGetOutputName = (m, x) => (o._OrtGetOutputName = te.X)(m, x)),
          (o._OrtFree = (m) => (o._OrtFree = te.Y)(m)),
          (o._OrtCreateTensor = (m, x, O, D, M, q) =>
            (o._OrtCreateTensor = te.Z)(m, x, O, D, M, q)),
          (o._OrtGetTensorData = (m, x, O, D, M) =>
            (o._OrtGetTensorData = te._)(m, x, O, D, M)),
          (o._OrtReleaseTensor = (m) => (o._OrtReleaseTensor = te.$)(m)),
          (o._OrtCreateRunOptions = (m, x, O, D) =>
            (o._OrtCreateRunOptions = te.aa)(m, x, O, D)),
          (o._OrtAddRunConfigEntry = (m, x, O) =>
            (o._OrtAddRunConfigEntry = te.ba)(m, x, O)),
          (o._OrtReleaseRunOptions = (m) =>
            (o._OrtReleaseRunOptions = te.ca)(m)),
          (o._OrtCreateBinding = (m) => (o._OrtCreateBinding = te.da)(m)),
          (o._OrtBindInput = (m, x, O) => (o._OrtBindInput = te.ea)(m, x, O)),
          (o._OrtBindOutput = (m, x, O, D) =>
            (o._OrtBindOutput = te.fa)(m, x, O, D)),
          (o._OrtClearBoundOutputs = (m) =>
            (o._OrtClearBoundOutputs = te.ga)(m)),
          (o._OrtReleaseBinding = (m) => (o._OrtReleaseBinding = te.ha)(m)),
          (o._OrtRunWithBinding = (m, x, O, D, M) =>
            (o._OrtRunWithBinding = te.ia)(m, x, O, D, M)),
          (o._OrtRun = (m, x, O, D, M, q, re, Fe) =>
            (o._OrtRun = te.ja)(m, x, O, D, M, q, re, Fe)),
          (o._OrtEndProfiling = (m) => (o._OrtEndProfiling = te.ka)(m)),
          (o._malloc = (m) => (o._malloc = te.la)(m)),
          (o._free = (m) => (o._free = te.ma)(m));
        var Xr = (m) => (Xr = te.oa)(m),
          vn = (m) => (vn = te.pa)(m),
          X = (m) => (X = te.qa)(m),
          or = () => (or = te.ra)();
        ...
        (o.stackSave = () => or()),
          (o.stackRestore = (m) => vn(m)),
          (o.stackAlloc = (m) => X(m)),
          (o.UTF8ToString = je),
          (o.stringToUTF8 = (m, x, O) => _t(m, ie, x, O)),
          (o.lengthBytesUTF8 = vt);
        var Ut;
        ee = function m() {
          Ut || Kr(), Ut || (ee = m);
        };
        function Kr() {
          if (!(0 < yt)) {
            ...
            if (!(0 < yt || Ut || ((Ut = !0), (o.calledRun = !0), J))) {
  ...
  typeof Ap == "object" && typeof ra == "object"
    ? (ra.exports = Sp)
    : typeof define == "function" && define.amd && define([], () => Sp);
});
var Ep = me(() => {});
var Dp = me(() => {});
var Lp = {};
    ...
    return (
      ...
      function (t = {}) {
        ...
        if (S) {
          var G = (Qi(), ar(Zi)),
            Te = (ta(), ar(ea));
          (C = v ? Te.dirname(C) + "/" : __dirname + "/"),
            (J = (f, b) => (
              (f = je(f) ? new URL(f) : Te.normalize(f)),
              G.readFileSync(f, b ? void 0 : "utf8")
            )),
            (ie = (f) => (
              (f = J(f, !0)), f.buffer || (f = new Uint8Array(f)), f
            )),
            (j = (f, b, y, I = !0) => {
              (f = je(f) ? new URL(f) : Te.normalize(f)),
                G.readFile(f, I ? void 0 : "utf8", (k, $) => {
                  k ? y(k) : b(I ? $.buffer : $);
                });
            }),
            !i.thisProgram &&
          ...
          (w || v) &&
            ...
            S ||
              ((J = (f) => {
                ...
                return b.open("GET", f, !1), b.send(null), b.responseText;
              }),
              v &&
                (ie = (f) => {
                  var b = new XMLHttpRequest();
        ...
        S &&
          ...
          (global.performance = Dp().performance);
        var He = console.log.bind(console),
          Le = console.error.bind(console);
        S &&
          ((He = (...f) =>
            G.writeSync(
              1,
...
`
        ...
        function Ce() {
          var f = Se.buffer;
          (i.HEAP8 = qe = new Int8Array(f)),
            (i.HEAP16 = new Int16Array(f)),
            (i.HEAPU8 = Ht = new Uint8Array(f)),
            (i.HEAPU16 = new Uint16Array(f)),
            (i.HEAP32 = Ke = new Int32Array(f)),
            (i.HEAPU32 = at = new Uint32Array(f)),
            (i.HEAPF32 = new Float32Array(f)),
            (i.HEAPF64 = Re = new Float64Array(f));
        }
        var Hr = 16777216;
        if (A) Se = i.wasmMemory;
        else if (i.wasmMemory) Se = i.wasmMemory;
        else if (
          ((Se = new WebAssembly.Memory({
            initial: Hr / 65536,
            maximum: 65536,
            shared: !0,
          })),
          !(Se.buffer instanceof SharedArrayBuffer))
        )
          throw (
            (Ne(
        ...
        function tr() {
          if (
            (Lt--,
            Lt == 0 && (wt !== null && (clearInterval(wt), (wt = null)), tt))
          ) {
            var f = tt;
            (tt = null), f();
          }
        ...
        var Be = (f) => f.startsWith("data:application/octet-stream;base64,"),
          je = (f) => f.startsWith("file://"),
          vt;
          ...
          if (w || v) {
            if (typeof fetch == "function" && !je(f))
              return fetch(f, { credentials: "same-origin" })
                .then((b) => {
                  if (!b.ok) throw `failed to load wasm binary file at '${f}'`;
        ...
        function qr(f, b, y) {
          return jt(f)
            .then((I) => WebAssembly.instantiate(I, b))
            .then(y, (I) => {
        ...
        function Tn(f, b) {
          ...
          return typeof WebAssembly.instantiateStreaming != "function" ||
            ...
            typeof fetch != "function"
            ? qr(y, f, b)
            : fetch(y, { credentials: "same-origin" }).then((I) =>
                WebAssembly.instantiateStreaming(I, f).then(b, function (k) {
                  return (
                    Ne(`wasm streaming compile failed: ${k}`),
        ...
        function rr(f) {
          (this.name = "ExitStatus"),
            (this.message = `Program terminated with exit(${f})`),
            (this.status = f);
        }
        var nr = (f) => {
          ...
          he = (f, b, ...y) =>
            wn(() => {
              for (
                var I = y.length, k = Uo(8 * I), $ = k >>> 3, z = 0;
                z < y.length;
                z++
              ) {
                var Oe = y[z];
        ...
        function jr(f) {
          if (A) return he(0, 1, f);
          (ee = f),
            0 < Gt || (X.hb(), i.onExit?.(f), (et = !0)),
            T(f, new rr(f));
        }
        var Yr = (f) => {
          if (((ee = f), A)) throw (_n(f), "unwind");
          jr(f);
        };
        function te() {
          for (var f = i.numThreads; f--; ) Xr();
          Tt.unshift(() => {
            Lt++, vn(() => tr());
          });
        }
        ...
        var X = {
          ...
          Va() {
            A
              ? ((X.receiveObjectTransfer = X.fb),
                (X.threadInitTLS = X.$a),
                (X.setExitStatus = X.Za))
              : te();
          },
          Za: (f) => (ee = f),
          pb: ["$terminateWorker"],
          hb: () => {
            for (var f of X.Pa) nr(f);
            for (f of X.Oa) nr(f);
            (X.Oa = []), (X.Pa = []), (X.La = []);
          },
          Ya: (f) => {
            ...
            new Promise((b) => {
              (f.onmessage = ($) => {
                ...
                if ($.targetThread && $.targetThread != In()) {
                  ...
                  Oe
                    ? Oe.postMessage($, $.transferList)
                    : Ne(
                        `Internal error! Worker sent a message "${z}" to target pthread ${$.targetThread}, but that thread no longer exists!`
                      );
                } else
                  z === "checkMailbox"
                    ? On()
                    ...
                    ? (($ = $.thread),
                      ...
                      nr(z),
                      Mo($),
                      X.Pa.splice(X.Pa.indexOf(z), 1),
                      (z.Na = 0))
                    : z === "cancelThread"
                    ? X.La[$.thread].postMessage({ cmd: "cancel" })
                    : z === "loaded"
                    ? ((f.loaded = !0), S && !f.Na && f.unref(), b(f))
                    : z === "alert"
                    ? alert(`Thread ${$.threadId}: ${$.text}`)
                    : $.target === "setimmediate"
                    ? f.postMessage($)
                    : z === "callHandler"
                    ? i[$.handler](...$.args)
                    : z && Ne(`worker sent an unknown command ${z}`);
              }),
                (f.onerror = ($) => {
                  throw (
                    (Ne(
                      `worker sent an error! ${$.filename}:${$.lineno}: ${$.message}`
                    ),
                    $)
                  );
                }),
                S &&
                  (f.on("message", ($) => f.onmessage({ data: $ })),
                  f.on("error", ($) => f.onerror($)));
              var y = [],
                I = ["onExit"],
                k;
              for (k of I) i.hasOwnProperty(k) && y.push(k);
              f.postMessage({
                cmd: "load",
                handlers: y,
                urlOrBlob: i.mainScriptUrlOrBlob || a,
                wasmMemory: Se,
                wasmModule: yt,
              });
            }),
        ...
        i.invokeEntryPoint = (f, b) => {
          Gt = 0;
          var y = Ut[f];
          y || (f >= Ut.length && (Ut.length = f + 1), (Ut[f] = y = Kr.get(f))),
            (f = y(b)),
            0 < Gt ? X.Za(f) : Go(f);
        };
        class m {
        ...
        function M(f, b, y, I) {
          ...
          return A && k.length === 0
            ? D(f, b, y, I)
            : ((f = { gb: y, Na: f, cb: I, mb: k }),
              A ? ((f.ob = "spawnThread"), postMessage(f, k), 0) : xn(f));
        }
        var q = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0,
          re = (f, b, y) => {
            b >>>= 0;
            var I = b + y;
            for (y = b; f[y] && !(y >= I); ) ++y;
        ...
        var Ve = (f) => {
          ...
          Yt = (f, b, y) => Jr(f, e(), b, y);
        function P(f, b) {
          if (A) return he(5, 1, f, b);
        }
        function pe(f, b, y) {
          if (A) return he(6, 1, f, b, y);
        }
        function xe(f, b, y) {
          return A ? he(7, 1, f, b, y) : 0;
        }
        function Ft(f, b) {
          if (A) return he(8, 1, f, b);
        }
        function Zr(f, b, y) {
          if (A) return he(9, 1, f, b, y);
        }
        function ha(f, b, y, I) {
          if (A) return he(10, 1, f, b, y, I);
        }
        function ma(f, b, y, I) {
          if (A) return he(11, 1, f, b, y, I);
        }
        function ba(f, b, y, I) {
          if (A) return he(12, 1, f, b, y, I);
        }
        function ga(f) {
          if (A) return he(13, 1, f);
        }
        function ya(f, b) {
          if (A) return he(14, 1, f, b);
        }
        function Ta(f, b, y) {
          if (A) return he(15, 1, f, b, y);
        }
        function $o(f) {
          (f >>>= 0),
            typeof Atomics.nb == "function" &&
              (Atomics.nb(r(), f >>> 2, f).value.then(On),
              (f += 128),
              Atomics.store(r(), f >>> 2, 1));
        }
        ...
        i.checkMailbox = On;
        var ko = [],
          Ir = (f) => f % 4 === 0 && (f % 100 !== 0 || f % 400 === 0),
          xa = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
          wa = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334];
        function va(f, b, y, I, k, $, z, Oe) {
          return A ? he(16, 1, f, b, y, I, k, $, z, Oe) : -52;
        }
        function _a(f, b, y, I, k, $, z) {
          if (A) return he(17, 1, f, b, y, I, k, $, z);
        }
        var Bo = [],
          No = {},
          Oa = () => {
            if (!Ro) {
              var f = {
                ...
                b;
              for (b in No) No[b] === void 0 ? delete f[b] : (f[b] = No[b]);
              var y = [];
              for (b in f) y.push(`${b}=${f[b]}`);
              Ro = y;
            }
            return Ro;
          },
        ...
        function Sa(f, b) {
          if (A) return he(19, 1, f, b);
          (f >>>= 0), (b >>>= 0);
          var y = Oa();
          n()[(f >>> 2) >>> 0] = y.length;
          var I = 0;
          return (
            y.forEach((k) => (I += k.length + 1)), (n()[(b >>> 2) >>> 0] = I), 0
          );
        }
        function Aa(f) {
        ...
        function Fa(f, b, y, I) {
          ...
          function z(E, de) {
            ...
            var ir;
            return (
              (ir = Ie(E.getFullYear() - de.getFullYear())) === 0 &&
                (ir = Ie(E.getMonth() - de.getMonth())) === 0 &&
                (ir = Ie(E.getDate() - de.getDate())),
              ir
            );
          }
          function Oe(E) {
          ...
          function $t(E) {
            var de = E.Qa;
            for (
              E = new Date(new Date(E.Ra + 1900, 0, 1).getTime());
              0 < de;

            ) {
              var Ie = E.getMonth(),
                ir = (Ir(E.getFullYear()) ? La : Ca)[Ie];
              if (de > ir - E.getDate())
                (de -= ir - E.getDate() + 1),
                  E.setDate(1),
                  11 > Ie
            ...
            return (
              (Ie = new Date(E.getFullYear() + 1, 0, 4)),
              (de = Oe(new Date(E.getFullYear(), 0, 4))),
              (Ie = Oe(Ie)),
              0 >= z(de, E)
                ? 0 >= z(Ie, E)
                  ? E.getFullYear() + 1
          ...
          (Ye = {
            "%a": (E) => Ga[E.Ma].substring(0, 3),
            "%A": (E) => Ga[E.Ma],
            "%b": (E) => Ua[E.Ta].substring(0, 3),
            "%B": (E) => Ua[E.Ta],
            "%C": (E) => $(((E.Ra + 1900) / 100) | 0, 2),
            "%d": (E) => $(E.Wa, 2),
            "%e": (E) => k(E.Wa, 2, " "),
            "%g": (E) => $t(E).toString().substring(2),
            "%G": $t,
            "%H": (E) => $(E.Sa, 2),
            "%I": (E) => (
              (E = E.Sa), E == 0 ? (E = 12) : 12 < E && (E -= 12), $(E, 2)
            ),
            "%j": (E) => {
              for (
                var de = 0, Ie = 0;
                Ie <= E.Ta - 1;
                de += (Ir(E.Ra + 1900) ? La : Ca)[Ie++]
              );
              return $(E.Wa + de, 3);
            },
            "%m": (E) => $(E.Ta + 1, 2),
...
`,
            ...
            "%w": (E) => E.Ma,
            "%W": (E) => $(Math.floor((E.Qa + 7 - ((E.Ma + 6) % 7)) / 7), 2),
          ...
          return (
            (y = y.replace(/\0\0/g, "%")),
            (rt = gd(y)),
            rt.length > b ? 0 : (yd(rt, f), rt.length - 1)
          );
        }
        X.Va();
        var Td = [
          ...
          xd = {
            b: function (f, b, y) {
              throw (
                ((f >>>= 0), new m(f).Va(b >>> 0, y >>> 0), (x = f), O++, x)
              );
            },
            L: function (f) {
              $a(f >>> 0, !v, 1, !w, 131072, !1), X.$a();
            },
            j: function (f) {
              (f >>>= 0),
                A
                  ? postMessage({ cmd: "cleanupThread", thread: f })
                  : X.Ya(X.La[f]);
            },
            H: M,
            h: st,
            ...
            z: function (f, b) {
              (f >>>= 0),
                f == b >>> 0
                  ? setTimeout(On)
                  : A
                  ? postMessage({ targetThread: f, cmd: "checkMailbox" })
                  : (f = X.La[f]) && f.postMessage({ cmd: "checkMailbox" });
            },
            I: function (f, b, y, I, k) {
              (b >>>= 0), (y >>>= 0), (ko.length = I), (k = (k >>> 0) >>> 3);
              for (var $ = 0; $ < I; $++) ko[$] = s()[(k + $) >>> 0];
              return (
                (f = b ? Or[b] : Td[f]),
                (X.eb = y),
                (y = f(...ko)),
            ...
            s: function (f, b, y) {
              (f =
                (b + 2097152) >>> 0 < 4194305 - !!f
                  ? (f >>> 0) + 4294967296 * b
                  : NaN),
                (y >>>= 0),
                (f = new Date(1e3 * f)),
                (r()[(y >>> 2) >>> 0] = f.getUTCSeconds()),
                (r()[((y + 4) >>> 2) >>> 0] = f.getUTCMinutes()),
                (r()[((y + 8) >>> 2) >>> 0] = f.getUTCHours()),
                (r()[((y + 12) >>> 2) >>> 0] = f.getUTCDate()),
                (r()[((y + 16) >>> 2) >>> 0] = f.getUTCMonth()),
                (r()[((y + 20) >>> 2) >>> 0] = f.getUTCFullYear() - 1900),
                (r()[((y + 24) >>> 2) >>> 0] = f.getUTCDay()),
                (f =
                  ((f.getTime() -
                    Date.UTC(f.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) /
                    864e5) |
                  0),
                (r()[((y + 28) >>> 2) >>> 0] = f);
            },
            t: function (f, b, y) {
              (f =
                ...
                (y >>>= 0),
                (f = new Date(1e3 * f)),
                (r()[(y >>> 2) >>> 0] = f.getSeconds()),
                (r()[((y + 4) >>> 2) >>> 0] = f.getMinutes()),
                (r()[((y + 8) >>> 2) >>> 0] = f.getHours()),
                (r()[((y + 12) >>> 2) >>> 0] = f.getDate()),
                (r()[((y + 16) >>> 2) >>> 0] = f.getMonth()),
                (r()[((y + 20) >>> 2) >>> 0] = f.getFullYear() - 1900),
                (r()[((y + 24) >>> 2) >>> 0] = f.getDay()),
                (b =
                  ((Ir(f.getFullYear()) ? xa : wa)[f.getMonth()] +
                    f.getDate() -
                    1) |
                  0),
                (r()[((y + 28) >>> 2) >>> 0] = b),
                (r()[((y + 36) >>> 2) >>> 0] = -(60 * f.getTimezoneOffset())),
                (b = new Date(f.getFullYear(), 6, 1).getTimezoneOffset());
              var I = new Date(f.getFullYear(), 0, 1).getTimezoneOffset();
              (f = (b != I && f.getTimezoneOffset() == Math.min(I, b)) | 0),
                (r()[((y + 32) >>> 2) >>> 0] = f);
            },
            u: function (f) {
              f >>>= 0;
              var b = new Date(
                ...
                y = r()[((f + 32) >>> 2) >>> 0],
                I = b.getTimezoneOffset(),
                k = new Date(b.getFullYear(), 6, 1).getTimezoneOffset(),
              ...
              return (
                0 > y
                  ...
                  : 0 < y != (z == I) &&
                    ((k = Math.max($, k)),
                    b.setTime(b.getTime() + 6e4 * ((0 < y ? z : k) - I))),
                (r()[((f + 24) >>> 2) >>> 0] = b.getDay()),
                (y =
                  ((Ir(b.getFullYear()) ? xa : wa)[b.getMonth()] +
                    b.getDate() -
                    1) |
                  0),
                (r()[((f + 28) >>> 2) >>> 0] = y),
                (r()[(f >>> 2) >>> 0] = b.getSeconds()),
                (r()[((f + 4) >>> 2) >>> 0] = b.getMinutes()),
                (r()[((f + 8) >>> 2) >>> 0] = b.getHours()),
                (r()[((f + 12) >>> 2) >>> 0] = b.getDate()),
                (r()[((f + 16) >>> 2) >>> 0] = b.getMonth()),
                (r()[((f + 20) >>> 2) >>> 0] = b.getYear()),
                (f = b.getTime()),
                (f = isNaN(f) ? -1 : f / 1e3),
                Na(
                  ((Ct = f),
                  1 <= +Math.abs(Ct)
                    ? 0 < Ct
                      ? +Math.floor(Ct / 4294967296) >>> 0
                      : ~~+Math.ceil((Ct - +(~~Ct >>> 0)) / 4294967296) >>> 0
                    : 0)
                ),
                f >>> 0
              );
            ...
            y: function (f, b, y, I) {
              ...
              var k = new Date().getFullYear(),
                ...
                z = new Date(k, 6, 1);
              k = $.getTimezoneOffset();
              var Oe = z.getTimezoneOffset(),
                $t = Math.max(k, Oe);
              (n()[(f >>> 2) >>> 0] = 60 * $t),
                (r()[(b >>> 2) >>> 0] = +(k != Oe)),
                (f = (Ye) =>
                  Ye.toLocaleTimeString(void 0, {
                    hour12: !1,
                    timeZoneName: "short",
                  }).split(" ")[1]),
                ($ = f($)),
            ...
            f: () =>
              S ? (Cp(), ar(Lp)).cpus().length : navigator.hardwareConcurrency,
            x: function (f) {
              f >>>= 0;
              var b = e().length;
              if (f <= b || 4294901760 < f) return !1;
              for (var y = 1; 4 >= y; y *= 2) {
                var I = b * (1 + 0.2 / y);
          ...
          K = (function () {
            ...
            if ((Lt++, i.instantiateWasm))
              try {
                ...
                Ne(`Module.instantiateWasm callback failed with error: ${y}`),
                  l(y);
              }
            return (
              Tn(b, function (y) {
        ...
        (i._OrtInit = (f, b) => (i._OrtInit = K.W)(f, b)),
          (i._OrtGetLastError = (f, b) => (i._OrtGetLastError = K.X)(f, b)),
          (i._OrtCreateSessionOptions = (f, b, y, I, k, $, z, Oe, $t, Ye) =>
            (i._OrtCreateSessionOptions = K.Y)(
              f,
              b,
              y,
              I,
          ...
          (i._OrtAppendExecutionProvider = (f, b) =>
            (i._OrtAppendExecutionProvider = K.Z)(f, b)),
          (i._OrtAddFreeDimensionOverride = (f, b, y) =>
            (i._OrtAddFreeDimensionOverride = K._)(f, b, y)),
          (i._OrtAddSessionConfigEntry = (f, b, y) =>
            (i._OrtAddSessionConfigEntry = K.$)(f, b, y)),
          (i._OrtReleaseSessionOptions = (f) =>
            (i._OrtReleaseSessionOptions = K.aa)(f)),
          (i._OrtCreateSession = (f, b, y) =>
            (i._OrtCreateSession = K.ba)(f, b, y)),
          (i._OrtReleaseSession = (f) => (i._OrtReleaseSession = K.ca)(f)),
          (i._OrtGetInputOutputCount = (f, b, y) =>
            (i._OrtGetInputOutputCount = K.da)(f, b, y)),
          (i._OrtGetInputName = (f, b) => (i._OrtGetInputName = K.ea)(f, b)),
          (i._OrtGetOutputName = (f, b) => (i._OrtGetOutputName = K.fa)(f, b)),
          (i._OrtFree = (f) => (i._OrtFree = K.ga)(f)),
          (i._OrtCreateTensor = (f, b, y, I, k, $) =>
            (i._OrtCreateTensor = K.ha)(f, b, y, I, k, $)),
          (i._OrtGetTensorData = (f, b, y, I, k) =>
            (i._OrtGetTensorData = K.ia)(f, b, y, I, k)),
          (i._OrtReleaseTensor = (f) => (i._OrtReleaseTensor = K.ja)(f)),
          (i._OrtCreateRunOptions = (f, b, y, I) =>
            (i._OrtCreateRunOptions = K.ka)(f, b, y, I)),
          (i._OrtAddRunConfigEntry = (f, b, y) =>
            (i._OrtAddRunConfigEntry = K.la)(f, b, y)),
          (i._OrtReleaseRunOptions = (f) =>
            (i._OrtReleaseRunOptions = K.ma)(f)),
          (i._OrtCreateBinding = (f) => (i._OrtCreateBinding = K.na)(f)),
          (i._OrtBindInput = (f, b, y) => (i._OrtBindInput = K.oa)(f, b, y)),
          (i._OrtBindOutput = (f, b, y, I) =>
            (i._OrtBindOutput = K.pa)(f, b, y, I)),
          (i._OrtClearBoundOutputs = (f) =>
            (i._OrtClearBoundOutputs = K.qa)(f)),
          (i._OrtReleaseBinding = (f) => (i._OrtReleaseBinding = K.ra)(f)),
          (i._OrtRunWithBinding = (f, b, y, I, k) =>
            (i._OrtRunWithBinding = K.sa)(f, b, y, I, k)),
          (i._OrtRun = (f, b, y, I, k, $, z, Oe) =>
            (i._OrtRun = K.ta)(f, b, y, I, k, $, z, Oe)),
          (i._OrtEndProfiling = (f) => (i._OrtEndProfiling = K.ua)(f));
        var In = (i._pthread_self = () => (In = i._pthread_self = K.va)());
        (i._malloc = (f) => (i._malloc = K.wa)(f)),
          (i._free = (f) => (i._free = K.xa)(f)),
          (i.__emscripten_tls_init = () => (i.__emscripten_tls_init = K.ya)());
        var $a = (i.__emscripten_thread_init = (f, b, y, I, k, $) =>
          ($a = i.__emscripten_thread_init = K.Aa)(f, b, y, I, k, $));
        i.__emscripten_thread_crashed = () =>
          (i.__emscripten_thread_crashed = K.Ba)();
        var ka = (f, b, y, I, k) => (ka = K.Ca)(f, b, y, I, k),
          Mo = (f) => (Mo = K.Da)(f),
          Go = (i.__emscripten_thread_exit = (f) =>
            (Go = i.__emscripten_thread_exit = K.Ea)(f)),
          Ba = () => (Ba = K.Fa)(),
          Na = (f) => (Na = K.Ga)(f),
          Ra = (f, b) => (Ra = K.Ha)(f, b),
          Sn = (f) => (Sn = K.Ia)(f),
        ...
        function wd() {
          ...
          return (
            (f.va = b(f.va)),
            (f.wa = y(f.wa)),
            (f.emscripten_main_runtime_thread_id = b(
              f.emscripten_main_runtime_thread_id
            )),
            (f.Ja = y(f.Ja)),
            (f.Ka = b(f.Ka)),
            f
        ...
        (i.wasmMemory = Se),
          (i.stackSave = () => zo()),
          (i.stackRestore = (f) => Sn(f)),
          (i.stackAlloc = (f) => Uo(f)),
          (i.keepRuntimeAlive = () => 0 < Gt),
          (i.UTF8ToString = Fe),
          (i.stringToUTF8 = Yt),
          (i.lengthBytesUTF8 = Ve),
          (i.ExitStatus = rr),
          (i.PThread = X);
        var An;
        tt = function f() {
        ...
        function Ma() {
          if (!(0 < Lt))
            if (A) u(i), A || or(qt), startWorker(i);
            else {
              if (i.preRun)
                for (
  ...
  typeof $p == "object" && typeof na == "object"
    ? (na.exports = Fp)
    : typeof define == "function" && define.amd && define([], () => Fp);
});
var Bp = me((aO, ag) => {
  ag.exports =
    ...
    (sg = kp()),
      ...
      (Mp = async (a) => {
        ...
        let t = a.initTimeout,
          ...
          n = e && lg(),
          s = a.wasmPaths,
          i = typeof s == "string" ? s : void 0,
          u = fg(n, r),
          l = typeof s == "object" ? s[u] : void 0,
          c = !1,
          p = [];
        if (
          (t > 0 &&
          ...
          p.push(
            new Promise((d, T) => {
              let w = r ? sg : Rp,
                v = {
                  locateFile: (S, A) =>
                    r && S.endsWith(".worker.js") && typeof Blob < "u"
                      ? URL.createObjectURL(
                          new Blob([Bp()], { type: "text/javascript" })
                        )
                      : S.endsWith(".wasm")
                      ? l || (i ?? A) + u
                      : A + S,
              ...
              if (r)
                if (((v.numThreads = o), typeof Blob > "u"))
                  v.mainScriptUrlOrBlob = (void 0)(
                    __dirname,
                    "ort-wasm-threaded.js"
                  );
                else {
                  let S = `var ortWasmThreaded=${w.toString()};`;
                  v.mainScriptUrlOrBlob = new Blob([S], {
    ...
    Gp = (a) => {
      ...
      try {
        if (a?.logSeverityLevel === void 0) r.logSeverityLevel = 2;
          ...
          typeof a.logSeverityLevel != "number" ||
          !Number.isInteger(a.logSeverityLevel) ||
          a.logSeverityLevel < 0 ||
          a.logSeverityLevel > 4
        )
          throw new Error(
            `log serverity level is not valid: ${a.logSeverityLevel}`
          );
        if (a?.logVerbosityLevel === void 0) r.logVerbosityLevel = 0;
        else if (
          typeof a.logVerbosityLevel != "number" ||
          !Number.isInteger(a.logVerbosityLevel)
        )
          throw new Error(
            `log verbosity level is not valid: ${a.logVerbosityLevel}`
          );
        a?.terminate === void 0 && (r.terminate = !1);
        let n = 0;
        return (
          a?.tag !== void 0 && (n = ve(a.tag, e)),
          (o = t._OrtCreateRunOptions(
            r.logSeverityLevel,
            r.logVerbosityLevel,
            !!r.terminate,
            n
          )),
          o === 0 && _e("Can't create run options."),
          a?.extra !== void 0 &&
            bn(a.extra, "", new WeakSet(), (s, i) => {
              let u = ve(s, e),
                l = ve(i, e);
              t._OrtAddRunConfigEntry(o, u, l) !== 0 &&
                _e(`Can't set a run config entry: ${s} - ${i}.`);
            }),
          [o, e]
        );
      } catch (n) {
        throw (
          (o !== 0 && t._OrtReleaseRunOptions(o),
          e.forEach((s) => t._free(s)),
          n)
        );
      }
    };
    ...
    (cg = (a) => {
      ...
      (dg = (a) => {
        ...
        t.use_ort_model_bytes_directly ||
          ...
          a.executionProviders &&
            a.executionProviders.some(
              (o) => (typeof o == "string" ? o : o.name) === "webgpu"
            ) &&
            (a.enableMemPattern = !1);
      }),
      (hg = (a, t, o) => {
        for (let e of t) {
          ...
          switch (r) {
            case "webnn":
              if (((r = "WEBNN"), typeof e != "string")) {
                let s = e;
                if (s?.deviceType) {
                  let i = ve("deviceType", o),
                    u = ve(s.deviceType, o);
                  De()._OrtAddSessionConfigEntry(a, i, u) !== 0 &&
                    _e(
                      `Can't set a session config entry: 'deviceType' - ${s.deviceType}.`
                    );
                }
                if (s?.numThreads) {
                  let i = s.numThreads;
                  (typeof i != "number" || !Number.isInteger(i) || i < 0) &&
                    (i = 0);
                  let u = ve("numThreads", o),
                    l = ve(i.toString(), o);
                  De()._OrtAddSessionConfigEntry(a, u, l) !== 0 &&
                    _e(
                      `Can't set a session config entry: 'numThreads' - ${s.numThreads}.`
                    );
                }
                if (s?.powerPreference) {
                  let i = ve("powerPreference", o),
                    u = ve(s.powerPreference, o);
                  De()._OrtAddSessionConfigEntry(a, i, u) !== 0 &&
                    _e(
                      `Can't set a session config entry: 'powerPreference' - ${s.powerPreference}.`
                    );
                }
              }
              break;
            case "webgpu":
              if (((r = "JS"), typeof e != "string")) {
                ...
                if (s?.preferredLayout) {
                  ...
                  let i = ve("preferredLayout", o),
                    u = ve(s.preferredLayout, o);
                  De()._OrtAddSessionConfigEntry(a, i, u) !== 0 &&
                    _e(
          ...
          let n = ve(r, o);
          De()._OrtAppendExecutionProvider(a, n) !== 0 &&
            _e(`Can't append execution provider: ${r}.`);
        }
      }),
      (zp = (a) => {
        let t = De(),
        ...
        dg(r);
        try {
          let n = cg(r.graphOptimizationLevel ?? "all"),
            s = pg(r.executionMode ?? "sequential"),
            i = typeof r.logId == "string" ? ve(r.logId, e) : 0,
          ...
          let c =
            typeof r.optimizedModelFilePath == "string"
              ? ve(r.optimizedModelFilePath, e)
              : 0;
          if (
            ((o = t._OrtCreateSessionOptions(
              n,
              !!r.enableCpuMemArena,
              !!r.enableMemPattern,
              s,
            ...
            o === 0 && _e("Can't create session options."),
            r.executionProviders && hg(o, r.executionProviders, e),
            ...
            let p = ve("enableGraphCapture", e),
              d = ve(r.enableGraphCapture.toString(), e);
            t._OrtAddSessionConfigEntry(o, p, d) !== 0 &&
              _e(
          ...
          if (r.freeDimensionOverrides)
            for (let [p, d] of Object.entries(r.freeDimensionOverrides)) {
              ...
              let T = ve(p, e);
              t._OrtAddFreeDimensionOverride(o, T, d) !== 0 &&
                _e(`Can't set a free dimension override: ${p} - ${d}.`);
            }
          return (
            r.extra !== void 0 &&
              bn(r.extra, "", new WeakSet(), (p, d) => {
                let T = ve(p, e),
                  w = ve(d, e);
                t._OrtAddSessionConfigEntry(o, T, w) !== 0 &&
                  _e(`Can't set a session config entry: ${p} - ${d}.`);
              }),
            [o, e]
          );
        } catch (n) {
          throw (
            (o !== 0 && t._OrtReleaseSessionOptions(o),
            e.forEach((s) => t._free(s)),
            n)
          );
        }
    ...
    gn = async (a) => {
      if (typeof a == "string")
        if (typeof process < "u" && process.versions && process.versions.node)
          ...
          let o = t.headers.get("Content-Length"),
            e = o ? parseInt(o, 10) : 0;
          if (e < 1073741824) return new Uint8Array(await t.arrayBuffer());
          {
            if (!t.body)
              throw new Error(
                `failed to load external data file: ${a}, no response body.`
              );
    ...
    (mg = (a, t) => {
      ...
      (bg = (a) => {
        ...
        try {
          let e = t.stackAlloc(8);
          return (
            t._OrtGetInputOutputCount(a, e, e + 4) !== 0 &&
              _e("Can't get session input/output count."),
            [t.HEAP32[e / 4], t.HEAP32[e / 4 + 1]]
          );
        } finally {
          t.stackRestore(o);
        }
      ...
      (fa = (a) => {
        ...
        if (o === 0)
          throw new Error(
            `Can't create a session. failed to allocate a buffer of size ${a.byteLength}.`
          );
        ...
        try {
          if ((([s, u] = zp(t)), t?.externalData && r.mountExternalData)) {
            ...
            for (let F of t.externalData) {
              ...
              C.push(
                gn(typeof F == "string" ? F : F.data).then((j) => {
          ...
          (n = await r._OrtCreateSession(o, e, s)),
            n === 0 && _e("Can't create a session.");
          let [p, d] = bg(n),
            T = !!t?.enableGraphCapture,
            w = [],
            v = [],
            S = [];
          for (let C = 0; C < p; C++) {
            let F = r._OrtGetInputName(n, C);
            F === 0 && _e("Can't get an input name."),
              l.push(F),
              w.push(r.UTF8ToString(F));
          }
          for (let C = 0; C < d; C++) {
          ...
          let A = null;
          return zr.set(n, [n, l, c, A, T, !1]), [n, w, v];
        } catch (p) {
          throw (
            (l.forEach((d) => r._OrtFree(d)),
            c.forEach((d) => r._OrtFree(d)),
            i !== 0 && r._OrtReleaseBinding(i),
      ...
      (Zp = (a) => {
        ...
        let [e, r, n, s, i] = o;
        s &&
          (i && t._OrtClearBoundOutputs(s.handle),
          t._OrtReleaseBinding(s.handle)),
          t.jsepOnReleaseSession?.(a),
          r.forEach((u) => t._OrtFree(u)),
          n.forEach((u) => t._OrtFree(u)),
          t._OrtReleaseSession(e),
          zr.delete(a);
      }),
      (Yp = (a, t, o, e, r, n = !1) => {
        if (!a) {
        ...
        if (l === "gpu-buffer") {
          ...
          if (Array.isArray(w)) {
            ...
            (p = w.byteLength),
              (c = s._malloc(p)),
              o.push(c),
              s.HEAPU8.set(new Uint8Array(w.buffer, w.byteOffset, p), c);
        }
        let d = s.stackSave(),
          T = s.stackAlloc(4 * u.length);
        try {
          let w = T / 4;
          ...
          v === 0 &&
            _e(
              `Can't create tensor for input/output. session=${e}, index=${r}.`
            ),
            t.push(v);
        } finally {
          s.stackRestore(d);
      ...
      (Qp = async (a, t, o, e, r, n) => {
        ...
        try {
          ...
          for (let ee = 0; ee < v; ee++) Yp(r[ee], F, J, a, w + e[ee], d);
          let Le = ie / 4,
            Y = G / 4,
            Ne = Te / 4,
            Se = He / 4;
          ...
          s.jsepOnRunStart?.(u);
          let yt;
          (yt = await s._OrtRun(u, G, ie, w, He, v, Te, S)),
            yt !== 0 && _e("failed to call OrtRun().");
          let et = [];
          for (let ee = 0; ee < v; ee++) {
            ...
            let Ht = s.stackSave(),
              ...
              Ce = 0;
            try {
              s._OrtGetTensorData(qe, Ke, Ke + 4, Ke + 8, Ke + 12) !== 0 &&
                _e(`Can't access output tensor data on index ${ee}.`);
              let Tt = Ke / 4,
                qt = s.HEAPU32[Tt++];
              Ce = s.HEAPU32[Tt++];
              let xt = s.HEAPU32[Tt++],
              ...
              if (Re === "string") {
                ...
                for (let je = 0; je < tt; je++) {
                  let vt = s.HEAPU32[Be++],
                    _t = je === tt - 1 ? void 0 : s.HEAPU32[Be] - vt;
                ...
                (at = !0),
                  et.push([
                    ...
                    {
                      gpuBuffer: Be,
                      download: s.jsepCreateDownloader(Be, tt * je, Re),
                      dispose: () => {
                ...
                let ke = Hp(Re),
                  Be = new ke(tt);
                new Uint8Array(Be.buffer, Be.byteOffset, Be.byteLength).set(
                  s.HEAPU8.subarray(Ce, Ce + Be.byteLength)
                ),
                  et.push([Re, wt, Be, "cpu"]);
              }
            } finally {
              s.stackRestore(Ht),
                Re === "string" && Ce && s._free(Ce),
                at || s._OrtReleaseTensor(qe);
            }
          }
          return (
            p &&
              ...
              zr.set(a, [u, l, c, p, d, !1])),
            et
          );
        } finally {
          s.stackRestore(j),
            C.forEach((Le) => s._OrtReleaseTensor(Le)),
            F.forEach((Le) => s._OrtReleaseTensor(Le)),
            J.forEach((Le) => s._free(Le)),
            S !== 0 && s._OrtReleaseRunOptions(S),
            A.forEach((Le) => s._free(Le));
        }
      }),
      (ed = (a) => {
        let t = De(),
...
var _r,
  ...
  da = L(() => {
    ...
    rd();
    Ur();
    (_r = () => !!Z.wasm.proxy && typeof document < "u"),
      (yn = !1),
      (Do = !1),
      (Lo = !1),
      (pa = new Map()),
      ...
      (Eo = typeof document < "u" ? document?.currentScript?.src : void 0),
      (od = async () => {
        if (!Do) {
          ...
          if (((yn = !0), _r()))
            return (
              Z.wasm.wasmPaths === void 0 &&
                Eo &&
                Eo.indexOf("blob:") !== 0 &&
                (Z.wasm.wasmPaths = Eo.substr(0, +Eo.lastIndexOf("/") + 1)),
              new Promise((a, t) => {
                gt?.terminate();
                let o = URL.createObjectURL(
                  new Blob([nd()], { type: "text/javascript" })
                );
                (gt = new Worker(o, { name: "ort-wasm-proxy-worker" })),
                  (gt.onerror = (r) => t(r)),
                  (gt.onmessage = Tg),
      ...
      (sd = async (a, t) => {
        if (_r()) {
          ...
          return (
            ...
            new Promise((o, e) => {
              Vr("create", [o, e]);
              let r = { type: "create", in: { model: a, options: { ...t } } },
                n = [];
      ...
      (Co = class {
        ...
        async loadModel(t, o) {
          ...
          typeof t == "string"
            ? typeof process < "u" && process.versions && process.versions.node
              ? (e = await gn(t))
              : (e = await this.fetchModelAndCopyToWasmMemory(t))
            : (e = t),
            ([this.sessionId, this.inputNames, this.outputNames] = await sd(
              e,
              o
            )),
            fr();
        ...
        async run(t, o, e) {
          ...
          Object.entries(o).forEach((d) => {
            let T = d[0],
              w = d[1],
              v = this.outputNames.indexOf(T);
            if (v === -1) throw new Error(`invalid output '${T}'`);
            s.push(w), i.push(v);
          });
          let u = r.map((d, T) =>
              cd(d, () => `input "${this.inputNames[n[T]]}"`)
            ),
            l = s.map((d, T) =>
              d ? cd(d, () => `output "${this.outputNames[i[T]]}"`) : null
            ),
            c = await ld(this.sessionId, n, u, i, l, e),
            p = {};
  ...
  dd = L(() => {
    ...
    (wg = () => {
      if (
        ...
        typeof Z.wasm.simd != "boolean" && (Z.wasm.simd = !0),
...
Object.defineProperty(Z.versions, "web", { value: Ts, enumerable: !0 });
export {
  Pd as InferenceSession,
  ls as TRACE,
  lr as TRACE_FUNC_BEGIN,
  fr as TRACE_FUNC_END,
  Me as Tensor,
  Dd as TrainingSession,
  jO as default,
  Z as env,
  Pr as registerBackend,
};
